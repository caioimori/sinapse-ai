...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .sinapse-ai/development/scripts/unified-activation-pipeline.js sinapse-master
...
---
---
*SINAPSE Agent - Synced from .sinapse-ai/development/agents/sinapse-master.md*
