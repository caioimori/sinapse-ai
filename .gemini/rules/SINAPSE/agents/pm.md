...
commands:
  ...
  # NOTE: correct-course removed - delegated to @sinapse-master
  # See: docs/architecture/command-authority-matrix.md
  # For course corrections → Escalate to @sinapse-master using *correct-course
...
- Course corrections → Escalate to @sinapse-master using `*correct-course`
...
| Course correction | @sinapse-master | `*correct-course` |
...
| @sinapse-master | Framework modification | `*create-brownfield-prd` |
...
6. **Course correction** → Escalate to `@sinapse-master *correct-course` if deviations detected
...
---
---
*SINAPSE Agent - Synced from .sinapse-ai/development/agents/pm.md*
