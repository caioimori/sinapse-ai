...
This directory contains automated workflows for the SINAPSE project.
...
> **Note:** Legacy 1MCP metrics have been deprecated. SINAPSE now uses Docker MCP Toolkit exclusively (Story 5.11).
