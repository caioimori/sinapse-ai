---
name: Squad Proposal
about: Propose a new SINAPSE Squad for the framework
title: '[SQUAD] '
...
### 📋 Description
A clear and concise description of what this SINAPSE Squad does and what domain it covers.

> SINAPSE Squads are modular teams of AI agents that work together to accomplish specialized tasks.
...
- Core SINAPSE framework (sinapse-ai)?
...
# Or via CLI
sinapse squad activate my-domain
```

### 📦 Dependencies
- **Core Framework:** Required sinapse-ai version?
- **Other Squads:** Any dependencies on other SINAPSE Squads?
- **External Services:** Any API keys or external services needed?

### 🔒 License & Distribution
- [ ] This squad will be open-source (MIT) in `sinapse-squads` repo
...
### ✅ Checklist
- [ ] Squad follows SINAPSE structure (`{squad}/agents/`, `{squad}/tasks/`, etc.)
...
**Note:** All squad proposals are reviewed by maintainers. Approved squads may be included in the official `sinapse-squads` repository.
