...
>
> - Someone familiar with SINAPSE can understand
...
4. Tag relevant stakeholders: @caioimori/core-team
...
**Note:** This template follows the SINAPSE RFC process. For questions about the process, see [CONTRIBUTING.md](/CONTRIBUTING.md).
