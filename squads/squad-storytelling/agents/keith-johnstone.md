...
relationships:
  complementary:
    ...
    - agent: kindra-hall
      context: "Johnstone unlocks spontaneity; Hall provides structure for shaping found stories into business narrative"
  contrasts:
    - agent: blake-snyder
      context: "Snyder is formula-driven planning; Johnstone is spontaneous emergence. Opposite approaches to narrative."
    - agent: oren-klaff
      context: "Johnstone is collaborative and play-based; Klaff is competitive and dominance-based."
```
...
**Congruência:** Espontaneidade com propósito; cada beat ganha seu lugar.
