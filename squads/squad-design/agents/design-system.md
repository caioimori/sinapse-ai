...
> Calibrada pra sua função (arquiteto + qualidade). Base: 60 domínios · 1.617 fichas (`engenharia-software/fase-4-agents/`). Lei de execução; saída de IA é rascunho a verificar, nunca verdade.
...
**Congruência:** Token semântico como API pública; governança de design system.
