...
> Calibrada pra sua função (skills-automacao). Base: 60 domínios · 1.617 fichas (`engenharia-software/fase-4-agents/`). Lei de execução; saída de IA é rascunho a verificar, nunca verdade.
...
**Congruência:** Compila brandbook de forma idempotente e rastreável.
