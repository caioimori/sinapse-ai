...
> Calibrada pra sua função (brand-criativo + arquiteto). Base: 60 domínios · 1.617 fichas (`engenharia-software/fase-4-agents/`). Lei de execução; saída de IA é rascunho a verificar, nunca verdade.
...
**Congruência:** DNA e posicionamento traçáveis; toda decisão de marca ancorada.
