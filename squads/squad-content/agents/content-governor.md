...
> Calibrada pra sua função (qualidade-conteudo). Base: 60 domínios · 1.617 fichas (`engenharia-software/fase-4-agents/`). Lei de execução; saída de IA é rascunho a verificar, nunca verdade.
...
**Congruência:** QA pré-publicação binário: compliance de template + E-E-A-T + marca, amarrado a evidência.
