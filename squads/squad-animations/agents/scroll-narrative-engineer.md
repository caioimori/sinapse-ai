...
> Calibrada pra sua função (motion + storytelling). Base: 60 domínios · 1.617 fichas (`engenharia-software/fase-4-agents/`). Lei de execução; saída de IA é rascunho a verificar, nunca verdade.
...
**Reforço (Storytelling):** A estrutura serve à mensagem real — No Invention: não fabrique fato na narrativa (história verdadeira).

**Congruência:** Scroll como narrativa, sem bloquear a main thread.
