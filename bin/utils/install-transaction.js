/**
 * InstallTransaction - Transaction manager for SINAPSE installer
 *
...
class InstallTransaction {
   ...
   */
  constructor(options = {}) {
    this.backupDir = options.backupDir || path.join(process.cwd(), '.sinapse-backup', this._generateTimestamp());
    this.logFile = options.logFile || path.join(process.cwd(), '.sinapse-install.log');
   ...
   *
   * @example
   * await transaction.backupDirectory('.sinapse-ai/');
   */
