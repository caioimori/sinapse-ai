...
const STATIC_ALIASES = {
  ...
  po: 'product-lead',
  sm: 'sprint-lead',
  'sinapse-dev': 'developer',
  'sinapse-qa': 'quality-gate',
  'sinapse-pm': 'project-lead',
  'sinapse-po': 'product-lead',
  'sinapse-sm': 'sprint-lead',
  'sinapse-architect': 'architect',
  'sinapse-analyst': 'analyst',
  'sinapse-data-engineer': 'data-engineer',
  'sinapse-devops': 'devops',
  'sinapse-squad-creator': 'squad-creator',
  'sinapse-ux-design-expert': 'ux-design-expert',
  imperator: 'snps-orqx',
  'sinapse-orqx': 'snps-orqx',
  sinapse: 'snps-orqx',
  snps: 'snps-orqx',
  'claude-orqx': 'claude-mastery-chief',
  'sinapse-claude': 'claude-mastery-chief',
  'sinapse-swarm': 'swarm-orqx',
  'sinapse-brand': 'brand-orqx',
  'sinapse-animations': 'animations-orqx',
  'sinapse-cloning': 'cloning-orqx',
  'sinapse-commercial': 'commercial-orqx',
  'sinapse-content': 'content-orqx',
  'sinapse-copy': 'copy-orqx',
  'sinapse-council': 'council-orqx',
  'sinapse-courses': 'courses-orqx',
  'sinapse-cyber': 'cyber-orqx',
  'sinapse-design': 'design-orqx',
  'sinapse-finance': 'finance-orqx',
  'sinapse-growth': 'growth-orqx',
  'sinapse-paidmedia': 'paidmedia-orqx',
  'sinapse-product': 'product-orqx',
  'sinapse-research': 'research-orqx',
  'sinapse-storytelling': 'storytelling-orqx',
};
