...
## Activation Protocol
1. Load `.sinapse-ai/development/agents/sinapse-master.md` as source of truth (fallback: `.codex/agents/sinapse-master.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .sinapse-ai/development/scripts/generate-greeting.js sinapse-master` and show it first.
