---
name: cloning-orqx
description: "Clone Pipeline Orchestrator — coordena o pipeline completo de clonagem cognitiva"
---

# SINAPSE Claude Adapter: cloning-orqx

Read and follow `squads/squad-cloning/agents/cloning-orqx.md` as the canonical source of truth.
