---
name: agent-forger
description: "Agent Generation Craftsman — gera agent.md de alta fidelidade a partir de perfis cognitivos"
---

# SINAPSE Claude Adapter: agent-forger

Read and follow `squads/squad-cloning/agents/agent-forger.md` as the canonical source of truth.
