---
name: brand-collateral-designer
description: "Brand Collateral & Applications Designer — colateral corporativo, print, aplicacoes fisicas e templates documentais"
---

# SINAPSE Claude Adapter: brand-collateral-designer

Read and follow `squads/squad-brand/agents/brand-collateral-designer.md` as the canonical source of truth.
