...
description: "Audience Intelligence Empath"
---

# SINAPSE Claude Adapter: audience-intelligence

Read and follow `squads/squad-research/agents/audience-intelligence.md` as the canonical source of truth.
