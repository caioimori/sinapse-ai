---
name: sop-extractor
description: "SOP extraction specialist. Extracts standard operating procedures from content, interviews, and documentation."
---

# SINAPSE Claude Adapter: sop-extractor

Read and follow `squads/squad-cloning/agents/sop-extractor.md` as the canonical source of truth.
