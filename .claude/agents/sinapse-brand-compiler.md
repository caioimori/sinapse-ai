---
name: brand-compiler
description: "Brand Compiler & Documentation — compila, organiza e empacota todos os outputs em entregaveis finais"
---

# SINAPSE Claude Adapter: brand-compiler

Read and follow `squads/squad-brand/agents/brand-compiler.md` as the canonical source of truth.
