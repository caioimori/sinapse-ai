...
description: "Deep Research Scholar"
---

# SINAPSE Claude Adapter: deep-researcher

Read and follow `squads/squad-research/agents/deep-researcher.md` as the canonical source of truth.
