...
description: "Production Director — planeja gravacao de video/audio: roteiros, shot lists, setup"
---

# SINAPSE Claude Adapter: production-director

Read and follow `squads/squad-courses/agents/production-director.md` as the canonical source of truth.
