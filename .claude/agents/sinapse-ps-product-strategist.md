---
name: ps-product-strategist
description: "Product Strategy & Vision Lead"
---

# SINAPSE Claude Adapter: ps-product-strategist

Read and follow `squads/squad-product/agents/ps-product-strategist.md` as the canonical source of truth.
