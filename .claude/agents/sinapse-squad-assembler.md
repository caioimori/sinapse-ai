...
description: "Squad Assembly & Deployment Engineer — monta squad deployavel e faz deploy cross-squad"
---

# SINAPSE Claude Adapter: squad-assembler

Read and follow `squads/squad-cloning/agents/squad-assembler.md` as the canonical source of truth.
