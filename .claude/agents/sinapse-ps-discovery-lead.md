---
name: ps-discovery-lead
description: "Product Discovery & Validation Lead"
---

# SINAPSE Claude Adapter: ps-discovery-lead

Read and follow `squads/squad-product/agents/ps-discovery-lead.md` as the canonical source of truth.
