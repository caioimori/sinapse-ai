---
name: ps-product-analyst
description: "Product Analytics & Metrics Specialist"
---

# SINAPSE Claude Adapter: ps-product-analyst

Read and follow `squads/squad-product/agents/ps-product-analyst.md` as the canonical source of truth.
