---
name: ps-product-ops-specialist
description: "Product Operations & Systems Specialist"
---

# SINAPSE Claude Adapter: ps-product-ops-specialist

Read and follow `squads/squad-product/agents/ps-product-ops-specialist.md` as the canonical source of truth.
