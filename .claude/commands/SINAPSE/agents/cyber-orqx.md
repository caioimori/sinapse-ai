...
> Calibrada pra sua função (orquestrador + seguranca). Base: 60 domínios · 1.617 fichas (`engenharia-software/fase-4-agents/`). Lei de execução; saída de IA é rascunho a verificar, nunca verdade.
...
**Reforço (Segurança):** Nada nasce inseguro.

**Congruência:** Triage e roteia 7 especialistas cyber — não executa o teste.
