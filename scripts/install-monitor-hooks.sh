#!/bin/bash
#
# SINAPSE Monitor Hooks Installation Script
#
# This script installs the SINAPSE monitor hooks into ~/.claude/hooks/
...
SINAPSE_ROOT="$(dirname "$SCRIPT_DIR")"
HOOKS_SOURCE="$SINAPSE_ROOT/.sinapse-ai/monitor/hooks"
HOOKS_TARGET="$HOME/.claude/hooks"

echo "╔════════════════════════════════════════════════════════════════╗"
echo "║              SINAPSE Monitor Hooks Installer                      ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
echo "║     export SINAPSE_MONITOR_URL=http://localhost:4001              ║"
echo "║                                                                ║"
