...
const FILES = {
  // Core Engine
  'core/engine.js': '.sinapse-ai/core/synapse/engine.js',
  'core/context/context-tracker.js': '.sinapse-ai/core/synapse/context/context-tracker.js',
  'core/domain/domain-loader.js': '.sinapse-ai/core/synapse/domain/domain-loader.js',
  'core/layers/layer-processor.js': '.sinapse-ai/core/synapse/layers/layer-processor.js',
  'core/layers/l0-constitution.js': '.sinapse-ai/core/synapse/layers/l0-constitution.js',
  'core/layers/l1-global.js': '.sinapse-ai/core/synapse/layers/l1-global.js',
  'core/layers/l2-agent.js': '.sinapse-ai/core/synapse/layers/l2-agent.js',
  'core/layers/l3-workflow.js': '.sinapse-ai/core/synapse/layers/l3-workflow.js',
  'core/layers/l4-task.js': '.sinapse-ai/core/synapse/layers/l4-task.js',
  'core/layers/l5-squad.js': '.sinapse-ai/core/synapse/layers/l5-squad.js',
  'core/layers/l6-keyword.js': '.sinapse-ai/core/synapse/layers/l6-keyword.js',
  'core/layers/l7-star-command.js': '.sinapse-ai/core/synapse/layers/l7-star-command.js',
  'core/memory/memory-bridge.js': '.sinapse-ai/core/synapse/memory/memory-bridge.js',
  'core/output/formatter.js': '.sinapse-ai/core/synapse/output/formatter.js',
  'core/session/session-manager.js': '.sinapse-ai/core/synapse/session/session-manager.js',
  'core/scripts/generate-constitution.js': '.sinapse-ai/core/synapse/scripts/generate-constitution.js',
  'core/utils/paths.js': '.sinapse-ai/core/synapse/utils/paths.js',
  'core/utils/tokens.js': '.sinapse-ai/core/synapse/utils/tokens.js',

  // Diagnostics
  'core/diagnostics/synapse-diagnostics.js': '.sinapse-ai/core/synapse/diagnostics/synapse-diagnostics.js',
  'core/diagnostics/report-formatter.js': '.sinapse-ai/core/synapse/diagnostics/report-formatter.js',
  'core/diagnostics/collectors/safe-read-json.js': '.sinapse-ai/core/synapse/diagnostics/collectors/safe-read-json.js',
  'core/diagnostics/collectors/hook-collector.js': '.sinapse-ai/core/synapse/diagnostics/collectors/hook-collector.js',
  'core/diagnostics/collectors/session-collector.js': '.sinapse-ai/core/synapse/diagnostics/collectors/session-collector.js',
  'core/diagnostics/collectors/manifest-collector.js': '.sinapse-ai/core/synapse/diagnostics/collectors/manifest-collector.js',
  'core/diagnostics/collectors/pipeline-collector.js': '.sinapse-ai/core/synapse/diagnostics/collectors/pipeline-collector.js',
  'core/diagnostics/collectors/uap-collector.js': '.sinapse-ai/core/synapse/diagnostics/collectors/uap-collector.js',
  'core/diagnostics/collectors/timing-collector.js': '.sinapse-ai/core/synapse/diagnostics/collectors/timing-collector.js',
  'core/diagnostics/collectors/quality-collector.js': '.sinapse-ai/core/synapse/diagnostics/collectors/quality-collector.js',
  'core/diagnostics/collectors/consistency-collector.js': '.sinapse-ai/core/synapse/diagnostics/collectors/consistency-collector.js',
  'core/diagnostics/collectors/output-analyzer.js': '.sinapse-ai/core/synapse/diagnostics/collectors/output-analyzer.js',
  'core/diagnostics/collectors/relevance-matrix.js': '.sinapse-ai/core/synapse/diagnostics/collectors/relevance-matrix.js',
...
SYNAPSE (SINAPSE Adaptive Processing & State Engine) is the JIT context injection
engine for SINAPSE. On every user prompt, it injects \`<synapse-rules>\` with adaptive
...
\`\`\`
cp -r core/ <your-project>/.sinapse-ai/core/synapse/
\`\`\`
...
├── core/                      # Engine source (.sinapse-ai/core/synapse/)
...
*SYNAPSE Context Engine v2.0 — SINAPSE*
