...
O **Squad Creator** (Craft) e o agente especializado do SINAPSE para criação, validação, publicacao e gerenciamento de squads. Squads sao pacotes modulares de agentes, tasks, workflows e recursos que podem ser reutilizados entre projetos.
...
| Arquivo | Propósito |
|---------|-----------|
| `.sinapse-ai/schemas/squad-schema.json` | Schema de validação do squad.yaml |
| `.sinapse-ai/schemas/squad-design-schema.json` | Schema de validação de blueprints |
...
- [Claude adapter: sinapse-squad-creator.md](../../.claude/agents/sinapse-squad-creator.md)
