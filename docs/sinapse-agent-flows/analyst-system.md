# Sistema do Agente Analyst (@analyst) - SINAPSE
...
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/facilitate-brainstorming-session.md` | `*brainstorm {topic}` | Task principal - facilita sessoes de brainstorming estruturadas |
| `.sinapse-ai/development/tasks/analyst-facilitate-brainstorming.md` | `*brainstorm {topic}` | Variante interativa da task de brainstorming |
| `.sinapse-ai/development/tasks/create-deep-research-prompt.md` | `*research-prompt {topic}` | Gera prompts de pesquisa profunda para investigacao |
| `.sinapse-ai/development/tasks/advanced-elicitation.md` | `*elicit` | Sessao avancada de elicitacao de requisitos |
| `.sinapse-ai/development/tasks/create-doc.md` | `*doc-out` | Criacao de documentos a partir de templates YAML |
| `.sinapse-ai/development/tasks/document-project.md` | `*create-project-brief` | Documentação de projetos existentes |
| `.sinapse-ai/development/tasks/calculate-roi.md` | (relacionada) | Calculo de ROI e economia de custos |

### Tasks Relacionadas de Analise

| Arquivo | Propósito |
|---------|-----------|
| `.sinapse-ai/development/tasks/analyze-brownfield.md` | Analise de projetos brownfield |
| `.sinapse-ai/development/tasks/analyze-framework.md` | Analise de frameworks existentes |
| `.sinapse-ai/development/tasks/analyze-performance.md` | Analise de performance |
| `.sinapse-ai/development/tasks/analyze-project-structure.md` | Analise de estrutura de projeto |
| `.sinapse-ai/development/tasks/analyze-cross-artifact.md` | Analise cross-artifact |

### Templates do Analyst

| Arquivo | Propósito |
|---------|-----------|
| `.sinapse-ai/product/templates/project-brief-tmpl.yaml` | Template para Project Brief |
| `.sinapse-ai/product/templates/market-research-tmpl.yaml` | Template para Pesquisa de Mercado |
| `.sinapse-ai/product/templates/competitor-analysis-tmpl.yaml` | Template para Analise Competitiva |
| `.sinapse-ai/product/templates/brainstorming-output-tmpl.yaml` | Template para output de sessoes de brainstorming |

### Arquivos de Dados

| Arquivo | Propósito |
|---------|-----------|
| `.sinapse-ai/development/data/sinapse-kb.md` | Knowledge base do SINAPSE |
| `.sinapse-ai/development/data/brainstorming-techniques.md` | Tecnicas de brainstorming disponiveis |

### Workflows que Usam o Analyst

| Arquivo | Fase | Propósito |
|---------|------|-----------|
| `.sinapse-ai/development/workflows/greenfield-fullstack.yaml` | Fase 1 | Discovery & Planning - cria project-brief.md |
| `.sinapse-ai/development/workflows/brownfield-discovery.yaml` | Fase 9 | Relatorio Executivo de Awareness |
...
|--------|---------------------|
| **@project-lead (Morgan)** | Analyst fornece pesquisa e analise para criação de PRD |
