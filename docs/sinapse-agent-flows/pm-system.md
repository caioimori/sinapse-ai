# Sistema do Agente Product Manager (PM) - SINAPSE
...
Este documento descreve o sistema completo do agente Product Manager (PM) do SINAPSE, incluindo todos os arquivos envolvidos, fluxos de trabalho, comandos disponiveis e integracoes entre agentes.
...
| Arquivo | Propósito |
|---------|-----------|
| `.sinapse-ai/development/agents/pm.md` | Definição core do agente PM |
...
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/create-doc.md` | `*create-prd` | Cria documentos a partir de templates YAML |
| `.sinapse-ai/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de projeto |
| `.sinapse-ai/development/tasks/create-deep-research-prompt.md` | `*research` | Gera prompts de pesquisa profunda |
| `.sinapse-ai/development/tasks/brownfield-create-epic.md` | `*create-epic` | Cria epics para projetos brownfield |
| `.sinapse-ai/development/tasks/brownfield-create-story.md` | `*create-story` | Cria stories para brownfield |
| `.sinapse-ai/development/tasks/execute-checklist.md` | `*checklist` | Executa validação de checklists |
| `.sinapse-ai/development/tasks/shard-doc.md` | `*shard-prd` | Fragmenta documentos grandes |

### Templates do @pm

| Arquivo | Propósito |
|---------|-----------|
| `.sinapse-ai/product/templates/prd-tmpl.yaml` | Template PRD para projetos greenfield |
| `.sinapse-ai/product/templates/brownfield-prd-tmpl.yaml` | Template PRD para projetos brownfield |

### Checklists do @pm

| Arquivo | Propósito |
|---------|-----------|
| `.sinapse-ai/product/checklists/pm-checklist.md` | Checklist de validação de PRD |
| `.sinapse-ai/product/checklists/change-checklist.md` | Checklist para navegacao de mudancas |

### Workflows que Utilizam o @pm

| Arquivo | Fase | Propósito |
|---------|------|-----------|
| `.sinapse-ai/development/workflows/brownfield-discovery.yaml` | Fase 10 | Criacao de epics e stories pos-discovery |
...
**Solucao:**
- Verifique `.sinapse-ai/product/templates/`
