...
O agente `@devops` (Gage) e o especialista em infraestrutura e operacoes do framework SINAPSE. Ele e responsavel por:
...
|---------|---------|-----------|
| Definição do Agente | `.sinapse-ai/development/agents/devops.md` | Persona, comandos e comportamentos |

### Arquivos de Tasks

| Task | Caminho | Comando |
|------|---------|---------|
| Pre-Push Quality Gate | `.sinapse-ai/development/tasks/github-devops-pre-push-quality-gate.md` | `*push` |
| Version Management | `.sinapse-ai/development/tasks/github-devops-version-management.md` | `*version-check` |
| Repository Cleanup | `.sinapse-ai/development/tasks/github-devops-repository-cleanup.md` | `*cleanup` |
| CI/CD Configuration | `.sinapse-ai/development/tasks/ci-cd-configuration.md` | `*ci-cd` |
| Release Management | `.sinapse-ai/development/tasks/release-management.md` | `*release` |
| Environment Bootstrap | `.sinapse-ai/development/tasks/environment-bootstrap.md` | `*environment-bootstrap` |
| Search MCP | `.sinapse-ai/development/tasks/search-mcp.md` | `*search-mcp` |
| Add MCP | `.sinapse-ai/development/tasks/add-mcp.md` | `*add-mcp` |
| Setup MCP Docker | `.sinapse-ai/development/tasks/setup-mcp-docker.md` | `*setup-mcp-docker` |
| Setup GitHub | `.sinapse-ai/development/tasks/setup-github.md` | `*setup-github` |
| Security Audit | `.sinapse-ai/development/tasks/security-audit.md` | `*security-audit` |
| Security Scan | `.sinapse-ai/development/tasks/security-scan.md` | `*security-scan` |
