...
├── framework/                 # English
├── platforms/                 # English
├── sinapse-agent-flows/          # Detailed agent documentation (PT) — legacy root location
├── sinapse-workflows/            # Detailed workflow documentation (PT) — legacy root location
│
...
- [Agent System Documentation](./en/sinapse-agent-flows/README.md)
- [Workflow Documentation](./en/sinapse-workflows/README.md)
...
- [代理系统文档](./zh/sinapse-agent-flows/README.md)
- [工作流文档](./zh/sinapse-workflows/README.md)
