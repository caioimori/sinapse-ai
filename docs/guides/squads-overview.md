...
Introduction to SINAPSE Squads - modular teams of AI agents that extend framework functionality.
...
Squads are modular teams of AI agents that extend SINAPSE functionality for specific domains or use cases. Each squad is a self-contained package that can be installed, shared, and composed with other squads.

> **SINAPSE Squads:** AI agent teams working with you
...
| Traditional Agents   | SINAPSE Squads                |
| -------------------- | -------------------------- |
...
| ----------------- | ------- | ---------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0   | Data collection and transformation | [sinapse-squads/etl](https://github.com/caioimori/sinapse-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0   | Content generation utilities       | [sinapse-squads/creator](https://github.com/caioimori/sinapse-squads/tree/main/creator) |
...
- **Explore Official Squads:** Check [sinapse-squads repository](https://github.com/caioimori/sinapse-squads)
...
- [Task Format Specification](../../.sinapse-ai/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
_SINAPSE Squads: AI agent teams working with you_
