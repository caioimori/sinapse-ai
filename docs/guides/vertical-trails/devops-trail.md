...
Você está em um projeto SINAPSE e precisa:
...
npx sinapse-ai doctor  # deve retornar healthy
...
✅ Repositório criado: github.com/seu-user/my-sinapse-project
...
📋 CI Pipeline triggered:
  https://github.com/seu-user/my-sinapse-project/actions/runs/xxxxx
```
...
Release URL:
  https://github.com/seu-user/my-sinapse-project/releases/tag/v1.1.0
```
