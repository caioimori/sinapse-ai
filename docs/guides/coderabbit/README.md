...
## SINAPSE Integration Overview

In SINAPSE, CodeRabbit is integrated into the Quality Gates system as part of **Layer 2: PR Automation**.
...
coderabbit_integration:
  ...
  wsl_config:
    ...
    working_directory: /mnt/c/Users/.../sinapse-ai
```
...
# Direct command
wsl bash -c 'cd /mnt/c/.../sinapse-ai && ~/.local/bin/coderabbit --prompt-only --base main'
```
...
| Severity     | Description                               | SINAPSE Action                      |
| ------------ | ----------------------------------------- | -------------------------------- |
...
## Integration with SINAPSE Workflow
