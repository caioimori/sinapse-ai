...
> Control how much autonomy SINAPSE agents have over your system.

---

## Overview

Permission Modes let you control the level of autonomy SINAPSE agents have. Whether you're exploring a new codebase or running fully autonomous builds, there's a mode for your workflow.
...
Mode is persisted in `.sinapse/config.yaml`:
...
Check `.sinapse/config.yaml` exists and is writable:
