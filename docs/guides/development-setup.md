...
Complete guide for developers who want to contribute to the SINAPSE project.
...
| Tool                 | Purpose                                 |
| -------------------- | --------------------------------------- |
| **Claude Code**      | AI-powered development with SINAPSE agents |
| **VS Code / Cursor** | IDE with SINAPSE integration               |
...
1. Navigate to [github.com/SynkraAI/sinapse-ai](https://github.com/SynkraAI/sinapse-ai)
...
Sync SINAPSE agents to your IDE:
...
Understanding the `sinapse-ai` directory structure:

```
sinapse-ai/
├── .sinapse-ai/                    # Framework source (committed)
...
│   ├── sinapse.js                    # Main CLI
│   └── sinapse-minimal.js            # Minimal CLI
│
...
| ----------------------------------- | ---------------------------- | ----------------------- |
| `.sinapse-ai/development/agents/`    | Agent personas and behaviors | Adding/modifying agents |
| `.sinapse-ai/development/tasks/`     | Executable task workflows    | Adding/modifying tasks  |
| `.sinapse-ai/development/workflows/` | Multi-step orchestrations    | Creating workflows      |
...
```bash
# File: .sinapse-ai/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Create in .sinapse-ai/development/tasks/
  checklists:
    - my-agent-checklist.md  # Create in .sinapse-ai/development/checklists/
  tools:
    - git
    - context7
````
...
Create a new file in `.sinapse-ai/development/tasks/`:
...
# Examples:
# .sinapse-ai/development/tasks/dev-build-component.md  (dev agent)
# .sinapse-ai/development/tasks/create-doc.md          (shared)
```
...
Create a new file in `.sinapse-ai/development/workflows/`:

```bash
# File: .sinapse-ai/development/workflows/my-workflow.yaml
```
