...
> How to discover, query, and use workers in the SINAPSE framework.
...
The Service Discovery system enables finding and using workers (tasks, templates, scripts, workflows) across the SINAPSE framework. The **Service Registry** is the central catalog containing metadata about all available workers.
...
**Location:** `.sinapse-ai/infrastructure/scripts/`
