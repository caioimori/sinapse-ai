...
**Option 1: If you have sinapse-ai cloned**
```bash
# From sinapse-ai directory
...
- **Task Definition:** `.sinapse-ai/development/tasks/setup-llm-routing.md`
...
*Generated by SINAPSE Framework - Story 6.7*
