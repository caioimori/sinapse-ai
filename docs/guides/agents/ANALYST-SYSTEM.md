...
| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/agents/analyst.md` | Definicao core do agente Analyst |
...
| `.sinapse-ai/development/tasks/document-project.md` | `*create-project-brief` | Documentacao de projetos existentes |
