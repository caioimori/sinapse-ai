...
| 6 | `.sinapse-ai/product/data/test-levels-framework.md` | AgentConfigLoader.loadFile() | Test levels framework (always loaded, 8KB) |
| 7 | `.sinapse-ai/product/data/test-priorities-matrix.md` | AgentConfigLoader.loadFile() | Test priorities matrix (always loaded, 6KB) |
| 8 | `.sinapse/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 9 | `.sinapse/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
qa:
  ...
  files_loaded:
    - path: .sinapse-ai/data/technical-preferences.md
      lazy: false
      size: 15KB
    - path: .sinapse-ai/product/data/test-levels-framework.md
      lazy: false
      size: 8KB
    - path: .sinapse-ai/product/data/test-priorities-matrix.md
      lazy: false
      size: 6KB
  lazy_loading:
...
**Task file:** `.sinapse-ai/development/tasks/qa-run-tests.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-review-story.md`
...
| `.sinapse-ai/product/data/test-levels-framework.md` | Data | Loaded at activation |
| `.sinapse-ai/product/data/test-priorities-matrix.md` | Data | Loaded at activation |
...
**Task file:** `.sinapse-ai/development/tasks/qa-review-build.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-gate.md`
**Template:** `.sinapse-ai/product/templates/qa-gate-tmpl.yaml` (EXISTS in product/templates)

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `qa-gate.md` | Task | EXISTS |
| `qa-gate-tmpl.yaml` | Template | EXISTS (in `.sinapse-ai/product/templates/`) |
| `docs/stories/{storyId}` | Input | Required |
...
**Task file:** `.sinapse-ai/development/tasks/qa-nfr-assess.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-risk-profile.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-create-fix-request.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-library-validation.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-security-checklist.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-migration-validation.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-evidence-requirements.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-false-positive-detection.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-browser-console-check.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-test-design.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-trace-requirements.md`
...
**Task file:** `.sinapse-ai/development/tasks/create-suite.md`
...
**Task file:** `.sinapse-ai/development/tasks/spec-critique.md`
...
**Task file:** `.sinapse-ai/development/tasks/manage-story-backlog.md` (MISSING)
...
| `qa-gate-tmpl.yaml` | Template | `*gate` (in `dependencies.templates`) | EXISTS in `.sinapse-ai/product/templates/` but NOT in `.sinapse-ai/development/templates/` per IDE-FILE-RESOLUTION |
| `story-tmpl.yaml` | Template | (in `dependencies.templates`) | EXISTS in `.sinapse-ai/product/templates/` but NOT in `.sinapse-ai/development/templates/` per IDE-FILE-RESOLUTION |
| `test-levels-framework.md` | Data | `agent-config-requirements.yaml` | EXISTS at `.sinapse-ai/product/data/` (NOT in `.sinapse-ai/data/` where `dependencies.data` resolves) |
| `test-priorities-matrix.md` | Data | `agent-config-requirements.yaml` | EXISTS at `.sinapse-ai/product/data/` (NOT in `.sinapse-ai/data/` where `dependencies.data` resolves) |

**Path Resolution Note:** The `IDE-FILE-RESOLUTION` rule in the agent definition maps `dependencies` to `.sinapse-ai/development/{type}/{name}`. However, 2 templates and 2 data files exist under `.sinapse-ai/product/` instead. The `agent-config-requirements.yaml` correctly references the full paths under `.sinapse-ai/product/data/`, but the agent definition's `dependencies` block uses short names that resolve to `.sinapse-ai/development/templates/` and `.sinapse-ai/development/data/` respectively, where these files do not exist. Actual runtime loading uses `agent-config-requirements.yaml` paths, so functionality is preserved.
