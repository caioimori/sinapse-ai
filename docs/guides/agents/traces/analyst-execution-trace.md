...
> Agent definition: `.sinapse-ai/development/agents/analyst.md`
...
|-------|------|--------|---------|
| 1 | `.sinapse-ai/development/agents/analyst.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.sinapse-ai/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.sinapse-ai/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, analyticsLocation |
| 4 | `.sinapse-ai/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.sinapse-ai/product/data/brainstorming-techniques.md` | AgentConfigLoader.loadFile() | Brainstorming techniques (always loaded, 2KB) |
...
analyst:
  config_sections:
    ...
    - analyticsLocation
  files_loaded:
    - path: .sinapse-ai/product/data/brainstorming-techniques.md
      lazy: false
      size: 2KB
...
**Template:** `.sinapse-ai/product/templates/project-brief-tmpl.yaml` (EXISTS)
...
| `.sinapse-ai/product/data/elicitation-methods.md` | Data | Referenced by create-doc |
...
**Task file:** `.sinapse-ai/development/tasks/create-doc.md`
**Template:** `.sinapse-ai/product/templates/market-research-tmpl.yaml` (EXISTS)
...
**Task file:** `.sinapse-ai/development/tasks/create-doc.md`
**Template:** `.sinapse-ai/product/templates/competitor-analysis-tmpl.yaml` (EXISTS)
...
**Task file:** `.sinapse-ai/development/tasks/facilitate-brainstorming-session.md`
**Template:** `.sinapse-ai/product/templates/brainstorming-output-tmpl.yaml` (EXISTS)
**Data file:** `.sinapse-ai/product/data/brainstorming-techniques.md` (EXISTS)
...
**Task file:** `.sinapse-ai/development/tasks/spec-research-dependencies.md`
...
**Script:** `.sinapse-ai/infrastructure/scripts/pattern-extractor.js` (EXISTS)
