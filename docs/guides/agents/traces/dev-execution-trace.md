...
| 8 | `.sinapse-ai/data/technical-preferences.md` | AgentConfigLoader.loadFile() | Technical preferences (always loaded, 15KB) |
| 9 | `.sinapse/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 10 | `.sinapse/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
**Task file:** `.sinapse-ai/development/tasks/dev-develop-story.md`
...
**Task file:** `.sinapse-ai/development/tasks/plan-execute-subtask.md`
...
**Task file:** `.sinapse-ai/development/tasks/build-autonomous.md`
...
**Task files:** `.sinapse-ai/development/tasks/gotcha.md`, `.sinapse-ai/development/tasks/gotchas.md`
...
**Task files:** `.sinapse-ai/development/tasks/create-worktree.md`, `list-worktrees.md`, `remove-worktree.md`
...
**Task file:** `.sinapse-ai/development/tasks/qa-fix-issues.md`
...
**Task file:** `.sinapse-ai/development/tasks/waves.md`
...
**Task file:** `.sinapse-ai/development/tasks/create-service.md`
