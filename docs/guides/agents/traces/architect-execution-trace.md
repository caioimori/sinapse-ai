...
> Agent definition: `.sinapse-ai/development/agents/architect.md`
...
|-------|------|--------|---------|
| 1 | `.sinapse-ai/development/agents/architect.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.sinapse-ai/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.sinapse-ai/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: architecture, dataLocation, templatesLocation |
...
**Template:** `.sinapse-ai/development/templates/fullstack-architecture-tmpl.yaml` (MISSING)
...
| `.sinapse-ai/data/elicitation-methods` | Data | Referenced by create-doc |
| `.sinapse-ai/product/templates/` | Templates dir | Scanned dynamically |
...
**Task file:** `.sinapse-ai/development/tasks/create-doc.md`
**Template:** `.sinapse-ai/development/templates/architecture-tmpl.yaml` (MISSING)
...
**Task file:** `.sinapse-ai/development/tasks/create-doc.md`
**Template:** `.sinapse-ai/development/templates/front-end-architecture-tmpl.yaml` (MISSING)
...
**Task file:** `.sinapse-ai/development/tasks/create-doc.md`
**Template:** `.sinapse-ai/development/templates/brownfield-architecture-tmpl.yaml` (MISSING)
...
| `.sinapse-ai/scripts/execute-task.js` | Script | Referenced |
...
flowchart TD
    ...
    B --> C[Resolve checklist file from .sinapse-ai/product/checklists/]
...
**Task file:** `.sinapse-ai/development/tasks/analyze-project-structure.md`
...
**Task file:** `.sinapse-ai/development/tasks/validate-tech-preset.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `validate-tech-preset.md` | Task | EXISTS |
| `.sinapse-ai/data/tech-presets/{name}.md` | Data | Validated |
| `.sinapse-ai/data/tech-presets/_template.md` | Template | Reference |
...
flowchart TD
    ...
    B --> C[Load preset from .sinapse-ai/data/tech-presets/{name}.md]
...
**Task file:** `.sinapse-ai/development/tasks/spec-assess-complexity.md`
...
**Task file:** `.sinapse-ai/development/tasks/plan-create-implementation.md`
...
**Task file:** `.sinapse-ai/development/tasks/plan-create-context.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `plan-create-context.md` | Task | EXISTS |
| `.sinapse-ai/core-config.yaml` | Config | Required |
...
**Script:** `.sinapse-ai/development/scripts/codebase-mapper.js` (MISSING)
