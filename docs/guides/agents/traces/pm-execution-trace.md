...
**Template:** `.sinapse-ai/development/templates/prd-tmpl.yaml` (MISSING in development/templates/)
...
| `.sinapse-ai/product/templates/prd-tmpl.yaml` | Template | EXISTS (fallback) |
...
**Task file:** `.sinapse-ai/development/tasks/create-doc.md`
**Template:** `.sinapse-ai/development/templates/brownfield-prd-tmpl.yaml` (MISSING in development/templates/)
...
| `.sinapse-ai/product/templates/brownfield-prd-tmpl.yaml` | Template | EXISTS (fallback) |
...
**Task file:** `.sinapse-ai/development/tasks/brownfield-create-epic.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `brownfield-create-epic.md` | Task | EXISTS |
| `.sinapse-ai/product/templates/prd-tmpl.yaml` | Template | EXISTS (epic structure) |
| `.sinapse-ai/product/checklists/pm-checklist.md` | Checklist | EXISTS |
...
**Task file:** `.sinapse-ai/development/tasks/brownfield-create-story.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `brownfield-create-story.md` | Task | EXISTS |
| `.sinapse-ai/product/templates/story-tmpl.yaml` | Template | EXISTS (in product/templates/) |
...
**Task file:** `.sinapse-ai/development/tasks/spec-gather-requirements.md`
...
**Task file:** `.sinapse-ai/development/tasks/spec-write-spec.md`
...
| Module | Path | Status |
|--------|------|--------|
| TerminalSpawner | `.sinapse-ai/core/orchestration/terminal-spawner.js` | EXISTS |
...
**Note:** All 9 task files referenced in dependencies exist in `.sinapse-ai/development/tasks/`. The 2 templates and 2 checklists are missing from `development/` but exist in `product/` as fallback locations.
