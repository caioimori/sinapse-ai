...
| 5 | `.sinapse-ai/product/data/mode-selection-best-practices.md` | AgentConfigLoader.loadFile() | Mode selection best practices (always loaded, 10KB) |
...
sm:
  config_sections:
    ...
    - dataLocation
  files_loaded:
    - path: .sinapse-ai/product/data/mode-selection-best-practices.md
      lazy: false
      size: 10KB
    - path: .sinapse-ai/data/workflow-patterns.yaml
      lazy: false
      size: 8KB
...
**Task file:** `.sinapse-ai/development/tasks/sm-create-next-story.md`
**Template:** `.sinapse-ai/development/templates/story-tmpl.yaml` (MISSING in development/, EXISTS in `.sinapse-ai/product/templates/story-tmpl.yaml`)
...
| `.sinapse-ai/product/data/mode-selection-best-practices.md` | Data | Referenced by sm config |
...
**Checklist:** `.sinapse-ai/development/checklists/story-draft-checklist.md` (MISSING in development/, EXISTS in `.sinapse-ai/product/checklists/story-draft-checklist.md`)
...
|------|------|---------------|--------|
| `story-tmpl.yaml` | Template | `*draft` (sm-create-next-story.md) | MISSING in `.sinapse-ai/development/templates/`, EXISTS in `.sinapse-ai/product/templates/story-tmpl.yaml` |
| `story-draft-checklist.md` | Checklist | `*story-checklist` (execute-checklist.md) | MISSING in `.sinapse-ai/development/checklists/`, EXISTS in `.sinapse-ai/product/checklists/story-draft-checklist.md` |
