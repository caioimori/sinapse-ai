...
> Agent definition: `.sinapse-ai/development/agents/ux-design-expert.md`
...
|-------|------|--------|---------|
| 1 | `.sinapse-ai/development/agents/ux-design-expert.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.sinapse-ai/core-config.yaml` | generate-greeting.js (fs.readFile + yaml.load) | Core configuration |
| 3 | `.sinapse-ai/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, uxLocation |
| 4 | `.sinapse-ai/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.sinapse/session-state.json` | SessionContextLoader.loadContext() | Session type detection (sessionType, previousAgent, lastCommands) |
| 6 | `.sinapse/project-status.yaml` | loadProjectStatus() | Cached project status (60s TTL) |
...
**Task file:** `.sinapse-ai/development/tasks/ux-user-research.md`
...
**Task file:** `.sinapse-ai/development/tasks/ux-create-wireframe.md`
...
**Task file:** `.sinapse-ai/development/tasks/generate-ai-frontend-prompt.md`
...
**Template:** `.sinapse-ai/product/templates/front-end-spec-tmpl.yaml`
...
**Task file:** `.sinapse-ai/development/tasks/audit-codebase.md`
...
**Task file:** `.sinapse-ai/development/tasks/consolidate-patterns.md`
...
**Task file:** `.sinapse-ai/development/tasks/generate-shock-report.md`
**Template:** `.sinapse-ai/product/templates/shock-report-tmpl.html`
...
**Task file:** `.sinapse-ai/development/tasks/extract-tokens.md`
**Template:** `.sinapse-ai/product/templates/tokens-schema-tmpl.yaml`
...
**Task file:** `.sinapse-ai/development/tasks/setup-design-system.md`
...
**Task file:** `.sinapse-ai/development/tasks/generate-migration-strategy.md`
**Template:** `.sinapse-ai/product/templates/migration-strategy-tmpl.md`
...
**Task file:** `.sinapse-ai/development/tasks/tailwind-upgrade.md`
...
**Task file:** `.sinapse-ai/development/tasks/audit-tailwind-config.md`
...
**Task file:** `.sinapse-ai/development/tasks/export-design-tokens-dtcg.md`
**Templates:** `.sinapse-ai/product/templates/token-exports-css-tmpl.css`, `.sinapse-ai/product/templates/token-exports-tailwind-tmpl.js`
...
**Task file:** `.sinapse-ai/development/tasks/bootstrap-shadcn-library.md`
...
**Task file:** `.sinapse-ai/development/tasks/build-component.md`
**Template:** `.sinapse-ai/product/templates/component-react-tmpl.tsx`
...
**Task file:** `.sinapse-ai/development/tasks/compose-molecule.md`
...
**Task file:** `.sinapse-ai/development/tasks/extend-pattern.md`
...
**Task file:** `.sinapse-ai/development/tasks/generate-documentation.md`
...
**Checklist file:** `.sinapse-ai/product/checklists/accessibility-wcag-checklist.md`
...
**Task file:** `.sinapse-ai/development/tasks/calculate-roi.md`
...
**Task file:** `.sinapse-ai/development/tasks/ux-ds-scan-artifact.md`
**Template:** `.sinapse-ai/product/templates/ds-artifact-analysis.md`
...
**Task file:** `.sinapse-ai/development/tasks/integrate-Squad.md` (MISSING)
...
The agent definition references dependencies using short names (e.g., `sinapse-ai/tasks/...`). The actual resolution paths are:

| Dependency Type | Agent Definition Path | Actual Disk Location |
|-----------------|----------------------|---------------------|
| Tasks | `sinapse-ai/tasks/{name}` | `.sinapse-ai/development/tasks/{name}` |
| Templates | `sinapse-ai/templates/{name}` | `.sinapse-ai/product/templates/{name}` |
| Checklists | `sinapse-ai/checklists/{name}` | `.sinapse-ai/product/checklists/{name}` |
| Data | `sinapse-ai/data/{name}` | `.sinapse-ai/data/{name}` or `.sinapse-ai/product/data/{name}` |

All 9 templates, all 4 checklists, and all 7 data files resolve correctly to files in `product/` directories. The `development/data/` directory does not exist; data files live under `.sinapse-ai/data/` and `.sinapse-ai/product/data/`.
...
**Template for state persistence:** `.sinapse-ai/product/templates/state-persistence-tmpl.yaml` (EXISTS)
