...
> Agent definition: `.sinapse-ai/development/agents/squad-creator.md`
...
|-------|------|--------|---------|
| 1 | `.sinapse-ai/development/agents/squad-creator.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.sinapse-ai/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.sinapse-ai/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation (no squad-creator entry found) |
...
| `*sync-squad-sinapse` | squad-creator-sync-sinapse.md | full | No |
...
**Task file:** `.sinapse-ai/development/tasks/squad-creator-design.md`
...
**Task file:** `.sinapse-ai/development/tasks/squad-creator-create.md`
...
| `.sinapse-ai/development/templates/squad-template/` | Template scaffold | EXISTS |
...
**Task file:** `.sinapse-ai/development/tasks/squad-creator-validate.md`
...
**Task file:** `.sinapse-ai/development/tasks/squad-creator-list.md`
...
**Task file:** `.sinapse-ai/development/tasks/squad-creator-migrate.md`
...
flowchart TD
    ...
    C --> D["Detect: config.yaml, flat structure,<br/>missing sinapse.type, missing sinapse.minVersion"]
    D --> E{Needs migration?}
...
**Migration detections:** config.yaml (rename to squad.yaml), flat structure (create dirs), missing fields (sinapse.type, sinapse.minVersion, name, version)

---

### `*analyze-squad`

**Task file:** `.sinapse-ai/development/tasks/squad-creator-analyze.md`
...
**Task file:** `.sinapse-ai/development/tasks/squad-creator-extend.md`
...
| `squad-validator.js` | Script | EXISTS |
| `.sinapse-ai/development/templates/squad/agent-template.md` | Template | EXISTS |
| `.sinapse-ai/development/templates/squad/task-template.md` | Template | EXISTS |
| `.sinapse-ai/development/templates/squad/workflow-template.yaml` | Template | EXISTS |
| `.sinapse-ai/development/templates/squad/checklist-template.md` | Template | EXISTS |
| `.sinapse-ai/development/templates/squad/template-template.md` | Template | EXISTS |
| `.sinapse-ai/development/templates/squad/tool-template.js` | Template | EXISTS |
| `.sinapse-ai/development/templates/squad/script-template.js` | Template | EXISTS |
| `.sinapse-ai/development/templates/squad/data-template.yaml` | Template | EXISTS |
...
**Task file:** `.sinapse-ai/development/tasks/squad-creator-download.md`
...
flowchart TD
    ...
    B --> C{--list flag?}
    C -->|yes| D[Fetch registry.json from sinapse-squads]
...
**Source:** `github.com/SynkraAI/sinapse-squads`

---

### `*publish-squad`

**Task file:** `.sinapse-ai/development/tasks/squad-creator-publish.md`
**Status:** Active (Sprint 8)
...
flowchart TD
    ...
    G -->|no| I[Fork/clone sinapse-squads]
...
**Target:** `github.com/SynkraAI/sinapse-squads` via Pull Request
...
**Task file:** `.sinapse-ai/development/tasks/squad-creator-sync-sinapse.md`
**Status:** Active (Sprint 8)

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `squad-creator-sync-sinapse.md` | Task | EXISTS |
| `squad-validator.js` | Script | EXISTS |
...
**API endpoint:** `https://api.sinapse.ai/api/squads/sync`
...
graph TD
    ...
    subgraph "Task Files"
        ...
        T10[squad-creator-sync-sinapse.md]
...
- `.sinapse-ai/development/tasks/squad-creator-design.md`
- `.sinapse-ai/development/tasks/squad-creator-create.md`
- `.sinapse-ai/development/tasks/squad-creator-validate.md`
- `.sinapse-ai/development/tasks/squad-creator-list.md`
- `.sinapse-ai/development/tasks/squad-creator-migrate.md`
- `.sinapse-ai/development/tasks/squad-creator-analyze.md`
- `.sinapse-ai/development/tasks/squad-creator-extend.md`
- `.sinapse-ai/development/tasks/squad-creator-download.md`
- `.sinapse-ai/development/tasks/squad-creator-publish.md`
- `.sinapse-ai/development/tasks/squad-creator-sync-sinapse.md`
- `.sinapse-ai/development/tasks/squad-creator-sync-ide-command.md`

**Scripts (11 files in squad/ dir, all EXISTS):**
- `.sinapse-ai/development/scripts/squad/index.js`
- `.sinapse-ai/development/scripts/squad/squad-loader.js`
- `.sinapse-ai/development/scripts/squad/squad-validator.js`
- `.sinapse-ai/development/scripts/squad/squad-generator.js`
- `.sinapse-ai/development/scripts/squad/squad-designer.js`
- `.sinapse-ai/development/scripts/squad/squad-migrator.js`
...
- `.sinapse-ai/development/scripts/squad/README.md`

**Schemas (2 files, all EXISTS):**
- `.sinapse-ai/schemas/squad-schema.json`
- `.sinapse-ai/schemas/squad-design-schema.json`
...
- `.sinapse-ai/development/templates/squad/workflow-template.yaml`
...
- `.sinapse-ai/development/templates/squad-template/squad.yaml`
- `.sinapse-ai/development/templates/squad-template/README.md`
- `.sinapse-ai/development/templates/squad-template/package.json`
- `.sinapse-ai/development/templates/squad-template/.gitignore`
- `.sinapse-ai/development/templates/squad-template/LICENSE`
- `.sinapse-ai/development/templates/squad-template/agents/example-agent.yaml`
- `.sinapse-ai/development/templates/squad-template/tasks/example-task.yaml`
- `.sinapse-ai/development/templates/squad-template/workflows/example-workflow.yaml`
- `.sinapse-ai/development/templates/squad-template/templates/example-template.md`
- `.sinapse-ai/development/templates/squad-template/tests/example-agent.test.js`
