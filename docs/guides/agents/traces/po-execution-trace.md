...
| 5 | `.sinapse-ai/product/data/elicitation-methods.md` | AgentConfigLoader.loadFile() | Elicitation methods (always loaded, 5KB) |
...
po:
  config_sections:
    ...
    - templatesLocation
  files_loaded:
    - path: .sinapse-ai/product/data/elicitation-methods.md
      lazy: false
      size: 5KB
  lazy_loading:
...
**Task file:** `.sinapse-ai/development/tasks/po-backlog-add.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `po-backlog-add.md` | Task | EXISTS |
| `.sinapse-ai/product/data/elicitation-methods.md` | Data | EXISTS (pre-loaded) |
...
**Task file:** `.sinapse-ai/development/tasks/po-manage-story-backlog.md`
...
**Task file:** `.sinapse-ai/development/tasks/po-stories-index.md`
...
**Task file:** `.sinapse-ai/development/tasks/validate-next-story.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `validate-next-story.md` | Task | EXISTS |
| `.sinapse-ai/product/templates/story-tmpl.yaml` | Template | EXISTS |
| `.sinapse-ai/product/checklists/po-master-checklist.md` | Checklist | EXISTS |
...
**Task file:** `.sinapse-ai/development/tasks/po-sync-story.md`
...
flowchart TD
    ...
    E -->|None configured| J[Prompt: run sinapse init]
...
**Task file:** `.sinapse-ai/development/tasks/po-pull-story.md`
