...
> Agent definition: `.sinapse-ai/development/agents/data-engineer.md`
...
|-------|------|--------|---------|
| 1 | `.sinapse-ai/development/agents/data-engineer.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.sinapse-ai/core-config.yaml` | generate-greeting.js (CLI wrapper) | Core configuration |
| 3 | `.sinapse-ai/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, etlLocation |
...
| 6 | `.sinapse/session-state.json` | SessionContextLoader.loadContext() | Session type detection (CLI wrapper pre-loads) |
...
> to GreetingBuilder. See `.sinapse-ai/development/scripts/generate-greeting.js`.
...
**Template:** `.sinapse-ai/development/templates/schema-design-tmpl.yaml` (MISSING)
...
| `.sinapse-ai/data/technical-preferences.md` | Data | Loaded at activation |
...
**Task file:** `.sinapse-ai/development/tasks/create-doc.md`
**Template:** `.sinapse-ai/development/templates/rls-policies-tmpl.yaml` (MISSING)
...
**Task file:** `.sinapse-ai/development/tasks/create-doc.md`
**Template:** `.sinapse-ai/development/templates/migration-plan-tmpl.yaml` (MISSING)
...
**Task file:** `.sinapse-ai/development/tasks/create-doc.md`
**Template:** `.sinapse-ai/development/templates/index-strategy-tmpl.yaml` (MISSING)
...
**Task file:** `.sinapse-ai/development/tasks/db-domain-modeling.md`
...
**Task file:** `.sinapse-ai/development/tasks/db-env-check.md`
...
**Task file:** `.sinapse-ai/development/tasks/db-bootstrap.md`
...
**Task file:** `.sinapse-ai/development/tasks/db-apply-migration.md`
...
**Task file:** `.sinapse-ai/development/tasks/db-dry-run.md`
...
**Task file:** `.sinapse-ai/development/tasks/db-seed.md`
...
**Task file:** `.sinapse-ai/development/tasks/db-snapshot.md`
...
**Task file:** `.sinapse-ai/development/tasks/db-rollback.md`
...
**Task file:** `.sinapse-ai/development/tasks/db-smoke-test.md`
...
**Task file:** `.sinapse-ai/development/tasks/security-audit.md`
...
**Task file:** `.sinapse-ai/development/tasks/analyze-performance.md`
...
**Task file:** `.sinapse-ai/development/tasks/db-policy-apply.md`
...
**Task file:** `.sinapse-ai/development/tasks/test-as-user.md`
...
**Task file:** `.sinapse-ai/development/tasks/db-verify-order.md`
...
**Task file:** `.sinapse-ai/development/tasks/db-load-csv.md`
...
**Task file:** `.sinapse-ai/development/tasks/db-run-sql.md`
...
**Task file:** `.sinapse-ai/development/tasks/setup-database.md`
...
flowchart TD
    ...
    B --> C[Resolve checklist from .sinapse-ai/development/checklists/]
...
**Task file:** `.sinapse-ai/development/tasks/create-deep-research-prompt.md`
