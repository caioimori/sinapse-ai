...
| `.sinapse-ai/development/tasks/execute-checklist.md` | `*checklist` | Executa validacao de checklists |
...
| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/product/checklists/pm-checklist.md` | Checklist de validacao de PRD |
