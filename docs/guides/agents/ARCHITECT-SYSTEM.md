...
O agente **@architect** (Aria) e o **Holistic System Architect & Full-Stack Technical Leader** do SINAPSE. Este agente e responsavel por:
...
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/architect-analyze-impact.md` | `*analyze-impact` | Analisa impacto de modificacoes em componentes do framework |
| `.sinapse-ai/development/tasks/document-project.md` | `*document-project` | Gera documentacao brownfield de projeto existente |
| `.sinapse-ai/development/tasks/create-doc.md` | `*create-doc` | Cria documentos a partir de templates YAML |
| `.sinapse-ai/development/tasks/collaborative-edit.md` | `*collaborative-edit` | Gerencia sessoes de edicao colaborativa |
| `.sinapse-ai/development/tasks/create-deep-research-prompt.md` | `*research` | Gera prompts de pesquisa profunda |
| `.sinapse-ai/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklists de validacao |
| `.sinapse-ai/development/tasks/spec-assess-complexity.md` | `*assess-complexity` | Avalia complexidade de stories (Spec Pipeline) |

### Arquivos de Definicao do Agente

| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/agents/architect.md` | Definicao core do agente Architect |
...
| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/product/templates/architecture-tmpl.yaml` | Template para arquitetura backend |
| `.sinapse-ai/product/templates/front-end-architecture-tmpl.yaml` | Template para arquitetura frontend |
| `.sinapse-ai/product/templates/fullstack-architecture-tmpl.yaml` | Template para arquitetura fullstack |
| `.sinapse-ai/product/templates/brownfield-architecture-tmpl.yaml` | Template para projetos brownfield |

### Arquivos de Dados de Suporte

| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/data/technical-preferences.md` | Preferencias tecnicas padrao do SINAPSE |
...
| `.sinapse-ai/development/agents/devops.md` | @devops | Colabora em infraestrutura |
...
**Arquivo:** `.sinapse-ai/development/workflows/greenfield-fullstack.yaml`
...
**Arquivo:** `.sinapse-ai/development/workflows/brownfield-fullstack.yaml`
...
**Arquivo:** `.sinapse-ai/development/workflows/spec-pipeline.yaml`
...
**Arquivo:** `.sinapse-ai/development/workflows/qa-loop.yaml`
...
```bash
# Analise basica
*analyze-impact modify .sinapse-ai/agents/weather-agent.md
...
*analyze-impact deprecate .sinapse-ai/scripts/old-helper.js --output-format visual --save-report reports/deprecation.html
...
| `.sinapse/project-registry.yaml` | Registro de projetos |
...
**Solucao:**
1. Verificar `.sinapse-ai/product/templates/`
