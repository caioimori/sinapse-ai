...
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/qa-gate.md` | `*gate {story}` | Criar arquivo de decisao de quality gate |
| `.sinapse-ai/development/tasks/qa-review-story.md` | `*review {story}` | Revisao completa de story com decisao de gate |
| `.sinapse-ai/development/tasks/qa-test-design.md` | `*test-design {story}` | Criar cenarios de teste abrangentes |
| `.sinapse-ai/development/tasks/qa-risk-profile.md` | `*risk-profile {story}` | Gerar matriz de avaliacao de risco |
| `.sinapse-ai/development/tasks/qa-nfr-assess.md` | `*nfr-assess {story}` | Validar requisitos nao-funcionais |
| `.sinapse-ai/development/tasks/qa-trace-requirements.md` | `*trace {story}` | Mapear requisitos para testes (Given-When-Then) |
...
| `.sinapse-ai/development/tasks/qa-security-checklist.md` | Checklist de seguranca |
| `.sinapse-ai/development/tasks/qa-review-proposal.md` | Revisao de propostas |

### Arquivos de Definicao do Agente

| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/agents/quality-gate.md` | Definicao completa do agente QA |
...
| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/workflows/qa-loop.yaml` | Orquestrador do loop QA (Review -> Fix -> Re-review) |
...
| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/core-config.yaml` | Configuracao central (qa.qaLocation, etc.) |
| `.sinapse-ai/development/data/technical-preferences.md` | Preferencias tecnicas para QA |
...
wsl bash -c 'cd /mnt/c/.../sinapse-ai && ~/.local/bin/coderabbit --prompt-only -t committed --base main'
```
