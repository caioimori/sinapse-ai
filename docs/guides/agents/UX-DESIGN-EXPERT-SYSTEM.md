# Sistema UX-Design-Expert SINAPSE
...
Este documento descreve o sistema completo do agente **UX-Design Expert (Uma)**, incluindo todos os arquivos envolvidos, fluxos de trabalho, comandos disponiveis, integracoes com outros agentes e workflows SINAPSE.
...
| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/agents/ux-design-expert.md` | Definicao completa do agente (persona, comandos, workflows) |
...
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/ux-user-research.md` | `*research` | Conduzir pesquisa de usuario, criar personas e jornadas |
| `.sinapse-ai/development/tasks/ux-create-wireframe.md` | `*wireframe` | Criar wireframes low/mid/high fidelity |
| `.sinapse-ai/development/tasks/generate-ai-frontend-prompt.md` | `*generate-ui-prompt` | Gerar prompts para v0.dev, Lovable.ai |
| `.sinapse-ai/development/tasks/create-doc.md` | `*create-front-end-spec` | Criar especificacao frontend detalhada |

#### Fase 2: Design System Audit (3 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/audit-codebase.md` | `*audit {path}` | Escanear codebase para redundancias UI |
| `.sinapse-ai/development/tasks/consolidate-patterns.md` | `*consolidate` | Reduzir redundancia com clustering HSL |
| `.sinapse-ai/development/tasks/generate-shock-report.md` | `*shock-report` | Gerar relatorio visual HTML |

#### Fase 3: Design Tokens & Setup (7 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/extract-tokens.md` | `*tokenize` | Extrair design tokens (YAML, JSON, CSS, DTCG) |
| `.sinapse-ai/development/tasks/setup-design-system.md` | `*setup` | Inicializar estrutura do design system |
| `.sinapse-ai/development/tasks/generate-migration-strategy.md` | `*migrate` | Gerar estrategia de migracao em 4 fases |
| `.sinapse-ai/development/tasks/tailwind-upgrade.md` | `*upgrade-tailwind` | Upgrade para Tailwind CSS v4 |
| `.sinapse-ai/development/tasks/audit-tailwind-config.md` | `*audit-tailwind-config` | Validar configuracao Tailwind |
| `.sinapse-ai/development/tasks/export-design-tokens-dtcg.md` | `*export-dtcg` | Exportar tokens W3C DTCG |
| `.sinapse-ai/development/tasks/bootstrap-shadcn-library.md` | `*bootstrap-shadcn` | Instalar Shadcn/Radix UI |

#### Fase 4: Atomic Component Building (3 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/build-component.md` | `*build {component}` | Construir componente atomico (React + TypeScript) |
| `.sinapse-ai/development/tasks/compose-molecule.md` | `*compose {molecule}` | Compor molecule de atoms existentes |
| `.sinapse-ai/development/tasks/extend-pattern.md` | `*extend {component}` | Adicionar variante a componente existente |

#### Fase 5: Quality & Documentation (3 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/generate-documentation.md` | `*document` | Gerar documentacao do pattern library |
| `.sinapse-ai/development/tasks/calculate-roi.md` | `*calculate-roi` | Calcular ROI e cost savings |
| `.sinapse-ai/development/checklists/accessibility-wcag-checklist.md` | `*a11y-check` | Auditoria de acessibilidade WCAG |

#### Tasks Universais (2 tasks)

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/ux-ds-scan-artifact.md` | `*scan {path\|url}` | Analisar HTML/React para extrair padroes |
| `.sinapse-ai/development/tasks/integrate-Squad.md` | `*integrate {squad}` | Conectar com expansion squad |

### Templates

| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/templates/front-end-spec-tmpl.yaml` | Template de especificacao frontend |
| `.sinapse-ai/development/templates/tokens-schema-tmpl.yaml` | Schema de design tokens |
| `.sinapse-ai/development/templates/component-react-tmpl.tsx` | Template de componente React |
| `.sinapse-ai/development/templates/state-persistence-tmpl.yaml` | Template de persistencia de estado |
| `.sinapse-ai/development/templates/shock-report-tmpl.html` | Template de shock report HTML |
| `.sinapse-ai/development/templates/migration-strategy-tmpl.md` | Template de estrategia de migracao |
| `.sinapse-ai/development/templates/token-exports-css-tmpl.css` | Template de export CSS |
| `.sinapse-ai/development/templates/token-exports-tailwind-tmpl.js` | Template de export Tailwind |
| `.sinapse-ai/development/templates/ds-artifact-analysis.md` | Template de analise de artefato |

### Checklists

| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/checklists/pattern-audit-checklist.md` | Checklist de auditoria de padroes |
| `.sinapse-ai/development/checklists/component-quality-checklist.md` | Checklist de qualidade de componente |
| `.sinapse-ai/development/checklists/accessibility-wcag-checklist.md` | Checklist WCAG AA/AAA |
| `.sinapse-ai/development/checklists/migration-readiness-checklist.md` | Checklist de readiness para migracao |

### Data Files

| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/data/technical-preferences.md` | Preferencias tecnicas padrao |
| `.sinapse-ai/development/data/atomic-design-principles.md` | Principios Atomic Design |
| `.sinapse-ai/development/data/design-token-best-practices.md` | Best practices de design tokens |
| `.sinapse-ai/development/data/consolidation-algorithms.md` | Algoritmos de consolidacao |
| `.sinapse-ai/development/data/roi-calculation-guide.md` | Guia de calculo de ROI |
| `.sinapse-ai/development/data/integration-patterns.md` | Padroes de integracao |
| `.sinapse-ai/development/data/wcag-compliance-guide.md` | Guia de conformidade WCAG |

### Workflows Relacionados

| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/workflows/design-system-build-quality.yaml` | Pipeline pos-migracao (build, docs, a11y, ROI) |
| `.sinapse-ai/development/workflows/brownfield-ui.yaml` | Workflow para UI brownfield |
| `.sinapse-ai/development/workflows/brownfield-discovery.yaml` | Discovery para projetos existentes |
| `.sinapse-ai/development/workflows/greenfield-ui.yaml` | Workflow para UI greenfield |
...
- [ux-user-research.md](../../.sinapse-ai/development/tasks/ux-user-research.md)
- [ux-create-wireframe.md](../../.sinapse-ai/development/tasks/ux-create-wireframe.md)
- [audit-codebase.md](../../.sinapse-ai/development/tasks/audit-codebase.md)
- [consolidate-patterns.md](../../.sinapse-ai/development/tasks/consolidate-patterns.md)
- [extract-tokens.md](../../.sinapse-ai/development/tasks/extract-tokens.md)
- [build-component.md](../../.sinapse-ai/development/tasks/build-component.md)
- [calculate-roi.md](../../.sinapse-ai/development/tasks/calculate-roi.md)

### Arquivos de Workflow

- [design-system-build-quality.yaml](../../.sinapse-ai/development/workflows/design-system-build-quality.yaml)
- [brownfield-ui.yaml](../../.sinapse-ai/development/workflows/brownfield-ui.yaml)

### Definicao do Agente

- [ux-design-expert.md](../../.sinapse-ai/development/agents/ux-design-expert.md)
