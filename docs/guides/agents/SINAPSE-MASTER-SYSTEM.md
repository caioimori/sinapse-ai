...
| `.sinapse-ai/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklist de validacao |
...
| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/templates/agent-template.yaml` | Template para criacao de novos agentes |
| `.sinapse-ai/development/templates/task-template.md` | Template para criacao de novas tasks |
| `.sinapse-ai/development/templates/workflow-template.yaml` | Template para criacao de novos workflows |
