# Sistema de Criacao e Gerenciamento de Squads SINAPSE
...
O **Squad Creator** (Craft) e o agente especializado do SINAPSE para criacao, validacao, publicacao e gerenciamento de squads. Squads sao pacotes modulares de agentes, tasks, workflows e recursos que podem ser reutilizados entre projetos.

Este sistema implementa a **arquitetura task-first** do SINAPSE, onde tasks sao o ponto de entrada principal para execucao, e agentes orquestram essas tasks.

### Propositos do Sistema

- **Criar squads** seguindo padroes e estrutura do SINAPSE
- **Validar squads** contra JSON Schema e especificacoes de task
- **Listar squads** locais do projeto
- **Distribuir squads** em 3 niveis (Local, sinapse-squads, SINAPSE API)
...
4. **3 Niveis de Distribuicao**: Local, Publico (sinapse-squads), Marketplace (SINAPSE API)
5. **Integracao com sinapse-ai**: Squads trabalham em sinergia com o framework
...
| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/agents/squad-creator.md` | Definicao core do agente Squad Creator |
...
|---------|---------|-----------|--------|
| `.sinapse-ai/development/tasks/squad-creator-create.md` | `*create-squad` | Cria novo squad com estrutura completa | Ativo |
| `.sinapse-ai/development/tasks/squad-creator-design.md` | `*design-squad` | Analisa documentacao e gera blueprint | Ativo |
| `.sinapse-ai/development/tasks/squad-creator-validate.md` | `*validate-squad` | Valida squad contra schema e padroes | Ativo |
| `.sinapse-ai/development/tasks/squad-creator-list.md` | `*list-squads` | Lista squads locais | Ativo |
| `.sinapse-ai/development/tasks/squad-creator-analyze.md` | `*analyze-squad` | Analisa estrutura e sugere melhorias | Ativo |
| `.sinapse-ai/development/tasks/squad-creator-extend.md` | `*extend-squad` | Estende squad com novos componentes | Ativo |
| `.sinapse-ai/development/tasks/squad-creator-migrate.md` | `*migrate-to-v2` | Migra squad para formato v2 | Ativo |
| `.sinapse-ai/development/tasks/squad-generate-skills.md` | `*generate-skills` | Gera skills de conhecimento do squad | Ativo |
...
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/create-agent.md` | `*create-agent` | Cria definicao de agente individual |
| `.sinapse-ai/development/tasks/create-task.md` | `*create-task` | Cria arquivo de task individual |
| `.sinapse-ai/development/tasks/create-workflow.md` | `*create-workflow` | Cria workflow de orquestracao |

### Scripts de Suporte

| Arquivo | Classe/Funcao | Proposito |
|---------|---------------|-----------|
| `.sinapse-ai/development/scripts/squad/squad-generator.js` | `SquadGenerator` | Gera estrutura de squad completa |
| `.sinapse-ai/development/scripts/squad/squad-validator.js` | `SquadValidator` | Valida squad contra schema e padroes |
| `.sinapse-ai/development/scripts/squad/squad-loader.js` | `SquadLoader` | Carrega e resolve squads |
| `.sinapse-ai/development/scripts/squad/squad-designer.js` | `SquadDesigner` | Analisa docs e gera blueprints |
| `.sinapse-ai/development/scripts/squad/squad-analyzer.js` | `SquadAnalyzer` | Analisa estrutura de squads |
| `.sinapse-ai/development/scripts/squad/squad-extender.js` | `SquadExtender` | Estende squads existentes |
| `.sinapse-ai/development/scripts/squad/squad-migrator.js` | `SquadMigrator` | Migra squads para v2 |
| `.sinapse-ai/development/scripts/squad/squad-downloader.js` | `SquadDownloader` | Baixa squads do repositorio |
| `.sinapse-ai/development/scripts/squad/squad-publisher.js` | `SquadPublisher` | Publica squads |

### Schemas JSON

| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/schemas/squad-schema.json` | Schema de validacao do squad.yaml |
| `.sinapse-ai/schemas/squad-design-schema.json` | Schema de validacao de blueprints |
...
sinapse:
  minVersion: string  # versao minima do SINAPSE
  type: squad
...
| **Niveis Distribuicao** | 3 (Local, sinapse-squads, SINAPSE API) |
