...
| Documento | Caminho |
|-----------|---------|
| Definicao do Workflow | `.sinapse-ai/development/workflows/design-system-build-quality.yaml` |
| Agente UX-Design Expert | `.sinapse-ai/development/agents/ux-design-expert.md` |
| Task: Build Component | `.sinapse-ai/development/tasks/build-component.md` |
| Task: Generate Documentation | `.sinapse-ai/development/tasks/generate-documentation.md` |
| Checklist: WCAG A11y | `.sinapse-ai/development/checklists/accessibility-wcag-checklist.md` |
| Task: Calculate ROI | `.sinapse-ai/development/tasks/calculate-roi.md` |
...
|--------|------|-------|----------|
| 1.0.0 | 2025-01-30 | Orion (SINAPSE Master) | Versao inicial do workflow |
