# SINAPSE Complete Cross-Reference Analysis
...
This document is the result of a comprehensive cross-reference analysis of every artifact in the SINAPSE framework. The analysis was conducted in 7 phases, examining 25 entity types totaling approximately 745 tracked files.
...
|-------------|-------|----------|
| Agents | 12 | `.sinapse-ai/development/agents/` |
| Tasks | 191 | `.sinapse-ai/development/tasks/` |
| Workflows | 12 | `.sinapse-ai/development/workflows/` |
| Product Templates | 92 | `.sinapse-ai/product/templates/` |
| Development Templates | 29 | `.sinapse-ai/development/templates/` |
| Product Checklists | 16 | `.sinapse-ai/product/checklists/` |
| Product Data | 16 | `.sinapse-ai/product/data/` |
| Framework Data | 8 | `.sinapse-ai/data/` |
| Dev Scripts | 37 | `.sinapse-ai/development/scripts/` |
| Infra Scripts | 90 | `.sinapse-ai/infrastructure/scripts/` |
| Infra Integrations | 5 | `.sinapse-ai/infrastructure/integrations/` |
| Infra Tools | 15 | `.sinapse-ai/infrastructure/tools/` |
| Infra Templates | 15 | `.sinapse-ai/infrastructure/templates/` |
| Core Modules | 130 | `.sinapse-ai/core/` |
| CLI Commands | 37 | `.sinapse-ai/cli/commands/` |
| Schemas | 6 | `.sinapse-ai/schemas/` |
| Manifests | 4 | `.sinapse-ai/manifests/` |
| Monitor Hooks | 10 | `.sinapse-ai/monitor/hooks/` |
| Quality Gates | 10 | `.sinapse-ai/core/quality-gates/` |
| Quality Metrics | 4 | `.sinapse-ai/quality/` |
| Workflow Intelligence | 19 | `.sinapse-ai/workflow-intelligence/` |
| Docs/Standards | 16 | `.sinapse-ai/docs/standards/` |
| Root Config | 8 | `.sinapse-ai/` root |
| Elicitation | 8 | `.sinapse-ai/core/elicitation/` + `.sinapse-ai/elicitation/` |
| **TOTAL** | **~745** | |
...
DATA FILES (4):
  sinapse-kb.md, agent-config-requirements.yaml,
...
| File | Location |
|------|----------|
| `SINAPSE-LIVRO-DE-OURO.md` | `docs/standards/` |
| `SINAPSE-LIVRO-DE-OURO-V2.1.md` | `docs/standards/` |
| `SINAPSE-LIVRO-DE-OURO-V2.1-SUMMARY.md` | `docs/standards/` |
| `SINAPSE-FRAMEWORK-MASTER.md` | `docs/standards/` |
...
|-----------|--------|---------------|
| `.sinapse-ai/agent-teams/` | Does not exist | install-manifest, source-tree docs, core-architecture |
| `.sinapse-ai/tools/` | Exists but empty | core-config.yaml, framework-config.yaml |
| `.sinapse-ai/processes/` | Does not exist | Not referenced |
...
- **infrastructure/** has ZERO dependencies on other SINAPSE modules
...
10. **Populate or remove `.sinapse-ai/tools/`** -- Currently empty despite config references.
