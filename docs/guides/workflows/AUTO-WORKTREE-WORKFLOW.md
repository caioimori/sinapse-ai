...
flowchart TB
    ...
    PF3 -->|Existe| PF4
    PF3 -->|Nao existe| ERR3[Erro: SINAPSE incompleto]
...
graph TB
    ...
    subgraph FS["File System"]
        WT[.sinapse/worktrees/{storyId}/<br/>Worktree Directory]
        LOG[.sinapse/logs/merges/<br/>Merge Audit Logs]
    end
...
**Estrutura Criada:**
```
.sinapse/worktrees/{storyId}/     # Diretorio de trabalho
...
| Propriedade | Valor |
|-------------|-------|
| **Localizacao** | `.sinapse-ai/development/tasks/create-worktree.md` |
| **Agente** | @devops (Gage) |
| **Versao** | 1.0 |
| **Story** | 1.3 |
...
| **SINAPSE Core** | Instalado | Verificar `.sinapse-ai/` |
...
| `WorktreeManager not found` | SINAPSE incompleto | Reinstalar SINAPSE |
...
3. Aumentar limite (se necessario) em `.sinapse/config.yaml`
...
| Arquivo | Caminho |
|---------|---------|
| **Workflow Definition** | `.sinapse-ai/development/workflows/auto-worktree.yaml` |
| **Task Create** | `.sinapse-ai/development/tasks/create-worktree.md` |
...
*Documentacao gerada automaticamente pelo SINAPSE-FULLSTACK*
