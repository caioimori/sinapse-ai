...
|---------|-----------|---------|
| Workflow Definition | Definicao YAML do workflow | `.sinapse-ai/development/workflows/brownfield-service.yaml` |
...
| PO Master Checklist | Checklist de validacao | `.sinapse-ai/development/checklists/po-master-checklist.md` |
