...
> **Scope:** `.sinapse-ai/development/scripts/` (38 files)
...
| S7 | `squad-downloader.js` | Downloads squads from sinapse-squads GitHub repository (SQS-6) | `https`, `fs.promises`, `path` | `index.js`, `squad-creator-download.md`, tests | @squad-creator | No |
| S8 | `squad-publisher.js` | Publishes squads to sinapse-squads GitHub repo via PR (SQS-6) | `child_process`, `fs.promises`, `path` | `index.js`, `squad-creator-publish.md`, tests | @squad-creator | No |
...
The SINAPSE greeting system generates contextual, session-aware greetings when agents are activated. It consists of **8 greeting-related files** in the development scripts directory plus supporting infrastructure.
...
| `.sinapse-ai/product/templates/activation-instructions-inline-greeting.yaml` | Template | ~64 | YAML template for inline greeting logic in agent files |
| `.claude/commands/greet.md` | Slash Command | ~102 | `/greet` slash command definition for Claude Code |

**External copies (in `.claude/commands/SINAPSE/scripts/`):**
| File | Purpose |
|------|---------|
...
The preference is stored in `.sinapse-ai/core-config.yaml` under `agentIdentity.greeting.preference`.
...
activation-instructions:
  - STEP 3: |
      Build intelligent greeting using .sinapse-ai/development/scripts/greeting-builder.js
...
```
greeting-builder.js
  |-- context-detector.js          (.sinapse-ai/core/session/)
  |-- git-config-detector.js       (.sinapse-ai/infrastructure/scripts/)
  |-- workflow-navigator.js        (sibling in development/scripts/)
  |-- greeting-preference-manager.js (sibling)
  |-- project-status-loader.js     (.sinapse-ai/infrastructure/scripts/)
  |-- PermissionMode               (.sinapse-ai/core/permissions/)
  |-- js-yaml
  |-- fs, path

generate-greeting.js
  |-- greeting-builder.js          (sibling)
  |-- session-context-loader.js    (.sinapse-ai/scripts/)
  |-- project-status-loader.js     (.sinapse-ai/infrastructure/scripts/)
...
```
.sinapse-ai/development/scripts/agent-assignment-resolver.js
.sinapse-ai/development/scripts/agent-config-loader.js
.sinapse-ai/development/scripts/agent-exit-hooks.js
.sinapse-ai/development/scripts/apply-inline-greeting-all-agents.js
.sinapse-ai/development/scripts/audit-agent-config.js
.sinapse-ai/development/scripts/backlog-manager.js
.sinapse-ai/development/scripts/batch-update-agents-session-context.js
.sinapse-ai/development/scripts/decision-context.js
.sinapse-ai/development/scripts/decision-log-generator.js
.sinapse-ai/development/scripts/decision-log-indexer.js
.sinapse-ai/development/scripts/decision-recorder.js
.sinapse-ai/development/scripts/dev-context-loader.js
.sinapse-ai/development/scripts/generate-greeting.js
.sinapse-ai/development/scripts/greeting-builder.js
.sinapse-ai/development/scripts/greeting-config-cli.js
.sinapse-ai/development/scripts/greeting-preference-manager.js
.sinapse-ai/development/scripts/migrate-task-to-v2.js
.sinapse-ai/development/scripts/story-index-generator.js
.sinapse-ai/development/scripts/story-manager.js
.sinapse-ai/development/scripts/story-update-hook.js
.sinapse-ai/development/scripts/task-identifier-resolver.js
.sinapse-ai/development/scripts/test-greeting-system.js
.sinapse-ai/development/scripts/validate-task-v2.js
.sinapse-ai/development/scripts/verify-workflow-gaps.js
.sinapse-ai/development/scripts/workflow-navigator.js
.sinapse-ai/development/scripts/workflow-state-manager.js
.sinapse-ai/development/scripts/workflow-validator.js
```
