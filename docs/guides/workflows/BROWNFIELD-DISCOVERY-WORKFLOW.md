...
| Arquivo | Localizacao |
|---------|-------------|
| Definicao do Workflow | `.sinapse-ai/development/workflows/brownfield-discovery.yaml` |
| Task: brownfield-create-epic | `.sinapse-ai/development/tasks/brownfield-create-epic.md` |
| Task: brownfield-create-story | `.sinapse-ai/development/tasks/brownfield-create-story.md` |
| Task: db-schema-audit | `.sinapse-ai/development/tasks/db-schema-audit.md` |
| Task: security-audit | `.sinapse-ai/development/tasks/security-audit.md` |
