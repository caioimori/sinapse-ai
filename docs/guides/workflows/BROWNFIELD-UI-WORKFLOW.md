...
| @project-lead | pm | Morgan | Product Manager | Criacao do PRD brownfield |
| @ux-expert | ux-design-expert | Uma | UX/UI Designer | Especificacao frontend |
| @product-lead | po | Pax | Product Owner | Validacao, fragmentacao, retrospectiva |
| @sprint-lead | sm | River | Scrum Master | Criacao de stories |
| @analyst | analyst | Atlas | Business Analyst | Revisao de stories (opcional) |
| @developer | dev | Dex | Full Stack Developer | Implementacao |
| @quality-gate | qa | Quinn | Test Architect | Revisao de qualidade (opcional) |
...
| **Templates SINAPSE** | Templates instalados | Verificar `.sinapse-ai/development/templates/` |
| **Agentes Configurados** | Todos os agentes do workflow | Verificar `.sinapse-ai/development/agents/` |
...
|-----------|-------------|-----------------|
| Templates de PRD | `.sinapse-ai/development/templates/brownfield-prd-tmpl.yaml` | Step 2 |
| Template Frontend | `.sinapse-ai/development/templates/front-end-spec-tmpl.yaml` | Step 3 |
| Template Arquitetura | `.sinapse-ai/development/templates/brownfield-architecture-tmpl.yaml` | Step 4 |
| Checklist PO | `.sinapse-ai/development/checklists/po-master-checklist.md` | Step 5 |
| Template Story | `.sinapse-ai/development/templates/story-tmpl.yaml` | Step 8 |
...
```bash
ls .sinapse-ai/development/templates/
```

2. Verificar nome correto do template no workflow
3. Se necessario, reinstalar templates do SINAPSE core
...
|-----------|-------------|-----------|
| SINAPSE Knowledge Base | `.sinapse-ai/data/sinapse-kb.md` | Base de conhecimento SINAPSE |
| IDE Development Workflow | `.sinapse-ai/data/sinapse-kb.md#IDE Development Workflow` | Workflow de desenvolvimento IDE |
| Brownfield PRD Template | `.sinapse-ai/development/templates/brownfield-prd-tmpl.yaml` | Template PRD brownfield |
| Frontend Spec Template | `.sinapse-ai/development/templates/front-end-spec-tmpl.yaml` | Template especificacao frontend |
| Brownfield Architecture Template | `.sinapse-ai/development/templates/brownfield-architecture-tmpl.yaml` | Template arquitetura brownfield |
| PO Master Checklist | `.sinapse-ai/development/checklists/po-master-checklist.md` | Checklist de validacao PO |
