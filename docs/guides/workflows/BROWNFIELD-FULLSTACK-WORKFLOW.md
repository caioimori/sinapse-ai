...
> **Arquivo Fonte:** `.sinapse-ai/development/workflows/brownfield-fullstack.yaml`
...
**Arquivo de Task:** `.sinapse-ai/development/tasks/document-project.md`
...
**Arquivo de Checklist:** `.sinapse-ai/product/checklists/po-master-checklist.md`
...
**Arquivo de Task:** `.sinapse-ai/development/tasks/shard-doc.md`
...
- `.sinapse-ai/development/tasks/create-brownfield-story.md`
...
- [ ] Core config SINAPSE configurado (`.sinapse-ai/core-config.yaml`)
...
| Arquivo | Proposito |
|---------|-----------|
| `.sinapse-ai/development/workflows/brownfield-fullstack.yaml` | Definicao do workflow |
| `.sinapse-ai/development/tasks/brownfield-create-story.md` | Task para criar story simples |
| `.sinapse-ai/development/tasks/brownfield-create-epic.md` | Task para criar epic |
| `.sinapse-ai/development/tasks/document-project.md` | Task para documentar projeto existente |
| `.sinapse-ai/development/tasks/shard-doc.md` | Task para fragmentar documentos |
| `.sinapse-ai/development/tasks/create-brownfield-story.md` | Task para criar story brownfield |
| `.sinapse-ai/development/tasks/create-next-story.md` | Task para criar story de PRD |
| `.sinapse-ai/product/checklists/po-master-checklist.md` | Checklist de validacao PO |
...
| `.sinapse-ai/working-in-the-brownfield.md` | Guia de trabalho brownfield |
