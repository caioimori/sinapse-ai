...
By using SINAPSE ("the Software"), you agree to be bound by these Terms of Use. If you do not agree to these terms, do not use the Software.

## License

SINAPSE is released under the **MIT License**. See the [LICENSE](LICENSE) file for the full license text.
...
By contributing to SINAPSE, you agree that:
...
SINAPSE includes third-party open-source components. Each component is subject to its own license terms:
...
When using AI providers (Claude, OpenAI, etc.) through SINAPSE:
