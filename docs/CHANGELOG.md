...
- **🤖 SINAPSE Autonomous Development Engine (ADE)**: Complete autonomous development system with 7 Epics:
...
- **Agent Sync**: All agents now synced between `.sinapse-ai/development/agents/` and `.claude/commands/SINAPSE/agents/`
...
- **Directory Structure**: Renamed `.legacy-core/` to `.sinapse-ai/`
...
- **IDE Configuration**: Claude Code agents moved to `.claude/commands/SINAPSE/agents/`
- **File Locations**:
...
- Manual installation process (use `npx sinapse-ai install` instead)
...
- Initial public release of SINAPSE
...
1. Directory renamed: `.legacy-core/` → `.sinapse-ai/`
