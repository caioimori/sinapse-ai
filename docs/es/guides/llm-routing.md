...
**Opcion 1: Si tienes sinapse-ai clonado**
```bash
# Desde el directorio sinapse-ai
...
- **Definicion de Herramienta:** `.sinapse-ai/infrastructure/tools/cli/llm-routing.yaml`
- **Script de Instalacion:** `.sinapse-ai/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Definicion de Tarea:** `.sinapse-ai/development/tasks/setup-llm-routing.md`
...
*Generado por SINAPSE Framework - Story 6.7*
