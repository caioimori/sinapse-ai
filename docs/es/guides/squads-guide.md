...
Guia completa para crear, validar, publicar y gestionar Squads en SINAPSE.

> **SINAPSE Squads:** Equipos de agentes de IA trabajando contigo
...
Los Squads son equipos modulares de agentes de IA que extienden la funcionalidad de SINAPSE. Cada squad es un paquete autocontenido que incluye:
...
- Node.js 18+
- Proyecto SINAPSE inicializado (`.sinapse-ai/` existe)
...
Las tareas deben seguir [TASK-FORMAT-SPECIFICATION-V1](../../../.sinapse-ai/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).
...
| Modo       | Comportamiento                                     |
| ---------- | -------------------------------------------------- |
| `extend`   | Agregar reglas del squad a las reglas base de SINAPSE |
...
### Nivel 2: Repositorio sinapse-squads (Publico)
...
3. **Agregar Campos** - `sinapse.type`, `sinapse.minVersion`
...
# - sinapse.type: debe ser "squad"
# - sinapse.minVersion: debe ser semver valido
```
...
### Cual es la diferencia entre un Squad y formatos legados de squad en SINAPSE?

**Squads** son el formato estandar en SINAPSE 2.1+ con:
...
3. Re-publicar: `*publish-squad` o `*sync-squad-sinapse`
...
- **Nivel 3**: Sincronizar con bandera `--private`: `*sync-squad-sinapse my-squad --private`

### Cual es la version minima de SINAPSE para Squads?

Los Squads requieren SINAPSE 2.1.0+. Configurar en el manifiesto:
...
_SINAPSE Squads: Equipos de agentes de IA trabajando contigo_
