...
# Guía de Descubrimiento de Servicios de SINAPSE

> 🌐 [EN](../../guides/service-discovery.md) | [PT](../../pt/guides/service-discovery.md) | **ES**

---

> Cómo descubrir, consultar y usar workers en el framework SINAPSE.
...
El sistema de Descubrimiento de Servicios permite encontrar y usar workers (tareas, plantillas, scripts, workflows) en todo el framework SINAPSE. El **Registro de Servicios** es el catálogo central que contiene metadatos sobre todos los workers disponibles.
...
Encontrados 5 workers que coinciden con "create story":
  ...
  [task] po-create-story
         Ruta: .sinapse-ai/development/tasks/po-create-story.md
         Etiquetas: task, creation, story, product
         Agentes: po

  [task] dev-create-brownfield-story
         Ruta: .sinapse-ai/development/tasks/dev-create-brownfield-story.md
...
**Ubicación:** `.sinapse-ai/development/tasks/`
...
**Ubicación:** `.sinapse-ai/product/templates/`
...
**Ubicación:** `.sinapse-ai/development/workflows/`
...
**Ubicación:** `.sinapse-ai/product/checklists/`
...
_Guía de Descubrimiento de Servicios de SINAPSE v4_
