...
Como contribuir squads al ecosistema SINAPSE.

## Descripcion General

Hay dos formas de compartir tu squad con la comunidad:

1. **Repositorio sinapse-squads** - Squads gratuitos y de codigo abierto en GitHub
2. **Marketplace de SINAPSE** - Squads premium via API de SINAPSE
...
| **Compatibilidad SINAPSE** | `sinapse.minVersion: "2.1.0"` o superior |
...
## Publicando en el Marketplace de SINAPSE
...
- Seguir convenciones de SINAPSE
