...
El Sistema de Saludo Contextual es una mejora de UX que hace que los saludos de los agentes SINAPSE sean inteligentes y adaptativos, mostrando información y comandos relevantes basados en el contexto de la sesión.
...
5. **Workflow Patterns** (`.sinapse-ai/data/workflow-patterns.yaml`)
...
### Scripts Core
- `.sinapse-ai/core/session/context-detector.js` - Detección de tipo de sesión
- `.sinapse-ai/infrastructure/scripts/git-config-detector.js` - Detección de git config
- `.sinapse-ai/development/scripts/greeting-builder.js` - Construcción del saludo
- `.sinapse-ai/development/scripts/workflow-navigator.js` - Navegación de workflow
- `.sinapse-ai/development/scripts/agent-exit-hooks.js` - Hooks de salida (para persistencia)

### Archivos de Datos
- `.sinapse-ai/data/workflow-patterns.yaml` - Definiciones de workflows
...
### Configuración
- `.sinapse-ai/core-config.yaml` - Configuración global (secciones git + agentIdentity)

### Agentes (Actualizados)
- `.sinapse-ai/agents/dev.md` - Metadatos de visibilidad de comandos
- `.sinapse-ai/agents/po.md` - Metadatos de visibilidad de comandos
- `.sinapse-ai/agents/*.md` - 9 agentes restantes (actualización pendiente)
...
R: Usa el script de prueba: `node .sinapse-ai/development/scripts/test-greeting-system.js`
