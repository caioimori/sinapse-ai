...
Como migrar squads legacy al formato SINAPSE 2.1.

## Descripcion General

SINAPSE 2.1 introdujo un nuevo formato de squad con:
...
| Campo de tipo SINAPSE    | Faltante      | `sinapse.type: squad`         |
| Version minima        | Faltante      | `sinapse.minVersion: "2.1.0"` |
...
- Agrega campos `sinapse` faltantes al manifiesto
...
- [ ] `sinapse.type` es `"squad"`
- [ ] `sinapse.minVersion` es `"2.1.0"` o superior
