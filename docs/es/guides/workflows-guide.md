...
Los Workflows de SINAPSE son secuencias orquestadas de actividades de agents que automatizan procesos de desarrollo complejos. Proporcionan patrones estructurados y repetibles para escenarios de desarrollo comunes.
...
El state se persiste en `.sinapse/{instance-id}-state.yaml`:
...
SINAPSE detecta patrones comunes de workflow basados en el historial de comandos:
...
| **Ubicacion** | `.sinapse-ai/development/workflows/` | `.sinapse-ai/development/tasks/` |
...
*Guia de Workflows de SINAPSE v1.0 - Orquestando la Colaboracion IA-Humano*
