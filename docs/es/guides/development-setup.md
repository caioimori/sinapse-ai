...
Guia completa para desarrolladores que quieren contribuir al proyecto SINAPSE.
...
| -------------------- | ------------------------------------------- |
| **Claude Code**      | Desarrollo potenciado por IA con agentes SINAPSE |
| **VS Code / Cursor** | IDE con integracion SINAPSE                    |
...
1. Navega a [github.com/SinapseAI/sinapse-ai](https://github.com/SinapseAI/sinapse-ai)
...
Sincroniza los agentes SINAPSE con tu IDE:
...
Entendiendo la estructura de directorios de `sinapse-ai`:

```
sinapse-ai/
├── .sinapse-ai/                    # Fuente del framework (committed)
...
│   ├── commands/SINAPSE/agents/      # Comandos skill de agentes
...
| ----------------------------------- | -------------------------------- | ------------------------- |
| `.sinapse-ai/development/agents/`    | Personas y comportamientos de agentes | Agregar/modificar agentes |
| `.sinapse-ai/development/tasks/`     | Workflows de tasks ejecutables   | Agregar/modificar tasks   |
| `.sinapse-ai/development/workflows/` | Orquestaciones multi-paso        | Crear workflows           |
...
Crea un nuevo archivo en `.sinapse-ai/development/agents/`:

```bash
# Archivo: .sinapse-ai/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Crear en .sinapse-ai/development/tasks/
  checklists:
    - my-agent-checklist.md  # Crear en .sinapse-ai/development/checklists/
  tools:
    - git
    - context7
````
...
Crea un nuevo archivo en `.sinapse-ai/development/tasks/`:
...
# Ejemplos:
# .sinapse-ai/development/tasks/dev-build-component.md  (agente dev)
# .sinapse-ai/development/tasks/create-doc.md          (compartida)
```
...
## Definicion de Task (SINAPSE Task Format V1.0)
...
Crea un nuevo archivo en `.sinapse-ai/development/workflows/`:

```bash
# Archivo: .sinapse-ai/development/workflows/my-workflow.yaml
```
...
npx js-yaml .sinapse-ai/development/agents/my-agent.md

# Verificar que existan dependencias
ls .sinapse-ai/development/tasks/my-task.md
```
...
SINAPSE_DEBUG=true npm run trace -- workflow-name

# Verificar estado de workflow
cat .sinapse/state/workflow-state.json
```
...
- Etiquetar `@SinapseAI/core-team` para issues urgentes
...
_SINAPSE Guia de Configuracion para Desarrollo v1.0.0_
