...
2. **Ejecutar diagnósticos**: `npx sinapse-ai@latest doctor`
3. **Verificar información del sistema**: `npx sinapse-ai@latest info`
...
| Comando | Descripción |
|---------|-------------|
| `npx sinapse-ai@latest` | Instalar/ejecutar asistente |
| `npx sinapse-ai@latest --version` | Mostrar versión |
| `npx sinapse-ai@latest --help` | Mostrar ayuda |
| `npx sinapse-ai@latest install` | Instalar en directorio actual |
| `npx sinapse-ai@latest init <name>` | Crear nuevo proyecto |
| `npx sinapse-ai@latest doctor` | Ejecutar diagnósticos |
| `npx sinapse-ai@latest info` | Mostrar información del sistema |
