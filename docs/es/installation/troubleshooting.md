...
# Guía de Solución de Problemas de SINAPSE
...
### Problema 1: "npx sinapse-ai no se reconoce"
...
```
npm ERR! code E404
npm ERR! 404 Not Found - GET https://registry.npmjs.org/sinapse-ai
```
...
npm ERR! network request to https://registry.npmjs.org/sinapse-ai failed
```
...
npm install sinapse-ai --verbose
```
...
```bash
# Verificar estado de instalación de SINAPSE
npx sinapse-ai status
...
npx sinapse-ai install --verbose
```
...
```bash
# Verificar estructura de .sinapse-ai
...
3. Busque [Issues de GitHub](https://github.com/SynkraAI/sinapse-ai/issues) existentes
...
- **Issues de GitHub**: [sinapse-ai/issues](https://github.com/SynkraAI/sinapse-ai/issues)
