...
# Guía de Instalación de SINAPSE para macOS
...
1. Los comandos se instalan en `.claude/commands/SINAPSE/`
...
2. SINAPSE maneja automáticamente tanto sistemas de archivos sensibles como insensibles a mayúsculas
