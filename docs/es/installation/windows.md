...
# Guía de Instalación Windows para SINAPSE
...
2. Comandos se instalan en `.claude\commands\SINAPSE\`
...
# - Hará respaldo de personalizaciones en .sinapse-backup\
