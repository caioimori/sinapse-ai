...
# Documentación de Instalación de SINAPSE
...
Este directorio contiene documentación completa de instalación y configuración para SINAPSE.
...
3. Abra un [Issue en GitHub](https://github.com/SynkraAI/sinapse-ai/issues)
