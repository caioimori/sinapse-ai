...
Guia de referencia completa para todos los comandos del meta-agente de SINAPSE.
...
```bash
SINAPSE_AI_PROVIDER=openai          # Proveedor de IA
SINAPSE_AI_MODEL=gpt-4             # Modelo de IA
SINAPSE_LOG_LEVEL=debug            # Nivel de log
SINAPSE_TELEMETRY=disabled         # Configuracion de telemetria
SINAPSE_TIMEOUT=30000             # Timeout de comando (ms)
SINAPSE_MEMORY_CACHE=true         # Cache de memoria
```
