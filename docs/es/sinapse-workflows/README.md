# SINAPSE Workflows - Documentacion Detallada de los Workflows

> [PT](../../sinapse-workflows/README.md) | [EN](../../en/sinapse-workflows/README.md) | **ES** | [ZH](../../zh/sinapse-workflows/README.md)
...
Esta carpeta contiene la documentacion detallada de todos los workflows de SINAPSE, incluyendo:
...
| Agent Flows | [docs/sinapse-agent-flows/](../../sinapse-agent-flows/) | Detalles de agentes |
...
*SINAPSE Workflows Documentation v1.0 - Documentacion detallada de los workflows de desarrollo*
