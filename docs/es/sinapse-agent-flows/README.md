# SINAPSE Agent Flows - Documentacion Detallada de los Agentes

> [PT](../../sinapse-agent-flows/README.md) | [EN](../../en/sinapse-agent-flows/README.md) | **ES** | [ZH](../../zh/sinapse-agent-flows/README.md)
...
Esta carpeta contiene la documentacion detallada de todos los agentes de SINAPSE, incluyendo:
...
| SINAPSE Workflows | [docs/sinapse-workflows/](../../sinapse-workflows/) | Detalle de workflows |
...
*SINAPSE Agent Flows Documentation v1.0 - Documentacion detallada del sistema de agentes*
