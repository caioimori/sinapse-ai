...
- [Documentación del Sistema de Agentes](./sinapse-agent-flows/README.md)
- [Documentación de Workflows](./sinapse-workflows/README.md)
...
Esta documentación es parte de SINAPSE, licenciada bajo [Licencia MIT](../../LICENSE).

---

_SINAPSE - Orquestando IA para un Mejor Desarrollo de Software_
