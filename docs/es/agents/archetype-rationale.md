...
# Fundamentos de los Arquetipos de Agentes SINAPSE

**Version:** 1.0
**Creado:** 2025-01-14
**Autor:** @ux-design-expert (Uma) + @architect (Aria)
**Proposito:** Documentar las decisiones de diseno, consideraciones de sensibilidad cultural y opciones alternativas para el sistema de personas de agentes SINAPSE

---

## Resumen Ejecutivo

Este documento proporciona la fundamentacion completa para el sistema de personas de agentes SINAPSE, incluyendo:
...
**Decision Clave:** Usar arquetipos zodiacales (12 signos) como marco de personalidad para 12 agentes SINAPSE, con equilibrio elemental perfecto y adecuacion cultural global.
...
**Pros:**
- Control completo
- Perfectamente adaptado a SINAPSE
- Sin bagaje cultural
...
**Los arquetipos zodiacales proporcionan el marco ideal para personas de agentes SINAPSE porque:**
