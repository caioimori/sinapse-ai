...
Guía para configurar servidores MCP (Model Context Protocol) basados en Docker con SINAPSE.
...
- `~/.sinapse/mcp/servers/` - Configuraciones de servidores individuales
...
SINAPSE usa Docker MCP Toolkit como infraestructura MCP principal:
...
_Guía de Configuración de Docker MCP de SINAPSE v4.0_
