...
API REST para sincronizar squads con SINAPSE y descubrir squads del marketplace.

## Vision General

La API de Squads permite:

- **Sync**: Enviar squads locales a la nube de SINAPSE
...
Envia una definicion de squad a SINAPSE.
...
```json
{
  ...
  "data": {
    "valid": true,
    "errors": [],
    "warnings": ["Falta campo recomendado: description", "Falta campo sinapse.minVersion"]
  }
}
```
...
{
  "info": {
    "name": "API de Squads SINAPSE",
    "description": "API REST para el Marketplace de Squads de SINAPSE",
