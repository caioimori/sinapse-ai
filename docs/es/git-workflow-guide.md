...
# Guía de Flujo de Trabajo Git de SINAPSE
...
SINAPSE implementa una estrategia de validación de **Defensa en Profundidad** con tres capas progresivas que detectan problemas tempranamente y aseguran la calidad del código antes del merge.
...
**Ubicación:** `.sinapse-ai/utils/sinapse-validator.js`
