...
# Guia de Solucion de Problemas de SINAPSE

> 🌐 [EN](../troubleshooting.md) | [PT](../pt/troubleshooting.md) | **ES**

---

Esta guia completa te ayuda a diagnosticar y resolver problemas comunes con SINAPSE.
...
# Salida detallada
npx sinapse-ai doctor --verbose

# Verificar componente especifico
npx sinapse-ai doctor --component memory-layer
```
...
npm exec sinapse-ai init my-project
```
...
npx sinapse-ai doctor --component config
...
```javascript
// Editar .sinapse/memory-config.json
{
...
```
Error: "sinapse-ai" cannot be opened
```
...
xattr -d com.apple.quarantine /usr/local/bin/sinapse-ai
```
...
npx sinapse-ai doctor --report diagnostic.json

# Incluir info del sistema
npx sinapse-ai info --detailed >> diagnostic.json
...
1. **Ejecutar diagnosticos:**
   ```bash
   npx sinapse-ai doctor --verbose > diagnostic.log
   ```
...
2. **Recopilar informacion:**
   ...
   - Version de SINAPSE: `npx sinapse-ai version`

3. **Verificar issues existentes:**
   - [GitHub Issues](https://github.com/sinapse-ai/sinapse-ai/issues)
   - [Discussions](https://github.com/sinapse-ai/sinapse-ai/discussions)
...
- **Stack Overflow**: Etiqueta preguntas con `sinapse-ai`
...
1. Ejecutar `npx sinapse-ai init test`
