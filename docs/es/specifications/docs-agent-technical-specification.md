...
**@docs (Ajax)** es un agente de IA especializado en crear **documentacion educativa** para SINAPSE. A diferencia de la documentacion tecnica (JSDoc/Typedoc), Ajax se enfoca en **tutoriales, guias de incorporacion, explicadores visuales y materiales de capacitacion para socios**.
...
whenToUse: |
  ...
  - Tutoriales explicando como usar funciones de SINAPSE
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Usa estilo consistente (paleta de colores SINAPSE)"
      blocker: false
...
whenToUse: |
  ...
  - Nuevo socio se une al ecosistema SINAPSE
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Enlaces a documentacion SINAPSE relevante"
      blocker: false
...
[Nombre del Agente] es el agente [rol] de SINAPSE, especializado en [experiencia principal].
...
**Notas de Plantilla:**
- Usar paleta de colores SINAPSE (Azul primario, Purpura secundario, Rosa terciario)
...
```bash
#!/bin/bash
# Hook de Auto-Actualizacion SINAPSE @docs
...
- [ ] Crear `squads/sinapse/agents/docs/agent.yaml`
...
- [ ] **Reconocimiento de Industria:** Docs de SINAPSE citados como "mejor en espacio de agentes IA"
...
Con la adicion de @docs (Ajax), SINAPSE ahora tiene **13 agentes nombrados**:
...
| 13 | @sinapse-master | Orion | Comandante | Aries | Cian |
