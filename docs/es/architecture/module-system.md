...
# Arquitectura del Sistema de Módulos SINAPSE

> 🌐 [EN](../../architecture/module-system.md) | [PT](../../pt/architecture/module-system.md) | **ES**

---

> Guía completa de la arquitectura modular v4.2 para SINAPSE.
...
SINAPSE organiza el directorio `.sinapse-ai/` en cuatro módulos principales:
...
| `data/`          | `sinapse-kb.md`, `workflow-patterns.yaml`           | Base de conocimiento del framework     |
...
```javascript
// Configuración
const { loadAgentConfig, globalConfigCache } = require('./.sinapse-ai/core');

// Sesión
const { ContextDetector, SessionContextLoader } = require('./.sinapse-ai/core');

// Elicitation
const { ElicitationEngine, ElicitationSessionManager } = require('./.sinapse-ai/core');
...
| --------------- | ------------------ | -------------------------- |
| SINAPSE Master     | `sinapse-master`      | Orquestación del framework |
...
**Ruta:** `.sinapse-ai/infrastructure/`
...
_Arquitectura del Sistema de Módulos SINAPSE v4_
