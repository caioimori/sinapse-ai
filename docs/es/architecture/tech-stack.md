...
SINAPSE esta construido sobre JavaScript/TypeScript moderno con runtime Node.js, optimizado para desarrollo CLI multiplataforma con UX interactivo y capacidades de orquestacion de agentes.
...
```yaml
Base: 30MB (Node.js + SINAPSE core)
...
```bash
# Configuracion SINAPSE
SINAPSE_DEBUG=true                    # Habilitar logging de debug
SINAPSE_CONFIG_PATH=/ruta/custom      # Ubicacion de config personalizada
SINAPSE_YOLO_MODE=true               # Forzar modo yolo
...
| 1.1     | 2025-12-14 | Actualizado aviso de migracion a SinapseAI/sinapse-ai, semantic-release a v25.0.2 [Story 6.10] | Dex (dev)        |

---

_Este es un estandar oficial del framework SINAPSE. Todas las elecciones de tecnologia deben alinearse con este stack._
