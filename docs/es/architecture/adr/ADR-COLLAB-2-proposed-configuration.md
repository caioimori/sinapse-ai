...
Siguiendo la [Auditoria de Estado Actual](./ADR-COLLAB-1-current-state-audit.md), este documento propone cambios de configuracion especificos para habilitar contribuciones externas seguras a SINAPSE.
...
# Configuracion CodeRabbit para SINAPSE
# Historia: COLLAB-1
...
reviews:
  ...
  path_instructions:
    ...
    '.sinapse-ai/development/agents/**':
      - 'Verificar que el agente sigue la estructura YAML de agentes SINAPSE (persona_profile, commands, dependencies)'
    ...
    '.sinapse-ai/development/tasks/**':
      - 'Verificar que la tarea sigue el formato de tareas SINAPSE con puntos de elicitacion claros'
    ...
    '.sinapse-ai/product/templates/**':
      - 'Asegurar que la plantilla sigue las convenciones de plantillas SINAPSE'
    ...
    '**/*.js':
      ...
      - 'Asegurar que el codigo sigue los estandares de codigo SINAPSE'
...
- [ ] El agente sigue la estructura YAML de agentes SINAPSE
...
- [ ] La tarea sigue el formato de tareas SINAPSE
