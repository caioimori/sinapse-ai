...
> **Fecha:** 2026-01-28
> **Proyecto:** SINAPSE Autonomous Development Engine (ADE)

---

## Resumen Ejecutivo

El ADE es un proyecto de **Prompt Engineering + Infraestructura** para habilitar ejecución autónoma de desarrollo en SINAPSE. Aproximadamente **60% del trabajo es creación de tasks .md, workflows .yaml y templates** - no código tradicional.
...
- `docs/prd/sinapse-autonomous-development-engine.md`

### Stories

- `docs/stories/sinapse-ai-ade/` (7 archivos de epic + README)

### Quality Gates

- `docs/qa/gates/sinapse-ai-ade/` (7 archivos de gate + README)

### Referencia

- `docs/architecture/AUTO-CLAUDE-ANALYSIS-COMPLETE.md` (patrones del Auto-Claude)
- `.sinapse-ai/core-config.yaml` (configuración central)
...
1. **Leer el PRD completo** - `docs/prd/sinapse-autonomous-development-engine.md`
