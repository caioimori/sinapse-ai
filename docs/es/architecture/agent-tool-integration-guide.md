...
Esta guía explica cómo se integran las herramientas con los agentes SINAPSE. Las herramientas amplían las capacidades de los agentes proporcionando acceso a servicios externos, APIs y recursos del sistema.
...
| `tasks`      | Archivos de flujo de trabajo          | `.sinapse-ai/development/tasks/`  |
| `checklists` | Listas de validación                  | `.sinapse-ai/product/checklists/` |

### Ejemplo de Declaración

```yaml
# De .sinapse-ai/development/agents/dev.md
dependencies:
  checklists:
...
SINAPSE implementa gobernanza estricta de operaciones de git:
...
- [Definiciones de Agentes](../../../.sinapse-ai/development/agents/)
