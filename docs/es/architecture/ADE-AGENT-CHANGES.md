# Cambios en los Agentes ADE - Alteraciones en los Agentes SINAPSE
...
Este documento registra todas las alteraciones realizadas en los archivos de definición de los agentes SINAPSE para soportar el SINAPSE Autonomous Development Engine (ADE).

**Archivos modificados:**

- `.sinapse-ai/development/agents/*.md` (fuente)
- `.claude/commands/SINAPSE/agents/*.md` (sincronizado)
...
**Archivo:** `.sinapse-ai/development/agents/devops.md`
...
**Archivo:** `.sinapse-ai/development/agents/pm.md`
...
**Archivo:** `.sinapse-ai/development/agents/architect.md`
...
**Archivo:** `.sinapse-ai/development/agents/analyst.md`
...
**Archivo:** `.sinapse-ai/development/agents/qa.md`
...
**Archivo:** `.sinapse-ai/development/agents/dev.md`
...
- name: list-gotchas
  visibility: [full, quick]
  description: 'Listar gotchas conocidos de .sinapse/gotchas.md'
```
...
```
.sinapse-ai/development/agents/   →   .claude/commands/SINAPSE/agents/
         (fuente)                           (sincronizado)
```
...
- `.sinapse-ai/infrastructure/schemas/agent-v3-schema.json`

**Comando para validar:**

```bash
node .sinapse-ai/infrastructure/scripts/migrate-agent.js --validate
```
