...
**Propósito:** Definir patrones estándar para integrar scripts de utilidades en el framework SINAPSE

---

## ¿Qué es la Integración de Utilidades?

**Definición:** La integración de utilidades es el proceso de hacer que un script de utilidad huérfano sea **descubrible, documentado y utilizable** dentro del framework SINAPSE.
...
- `.sinapse-ai/agents/{agent}.yaml` (agregar a dependencies.utils)
- `.sinapse-ai/core-config.yaml` (registrar si es necesario)
- `.sinapse-ai/utils/README.md` (documentar utilidad)
...
```yaml
# .sinapse-ai/tasks/generate-commit-message.md
...
**Archivos Modificados:**
- `.sinapse-ai/tasks/{task}.md` (agregar execution.utils)
- `.sinapse-ai/agents/{agent}.yaml` (agregar tarea a lista executes)
- `.sinapse-ai/core-config.yaml` (registrar si es necesario)
- `.sinapse-ai/utils/README.md` (documentar utilidad)
...
**Archivos Modificados:**
- `.sinapse-ai/core-config.yaml` (registrar bajo framework)
- `.sinapse-ai/utils/README.md` (documentar como utilidad de framework)
...
```yaml
# .sinapse-ai/agents/architect.yaml
dependencies:
  utils:
...
**Archivos Modificados:**
- `.sinapse-ai/agents/{agent}.yaml`
- `.sinapse-ai/tasks/{task}.md` (si se crea tarea)
- `.sinapse-ai/core-config.yaml`
- `.sinapse-ai/utils/README.md`
...
**Ejemplos:** sinapse-validator, code-quality-improver, coverage-analyzer
...
const utility = require('.sinapse-ai/utils/{utility-name}');
...
**Ubicación:** `.sinapse-ai/utils/{name}.js`
