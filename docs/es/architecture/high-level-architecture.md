...
# Arquitectura de Alto Nivel SINAPSE v4
...
**SINAPSE (AI Operating System)** es un framework sofisticado para orquestar agentes de IA, workers y humanos en flujos de trabajo complejos de desarrollo de software. La versión 2.1 introduce una arquitectura modular con 4 módulos, estrategia multi-repositorio y quality gates de 3 capas.
...
| --------------------- | ----------- | -------------- |
| `@sinapse/core`          | npm público | MIT            |
| `@sinapse/squad-etl`     | npm público | MIT            |
| `@sinapse/squad-creator` | npm público | MIT            |
| `@sinapse/squad-mmos`    | npm público | MIT            |
| `@sinapse/mcp-presets`   | npm público | Apache 2.0     |
...
| ------------------ | ---------------------------- | ------------------------ | ----------------------------------- |
| **Core**           | `.sinapse-ai/core/`           | Fundación del framework  | Config, Registry, QG, MCP, Session  |
| **Development**    | `.sinapse-ai/development/`    | Artefactos de desarrollo | Agentes, Tareas, Workflows, Scripts |
| **Product**        | `.sinapse-ai/product/`        | Artefactos PM            | Plantillas, Checklists, Data        |
| **Infrastructure** | `.sinapse-ai/infrastructure/` | Config del sistema       | Scripts, Tools, Integraciones       |
...
| Pax    | `sinapse-master`   | Orquestador  | Orquestación del framework |
...
- [SINAPSE-LIVRO-DE-OURO-V2.1-COMPLETE.md](../../../.sinapse-ai/docs/standards/SINAPSE-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Guía completa del framework
