...
| -------------------- | -------------------------------------------------------- | ----------- | ------ |
| asset-inventory.js   | `.sinapse-ai/infrastructure/scripts/asset-inventory.js`   | JS Script   | OK     |
| path-analyzer.js     | `.sinapse-ai/infrastructure/scripts/path-analyzer.js`     | JS Script   | OK     |
| migrate-agent.js     | `.sinapse-ai/infrastructure/scripts/migrate-agent.js`     | JS Script   | OK     |
| agent-v3-schema.json | `.sinapse-ai/infrastructure/schemas/agent-v3-schema.json` | JSON Schema | OK     |
| task-v3-schema.json  | `.sinapse-ai/infrastructure/schemas/task-v3-schema.json`  | JSON Schema | OK     |
...
- **Todos los agents** sincronizados a `.claude/commands/SINAPSE/agents/`
