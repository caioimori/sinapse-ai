...
# Estructura del Arbol de Codigo Fuente SINAPSE
...
- [Estructura Actual (sinapse-ai Brownfield)](#estructura-actual-sinapse-ai-brownfield)
...
SINAPSE usa una **arquitectura de doble capa**:

1. **Framework Core** (`.sinapse-ai/`) - Componentes portables del framework
...
## Estructura Actual (sinapse-ai Brownfield)

```
sinapse-ai/                             # Raiz (proyecto brownfield)
├── .sinapse-ai/                        # Framework core (portable)
...
│
├── bin/                               # Ejecutables CLI
│   ├── sinapse-ai.js           # Punto de entrada principal del CLI
│   └── sinapse-minimal.js                # CLI minimo
│
...
**Proposito:** Componentes portables del framework que funcionan en cualquier proyecto SINAPSE.
...
│
├── stories/                           # Historias de desarrollo
│   ├── sinapse migration/                # Historias de migracion SINAPSE
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Los Squads son extensiones modulares que agregan capacidades especializadas a SINAPSE. A diferencia de los Paquetes de Expansion obsoletos, los Squads siguen una estructura de plantilla estandarizada.
...
│   └── cli/                           # Interfaz CLI
│
├── .sinapse-ai/                        # Assets del framework (estructura actual)
│   ├── agents/
│   ├── tasks/
│   ├── templates/
│   └── ...
...
Ubicacion: .sinapse-ai/agents/{nombre-agente}.md
Ejemplo: .sinapse-ai/agents/security-expert.md

# Estoy creando una nueva tarea:
Ubicacion: .sinapse-ai/tasks/{nombre-tarea}.md
Ejemplo: .sinapse-ai/tasks/deploy-to-production.md

# Estoy creando un nuevo workflow:
Ubicacion: .sinapse-ai/workflows/{nombre-workflow}.yaml
Ejemplo: .sinapse-ai/workflows/continuous-deployment.yaml

# Estoy creando una nueva plantilla:
Ubicacion: .sinapse-ai/product/templates/{nombre-plantilla}-tmpl.{yaml|md}
...
Ejemplo: docs/stories/sinapse migration/story-6.1.2.6.md
...
Ubicacion: .sinapse-ai/utils/{nombre-utilidad}.js
Ejemplo: .sinapse-ai/utils/performance-monitor.js
...
_Este es un estandar oficial del framework SINAPSE. Toda colocacion de archivos debe seguir esta estructura._
