...
# Estructura del Árbol de Código Fuente SINAPSE
...
- [Core del Framework (.sinapse-ai/)](#core-del-framework-sinapse-ai)
...
SINAPSE utiliza una **arquitectura modular** con clara separación de responsabilidades:

1. **Core del Framework** (`.sinapse-ai/`) - Componentes portables del framework organizados por dominio
...
```
sinapse-ai/                             # Proyecto raíz
├── .sinapse-ai/                        # Core del framework (modular)
...
│
├── bin/                               # Ejecutables CLI
│   └── sinapse.js                        # Punto de entrada principal CLI
│
...
│   └── sinapse-kb.md                     # Base de conocimiento SINAPSE
│
├── development/                       # Assets de Desarrollo
│   ├── agents/                        # Definiciones de agentes (11 agentes core)
│   │   ├── sinapse-master.md             # Orquestador maestro
...
Tasks:
  Location: .sinapse-ai/development/tasks/
...
Workflows:
  Location: .sinapse-ai/development/workflows/
  Format: YAML
...
│   ├── sinapse migration/                # Stories de migración SINAPSE
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Los Squads son extensiones modulares que agregan capacidades especializadas a SINAPSE. A diferencia de los Squads deprecados, los Squads siguen una estructura de template estandarizada.
...
npx create-sinapse-squad my-squad-name
...
```
sinapse-ai/
├── .sinapse-ai/                        # Assets del framework (modular v2.0)
│   ├── cli/                           # Comandos CLI y utilidades
│   ├── core/                          # Esenciales del framework
│   │   ├── config/                    # Sistema de configuración
...
```
squads/
├── verified/                          # Squads curados por SINAPSE
│   ├── github-devops/
│   ├── db-sage/
│   └── coderabbit-workflow/
│
...
Ubicación: .sinapse-ai/development/agents/{agent-name}.md
Ejemplo: .sinapse-ai/development/agents/security-expert.md

# Estoy creando una nueva tarea:
Ubicación: .sinapse-ai/development/tasks/{task-name}.md
Ejemplo: .sinapse-ai/development/tasks/deploy-to-production.md

# Estoy creando un nuevo workflow:
Ubicación: .sinapse-ai/development/workflows/{workflow-name}.yaml
Ejemplo: .sinapse-ai/development/workflows/continuous-deployment.yaml

# Estoy creando un nuevo template:
Ubicación: .sinapse-ai/product/templates/{template-name}-tmpl.{yaml|md}
Ejemplo: .sinapse-ai/product/templates/deployment-plan-tmpl.yaml

# Estoy creando un nuevo checklist:
Ubicación: .sinapse-ai/product/checklists/{checklist-name}-checklist.md
Ejemplo: .sinapse-ai/product/checklists/security-review-checklist.md

# Estoy creando un comando CLI:
Ubicación: .sinapse-ai/cli/commands/{category}/{command-name}.js
Ejemplo: .sinapse-ai/cli/commands/generate/workflow.js

# Estoy creando una utilidad core:
Ubicación: .sinapse-ai/core/utils/{utility-name}.js
Ejemplo: .sinapse-ai/core/utils/performance-monitor.js

# Estoy creando un script de infraestructura:
Ubicación: .sinapse-ai/infrastructure/scripts/{category}/{script-name}.js
Ejemplo: .sinapse-ai/infrastructure/scripts/llm-routing/router.js

# Estoy agregando un adaptador de herramienta PM:
Ubicación: .sinapse-ai/infrastructure/integrations/pm-adapters/{adapter-name}.js
Ejemplo: .sinapse-ai/infrastructure/integrations/pm-adapters/monday-adapter.js
...
_Este es un estándar oficial del framework SINAPSE. Toda colocación de archivos debe seguir esta estructura._
