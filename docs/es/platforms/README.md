...
SINAPSE soporta 9 plataformas de desarrollo con IA. Elija la que mejor se adapte a su flujo de trabajo.
...
flowchart TD
    ...
    Q1 -->|Sí| CC["<b>Claude Code</b> ⭐<br/>Mejor integración SINAPSE"]
...
```mermaid
graph TD
    subgraph "SINAPSE Core"
        Agents["Definiciones de Agentes<br/>.sinapse-ai/development/agents"]
        Templates["Templates de IDE<br/>.sinapse-ai/product/templates"]
...
1. **Instale SINAPSE** en su proyecto:
...
sequenceDiagram
    ...
    participant CLI as SINAPSE CLI
...
_SINAPSE - Documentación de Plataformas v1.0_
