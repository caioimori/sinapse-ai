...
### ¿Por qué usar SINAPSE con AntiGravity?
...
```markdown
# Reglas de SINAPSE para AntiGravity
...
1. Tus agentes en `.sinapse-ai/` son portables
...
1. Los agentes de SINAPSE permanecen en `.sinapse-ai/`
...
*SINAPSE - Guía de Plataforma AntiGravity v1.0*
