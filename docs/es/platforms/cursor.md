...
### ¿Por qué usar SINAPSE con Cursor?

Cursor es uno de los **IDEs de IA más populares** con excelente integración de SINAPSE:
...
Verificar que se crearon los archivos de SINAPSE:
...
R: Ejecutar `npm run sync:ide` después de actualizaciones de SINAPSE.
...
2. Inicializar SINAPSE para Claude Code:
...
- [Guía de Integración de SINAPSE](../README.md)

---

_SINAPSE - Guía de Plataforma Cursor v1.0_
