...
# Guía de SINAPSE para GitHub Copilot
...
### ¿Por qué usar SINAPSE con GitHub Copilot?
...
Este proyecto utiliza SINAPSE para desarrollo orquestado por IA.
...
Eres un Senior Full Stack Developer trabajando con SINAPSE.
...
### Activando Modos de Agentes SINAPSE
...
4. Para agentes SINAPSE, usa modos de chat personalizados en `.github/chatmodes/`

### Modos Personalizados SINAPSE

| Modo | Propósito |
|---|---|
| `sinapse-dev` | Desarrollo full-stack |
| `sinapse-qa` | Aseguramiento de calidad |
| `sinapse-architect` | Diseño de sistemas |
| `sinapse-pm` | Gestión de proyectos |
...
```
Problema: Los modos de agentes SINAPSE no aparecen en el selector
```
**Solución:**
...
1. Instala SINAPSE para Copilot:
   ```bash
...
1. Los agentes almacenados en `.sinapse-ai/` son portables
...
*SINAPSE - Guía de Plataforma GitHub Copilot v1.0*
