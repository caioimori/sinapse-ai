...
# Primeros Pasos con SINAPSE

> 🌐 [EN](../getting-started.md) | [PT](../pt/getting-started.md) | **ES**

---

Bienvenido a SINAPSE! Esta guia te llevara a traves de tus primeros pasos con el framework de desarrollo auto-modificable impulsado por IA.
...
Antes de instalar SINAPSE, asegurate de tener:
...
SINAPSE ofrece opciones de instalacion flexibles:
...
```
my-first-project/
├── .sinapse/                    # Configuracion del framework
...
El archivo de configuracion principal (`.sinapse/config.json`) contiene:
...
SINAPSE_TELEMETRY=enabled
```

## Entendiendo el Meta-Agente

El meta-agente es el nucleo de SINAPSE - una IA que entiende y puede modificar su propia base de codigo.
...
- **[Tutoriales en Video](https://sinapse-ai.dev/tutorials)**: Aprendizaje visual
...
- **Twitter**: Sigue [@sinapsefullstack](https://twitter.com/sinapsefullstack)
...
Recuerda: SINAPSE aprende y mejora con el uso. Cuanto mas interactues con el, mejor entendera tu estilo de desarrollo y necesidades.

Feliz programacion con SINAPSE!
