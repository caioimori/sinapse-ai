<!--
  Traducción: ES
  Original: /docs/en/sinapse-nomenclature-specification.md
  Última sincronización: 2026-01-26
-->

# Especificación de Nomenclatura de SINAPSE

> 🌐 [EN](../sinapse-nomenclature-specification.md) | [PT](../pt/sinapse-nomenclature-specification.md) | **ES**
...
Este documento establece nomenclatura clara para SINAPSE para diferenciar entre:
...
**Características:**
- **Alcance:** Interno a un único archivo de tarea (`.sinapse-ai/tasks/*.md`)
...
- **Ubicación:** Definido en `.sinapse-ai/workflows/*.yaml` o secciones de workflow de stories
...
**Concepto:** Inspirado por el protocolo Organizer-Worker de AsyncThink, los workflows de SINAPSE pueden usar un **Agente Organizador** que coordina **Agentes Trabajadores** ejecutando tareas en paralelo.

**Aplicación a SINAPSE:**
...
**Archivos de Tarea:**
- Ubicación: `.sinapse-ai/tasks/{task-name}.md`
- Contiene: Task workflow (Step-by-Step Execution)
- Ejemplo: `.sinapse-ai/tasks/security-scan.md`

**Archivos de Workflow:**
- Ubicación: `.sinapse-ai/workflows/{workflow-name}.yaml`
- Contiene: Definición de orquestación multi-tarea
- Ejemplo: `.sinapse-ai/workflows/story-development-workflow.yaml`
...
```yaml
# .sinapse-ai/workflows/story-development-workflow.yaml
workflow:
  id: story-development-workflow
  name: Story Development Flow
...
3. **Gestión de Workflows SINAPSE:** Patrones de workflow existentes en SINAPSE
