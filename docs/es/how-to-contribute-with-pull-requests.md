...
- **Para correcciones de bugs**: Crea un issue usando la [plantilla de reporte de bugs](https://github.com/SynkraAIinc/sinapse-ai/issues/new?template=bug_report.md)
- **Para nuevas features**:
  1. Discute en Discord en el [canal #general-dev](https://discord.gg/gk8jAdXWmj)
  2. Crea un issue usando la [plantilla de solicitud de feature](https://github.com/SynkraAIinc/sinapse-ai/issues/new?template=feature_request.md)
...
1. Ve al [repositorio SINAPSE](https://github.com/SynkraAIinc/sinapse-ai)
...
git clone https://github.com/TU-USUARIO/sinapse-ai.git
cd sinapse-ai
```
...
- Reporta bugs usando la [plantilla de reporte de bugs](https://github.com/SynkraAIinc/sinapse-ai/issues/new?template=bug_report.md)
- Sugiere features usando la [plantilla de solicitud de feature](https://github.com/SynkraAIinc/sinapse-ai/issues/new?template=feature_request.md)
