...
Todos los cambios notables en SINAPSE seran documentados en este archivo.
...
- **Estructura de Directorios**: Renombrado `.legacy-core/` a `.sinapse-ai/`
...
- **Configuracion de IDE**: Agentes de Claude Code movidos a `.claude/commands/SINAPSE/agents/`
...
- Proceso de instalacion manual (usar `npx sinapse-ai install` en su lugar)
...
- Lanzamiento publico inicial de SINAPSE
...
**Cambios clave:**
1. Directorio renombrado: `.legacy-core/` → `.sinapse-ai/`
