...
REST API用于将squads同步到SINAPSE并发现marketplace中的squads。

## 概述

Squads API允许：

- **同步**: 将本地squads发送到SINAPSE云端
...
```json
{
  "info": {
    ...
    "description": "SINAPSE Squads Marketplace的REST API",
...
- [@squad-creator代理](../../../.sinapse-ai/development/agents/squad-creator.md)
