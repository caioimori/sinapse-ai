...
├── framework/                 # English
├── platforms/                 # English
├── sinapse-agent-flows/          # Detailed agent documentation (PT)
├── sinapse-workflows/            # Detailed workflow documentation (PT)
│
├── pt/                        # Português
├── es/                        # Español
└── zh/                        # 中文（简体）
...
- [代理系统文档](./sinapse-agent-flows/README.md)
- [工作流文档](./sinapse-workflows/README.md)
