...
**代理流程文档 (sinapse-agent-flows/)：**

| 文档 | 原文路径 | 译文路径 | 状态 |
|------|----------|----------|------|
| 代理流程 README | `sinapse-agent-flows/README.md` | `zh/sinapse-agent-flows/README.md` | ⬜ |
| SINAPSE Master 系统 | `sinapse-agent-flows/sinapse-master-system.md` | `zh/sinapse-agent-flows/sinapse-master-system.md` | ⬜ |
| 开发者系统 | `sinapse-agent-flows/dev-system.md` | `zh/sinapse-agent-flows/dev-system.md` | ⬜ |
| 架构师系统 | `sinapse-agent-flows/architect-system.md` | `zh/sinapse-agent-flows/architect-system.md` | ⬜ |
| QA 系统 | `sinapse-agent-flows/qa-system.md` | `zh/sinapse-agent-flows/qa-system.md` | ⬜ |
| UX 设计专家系统 | `sinapse-agent-flows/ux-design-expert-system.md` | `zh/sinapse-agent-flows/ux-design-expert-system.md` | ⬜ |
| 数据工程师系统 | `sinapse-agent-flows/data-engineer-system.md` | `zh/sinapse-agent-flows/data-engineer-system.md` | ⬜ |
| 分析师系统 | `sinapse-agent-flows/analyst-system.md` | `zh/sinapse-agent-flows/analyst-system.md` | ⬜ |
| 产品经理系统 | `sinapse-agent-flows/pm-system.md` | `zh/sinapse-agent-flows/pm-system.md` | ⬜ |
| Scrum Master 系统 | `sinapse-agent-flows/sm-system.md` | `zh/sinapse-agent-flows/sm-system.md` | ⬜ |
| DevOps 系统 | `sinapse-agent-flows/devops-system.md` | `zh/sinapse-agent-flows/devops-system.md` | ⬜ |
| Squad 创建者系统 | `sinapse-agent-flows/squad-creator-system.md` | `zh/sinapse-agent-flows/squad-creator-system.md` | ⬜ |

**工作流文档 (sinapse-workflows/)：**

| 文档 | 原文路径 | 译文路径 | 状态 |
|------|----------|----------|------|
| 工作流 README | `sinapse-workflows/README.md` | `zh/sinapse-workflows/README.md` | ⬜ |
| 绿地全栈工作流 | `sinapse-workflows/greenfield-fullstack-workflow.md` | `zh/sinapse-workflows/greenfield-fullstack-workflow.md` | ⬜ |
| 绿地服务工作流 | `sinapse-workflows/greenfield-service-workflow.md` | `zh/sinapse-workflows/greenfield-service-workflow.md` | ⬜ |
| 绿地 UI 工作流 | `sinapse-workflows/greenfield-ui-workflow.md` | `zh/sinapse-workflows/greenfield-ui-workflow.md` | ⬜ |
| 棕地全栈工作流 | `sinapse-workflows/brownfield-fullstack-workflow.md` | `zh/sinapse-workflows/brownfield-fullstack-workflow.md` | ⬜ |
| 棕地服务工作流 | `sinapse-workflows/brownfield-service-workflow.md` | `zh/sinapse-workflows/brownfield-service-workflow.md` | ⬜ |
| 棕地 UI 工作流 | `sinapse-workflows/brownfield-ui-workflow.md` | `zh/sinapse-workflows/brownfield-ui-workflow.md` | ⬜ |
| 棕地发现工作流 | `sinapse-workflows/brownfield-discovery-workflow.md` | `zh/sinapse-workflows/brownfield-discovery-workflow.md` | ⬜ |
| 规格流水线工作流 | `sinapse-workflows/spec-pipeline-workflow.md` | `zh/sinapse-workflows/spec-pipeline-workflow.md` | ⬜ |
| QA 循环工作流 | `sinapse-workflows/qa-loop-workflow.md` | `zh/sinapse-workflows/qa-loop-workflow.md` | ⬜ |
| Story 开发周期 | `sinapse-workflows/story-development-cycle-workflow.md` | `zh/sinapse-workflows/story-development-cycle-workflow.md` | ⬜ |
...
| SINAPSE 视觉概览 | `architecture/SINAPSE-VISUAL-OVERVIEW.md` | `zh/architecture/SINAPSE-VISUAL-OVERVIEW.md` | ⬜ |
...
| Gate | 门控 | 門控 | 质量门控 |
| Persona | 角色 / 人格 | 角色 / 人格 | |
| Constitution | 宪法 / 准则 | 憲法 / 準則 | SINAPSE Constitution |
| CLI | CLI / 命令行 | CLI / 命令列 | |
| Hook | 钩子 | 鉤子 | |
| MCP | MCP | MCP | 不翻译 |
...
3. **保留品牌名** - SINAPSE、SINAPSE、Claude 等品牌名不翻译
...
│       └── README.md
│
├── sinapse-agent-flows/                   # 代理流程
│   ├── README.md
│   ├── sinapse-master-system.md
│   ├── dev-system.md
│   ├── architect-system.md
│   ├── qa-system.md
