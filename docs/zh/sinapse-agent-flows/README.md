<!--
  翻译：zh-CN（简体中文）
  原文：/docs/sinapse-agent-flows/README.md
  最后同步：2026-02-22
-->

# SINAPSE 代理流程 - 代理详细文档

> 🌐 [PT](../../sinapse-agent-flows/README.md) | [EN](../../en/sinapse-agent-flows/README.md) | [ES](../../es/sinapse-agent-flows/README.md) | **ZH**
...
| 代理 | 角色 | 原型 | 文档 |
|--------|---------|-----------|-----------|
| **@sinapse-master** | Orion | 编排者 | [sinapse-master-system.md](./sinapse-master-system.md) |
...
| SINAPSE 工作流 | [docs/sinapse-workflows/](../sinapse-workflows/) | 工作流详情 |
