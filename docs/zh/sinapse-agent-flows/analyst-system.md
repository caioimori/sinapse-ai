<!--
  翻译：zh-CN（简体中文）
  原文：/docs/sinapse-agent-flows/analyst-system.md
  最后同步：2026-02-22
-->

# 分析师代理 (@analyst) 系统 - SINAPSE
...
| 文件 | 目的 |
|---------|-----------|
| `.sinapse-ai/development/agents/analyst.md` | 分析师代理核心定义 |
| `.claude/commands/SINAPSE/agents/analyst.md` | 用于激活 @analyst 的 Claude Code 命令 |

### 分析师任务

| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/facilitate-brainstorming-session.md` | `*brainstorm {topic}` | 主要任务 - 促进结构化头脑风暴会话 |
| `.sinapse-ai/development/tasks/analyst-facilitate-brainstorming.md` | `*brainstorm {topic}` | 头脑风暴任务的交互变体 |
| `.sinapse-ai/development/tasks/create-deep-research-prompt.md` | `*research-prompt {topic}` | 生成深度研究调查提示 |
| `.sinapse-ai/development/tasks/advanced-elicitation.md` | `*elicit` | 高级需求获取会话 |
| `.sinapse-ai/development/tasks/create-doc.md` | `*doc-out` | 从 YAML 模板创建文档 |
| `.sinapse-ai/development/tasks/document-project.md` | `*create-project-brief` | 现有项目文档 |
| `.sinapse-ai/development/tasks/calculate-roi.md` | (相关) | ROI 和成本节约计算 |

### 相关分析任务

| 文件 | 目的 |
|---------|-----------|
| `.sinapse-ai/development/tasks/analyze-brownfield.md` | 棕地项目分析 |
| `.sinapse-ai/development/tasks/analyze-framework.md` | 现有框架分析 |
| `.sinapse-ai/development/tasks/analyze-performance.md` | 性能分析 |
| `.sinapse-ai/development/tasks/analyze-project-structure.md` | 项目结构分析 |
| `.sinapse-ai/development/tasks/analyze-cross-artifact.md` | 跨工件分析 |

### 分析师模板

| 文件 | 目的 |
|---------|-----------|
| `.sinapse-ai/product/templates/project-brief-tmpl.yaml` | 项目简介模板 |
| `.sinapse-ai/product/templates/market-research-tmpl.yaml` | 市场研究模板 |
| `.sinapse-ai/product/templates/competitor-analysis-tmpl.yaml` | 竞争分析模板 |
| `.sinapse-ai/product/templates/brainstorming-output-tmpl.yaml` | 头脑风暴会话输出模板 |

### 数据文件

| 文件 | 目的 |
|---------|-----------|
| `.sinapse-ai/development/data/sinapse-kb.md` | SINAPSE 知识库 |
| `.sinapse-ai/development/data/brainstorming-techniques.md` | 可用的头脑风暴技术 |

### 使用分析师的工作流

| 文件 | 阶段 | 目的 |
|---------|------|-----------|
| `.sinapse-ai/development/workflows/greenfield-fullstack.yaml` | 阶段 1 | 发现与规划 - 创建 project-brief.md |
| `.sinapse-ai/development/workflows/brownfield-discovery.yaml` | 阶段 9 | 高管意识报告 |
...
- [任务：facilitate-brainstorming-session.md](.sinapse-ai/development/tasks/facilitate-brainstorming-session.md)
- [任务：create-deep-research-prompt.md](.sinapse-ai/development/tasks/create-deep-research-prompt.md)
- [任务：advanced-elicitation.md](.sinapse-ai/development/tasks/advanced-elicitation.md)
- [任务：create-doc.md](.sinapse-ai/development/tasks/create-doc.md)
- [任务：document-project.md](.sinapse-ai/development/tasks/document-project.md)

### 模板

- [模板：project-brief-tmpl.yaml](.sinapse-ai/product/templates/project-brief-tmpl.yaml)
- [模板：market-research-tmpl.yaml](.sinapse-ai/product/templates/market-research-tmpl.yaml)
- [模板：competitor-analysis-tmpl.yaml](.sinapse-ai/product/templates/competitor-analysis-tmpl.yaml)
- [模板：brainstorming-output-tmpl.yaml](.sinapse-ai/product/templates/brainstorming-output-tmpl.yaml)

### 工作流

- [工作流：greenfield-fullstack.yaml](.sinapse-ai/development/workflows/greenfield-fullstack.yaml)
- [工作流：brownfield-discovery.yaml](.sinapse-ai/development/workflows/brownfield-discovery.yaml)

### 代理

- [代理：analyst.md](.sinapse-ai/development/agents/analyst.md)
