<!--
  翻译：zh-CN（简体中文）
  原文：/docs/sinapse-agent-flows/pm-system.md
  最后同步：2026-02-22
-->

# 产品经理 (PM) 代理系统 - SINAPSE
...
本文档描述 SINAPSE 产品经理 (PM) 代理的完整系统，包括所有涉及的文件、工作流程、可用命令和代理之间的集成。
...
| 文件 | 目的 |
|---------|-----------|
| `.sinapse-ai/development/agents/pm.md` | PM 代理核心定义 |
| `.claude/commands/SINAPSE/agents/pm.md` | 用于激活 @pm 的 Claude Code 命令 |

### @pm 任务

| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.sinapse-ai/development/tasks/create-doc.md` | `*create-prd` | 从 YAML 模板创建文档 |
| `.sinapse-ai/development/tasks/correct-course.md` | `*correct-course` | 分析并纠正项目偏差 |
| `.sinapse-ai/development/tasks/create-deep-research-prompt.md` | `*research` | 生成深度研究提示 |
| `.sinapse-ai/development/tasks/brownfield-create-epic.md` | `*create-epic` | 为棕地项目创建史诗 |
| `.sinapse-ai/development/tasks/brownfield-create-story.md` | `*create-story` | 为棕地创建故事 |
| `.sinapse-ai/development/tasks/execute-checklist.md` | `*checklist` | 执行检查清单验证 |
| `.sinapse-ai/development/tasks/shard-doc.md` | `*shard-prd` | 拆分大型文档 |

### @pm 模板

| 文件 | 目的 |
|---------|-----------|
| `.sinapse-ai/product/templates/prd-tmpl.yaml` | 绿地项目 PRD 模板 |
| `.sinapse-ai/product/templates/brownfield-prd-tmpl.yaml` | 棕地项目 PRD 模板 |

### @pm 检查清单

| 文件 | 目的 |
|---------|-----------|
| `.sinapse-ai/product/checklists/pm-checklist.md` | PRD 验证检查清单 |
| `.sinapse-ai/product/checklists/change-checklist.md` | 变更导航检查清单 |

### 使用 @pm 的工作流

| 文件 | 阶段 | 目的 |
|---------|------|-----------|
| `.sinapse-ai/development/workflows/brownfield-discovery.yaml` | 阶段 10 | 发现后创建史诗和故事 |
...
**解决方案：**
- 检查 `.sinapse-ai/product/templates/`
...
- [代理定义：pm.md](.sinapse-ai/development/agents/pm.md)
- [任务：create-doc.md](.sinapse-ai/development/tasks/create-doc.md)
- [任务：brownfield-create-epic.md](.sinapse-ai/development/tasks/brownfield-create-epic.md)
- [任务：correct-course.md](.sinapse-ai/development/tasks/correct-course.md)
- [模板：prd-tmpl.yaml](.sinapse-ai/product/templates/prd-tmpl.yaml)
- [模板：brownfield-prd-tmpl.yaml](.sinapse-ai/product/templates/brownfield-prd-tmpl.yaml)
- [检查清单：pm-checklist.md](.sinapse-ai/product/checklists/pm-checklist.md)
