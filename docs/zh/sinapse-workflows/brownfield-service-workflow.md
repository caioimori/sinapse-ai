...
| 文件 | 描述 | 路径 |
|------|------|------|
| 工作流定义 | 工作流的YAML定义 | `.sinapse-ai/development/workflows/brownfield-service.yaml` |
| PRD模板 | 棕地PRD的模板 | `.sinapse-ai/development/templates/brownfield-prd-tmpl.yaml` |
| 架构模板 | 架构的模板 | `.sinapse-ai/development/templates/brownfield-architecture-tmpl.yaml` |
| 故事模板 | 故事的模板 | `.sinapse-ai/development/templates/story-tmpl.yaml` |
| PO主清单 | 验证清单 | `.sinapse-ai/development/checklists/po-master-checklist.md` |
| 故事草稿清单 | 故事清单 | `.sinapse-ai/development/checklists/story-draft-checklist.md` |
| 故事DoD清单 | 完成定义 | `.sinapse-ai/development/checklists/story-dod-checklist.md` |
...
- [SINAPSE知识库](../../../.sinapse-ai/data/sinapse-kb.md) - 框架知识库
- [技术偏好](../../../.sinapse-ai/development/data/technical-preferences.md) - 项目技术偏好
- [IDE开发工作流](../../../.sinapse-ai/data/sinapse-kb.md#IDE-Development-Workflow) - IDE开发流程
...
*从workflow `brownfield-service.yaml` 生成 - SINAPSE框架 v2.2*
