...
| 文档 | 路径 |
|------|------|
| 工作流定义 | `.sinapse-ai/development/workflows/design-system-build-quality.yaml` |
| UX 设计专家代理 | `.sinapse-ai/development/agents/ux-design-expert.md` |
| 任务: 构建组件 | `.sinapse-ai/development/tasks/build-component.md` |
| 任务: 生成文档 | `.sinapse-ai/development/tasks/generate-documentation.md` |
| 检查清单: WCAG A11y | `.sinapse-ai/development/checklists/accessibility-wcag-checklist.md` |
| 任务: 计算 ROI | `.sinapse-ai/development/tasks/calculate-roi.md` |
...
| 版本 | 日期 | 作者 | 更改 |
|------|------|------|------|
| 1.0.0 | 2025-01-30 | Orion (SINAPSE 主机) | 工作流初始版本 |
