...
> **类型：** 棕地项目开发
> **状态：** 官方文档
> **源文件：** `.sinapse-ai/development/workflows/brownfield-fullstack.yaml`
...
**任务文件：** `.sinapse-ai/development/tasks/document-project.md`
...
**清单文件：** `.sinapse-ai/development/checklists/po-master-checklist.md`
...
**任务文件：** `.sinapse-ai/development/tasks/shard-doc.md`
...
- [ ] SINAPSE核心配置已配置 (`.sinapse-ai/core-config.yaml`)
...
| 文件 | 目的 |
|------|------|
| `.sinapse-ai/development/workflows/brownfield-fullstack.yaml` | 工作流定义 |
| `.sinapse-ai/development/tasks/brownfield-create-story.md` | 创建简单故事的任务 |
| `.sinapse-ai/development/tasks/brownfield-create-epic.md` | 创建史诗的任务 |
| `.sinapse-ai/development/tasks/document-project.md` | 记录现有项目的任务 |
| `.sinapse-ai/development/tasks/shard-doc.md` | 分割文档的任务 |
| `.sinapse-ai/development/tasks/create-brownfield-story.md` | 创建棕地故事的任务 |
| `.sinapse-ai/development/tasks/create-next-story.md` | 从PRD创建故事的任务 |
| `.sinapse-ai/product/checklists/po-master-checklist.md` | PO验证清单 |
...
| `.sinapse-ai/working-in-the-brownfield.md` | 棕地工作指南 |
