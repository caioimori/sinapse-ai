...
**版本:** 1.0
**创建:** 2026-02-04
**源:** `.sinapse-ai/development/workflows/greenfield-service.yaml`
...
**参考:** `.sinapse-ai/data/sinapse-kb.md#IDE Development Workflow`
...
| 文件 | 描述 |
|------|------|
| `.sinapse-ai/core-config.yaml` | 框架配置 |
| `.env` | 环境变量 |
...
| 类型 | 位置 |
|------|------|
| 代理日志 | `.sinapse/logs/agent.log` |
| 项目状态 | `.sinapse/project-registry.yaml` |
...
| 文件 | 描述 |
|------|------|
| `.sinapse-ai/development/workflows/greenfield-service.yaml` | 工作流定义 |
| `.sinapse-ai/data/sinapse-kb.md` | SINAPSE 知识库 |

### 代理

| 文件 | 代理 |
|------|------|
| `.sinapse-ai/development/agents/analyst.md` | Atlas (分析师) |
| `.sinapse-ai/development/agents/pm.md` | Morgan (PM) |
| `.sinapse-ai/development/agents/architect.md` | Aria (架构师) |
...
| 文件 | 任务 |
|------|------|
| `.sinapse-ai/development/tasks/create-doc.md` | 创建文档 |
| `.sinapse-ai/development/tasks/shard-doc.md` | 分片文档 |
| `.sinapse-ai/development/tasks/sm-create-next-story.md` | 创建故事 |
| `.sinapse-ai/development/tasks/dev-develop-story.md` | 实施故事 |
| `.sinapse-ai/development/tasks/qa-review-story.md` | 审阅实现 |
| `.sinapse-ai/development/tasks/execute-checklist.md` | 执行检查列表 |

### 模板

| 文件 | 模板 |
|------|------|
| `.sinapse-ai/development/templates/project-brief-tmpl.yaml` | 项目简报 |
| `.sinapse-ai/development/templates/prd-tmpl.yaml` | PRD |
| `.sinapse-ai/development/templates/architecture-tmpl.yaml` | 架构 |
| `.sinapse-ai/development/templates/story-tmpl.yaml` | 用户故事 |
| `.sinapse-ai/development/templates/qa-gate-tmpl.yaml` | 质量保证关卡 |

### 检查列表

| 文件 | 检查列表 |
|------|----------|
| `.sinapse-ai/development/checklists/po-master-checklist.md` | PO 验证 |
| `.sinapse-ai/development/checklists/story-draft-checklist.md` | 验证故事草稿 |
| `.sinapse-ai/development/checklists/story-dod-checklist.md` | 完成定义 |
...
*文档自动从 `.sinapse-ai/development/workflows/greenfield-service.yaml` 生成*
