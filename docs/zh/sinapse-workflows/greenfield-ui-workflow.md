...
| 问题 | 可能原因 | 解决方案 |
|------|---------|---------|
| 模板未找到 | 路径不正确 | 检查 `.sinapse-ai/development/templates/` |
...
| 文件 | 路径 |
|------|------|
| 工作流定义 | `.sinapse-ai/development/workflows/greenfield-ui.yaml` |
| 知识库 | `.sinapse-ai/data/sinapse-kb.md` |
...
| 模板 | 路径 |
|------|------|
| 项目简报 | `.sinapse-ai/development/templates/project-brief-tmpl.yaml` |
| PRD | `.sinapse-ai/development/templates/prd-tmpl.yaml` |
| 前端规范 | `.sinapse-ai/development/templates/front-end-spec-tmpl.yaml` |
| 前端架构 | `.sinapse-ai/development/templates/front-end-architecture-tmpl.yaml` |
| 故事 | `.sinapse-ai/development/templates/story-tmpl.yaml` |

### 检查列表

| 检查列表 | 路径 |
|---------|------|
| PO 主检查 | `.sinapse-ai/development/checklists/po-master-checklist.md` |
| 故事草稿 | `.sinapse-ai/development/checklists/story-draft-checklist.md` |
| 故事完成定义 | `.sinapse-ai/development/checklists/story-dod-checklist.md` |

### 相关文档

- [SINAPSE 知识库](.sinapse-ai/data/sinapse-kb.md) - 中央知识库
...
*文档自动从 `.sinapse-ai/development/workflows/greenfield-ui.yaml` 生成*
