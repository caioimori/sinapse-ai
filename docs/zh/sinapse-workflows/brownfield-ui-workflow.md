...
| **SINAPSE模板** | 已安装的模板 | 检查 `.sinapse-ai/development/templates/` |
| **已配置的代理** | 工作流的所有代理 | 检查 `.sinapse-ai/development/agents/` |
...
| 文档 | 位置 | 需要用于 |
|------|------|---------|
| PRD模板 | `.sinapse-ai/development/templates/brownfield-prd-tmpl.yaml` | 步骤2 |
| 前端模板 | `.sinapse-ai/development/templates/front-end-spec-tmpl.yaml` | 步骤3 |
| 架构模板 | `.sinapse-ai/development/templates/brownfield-architecture-tmpl.yaml` | 步骤4 |
| PO清单 | `.sinapse-ai/development/checklists/po-master-checklist.md` | 步骤5 |
| 故事模板 | `.sinapse-ai/development/templates/story-tmpl.yaml` | 步骤8 |
...
| 文档 | 位置 | 描述 |
|------|------|------|
| SINAPSE知识库 | `.sinapse-ai/data/sinapse-kb.md` | SINAPSE基础知识库 |
| IDE开发工作流 | `.sinapse-ai/data/sinapse-kb.md#IDE Development Workflow` | IDE开发工作流 |
| 棕地PRD模板 | `.sinapse-ai/development/templates/brownfield-prd-tmpl.yaml` | 棕地PRD模板 |
| 前端规范模板 | `.sinapse-ai/development/templates/front-end-spec-tmpl.yaml` | 前端规范模板 |
| 棕地架构模板 | `.sinapse-ai/development/templates/brownfield-architecture-tmpl.yaml` | 棕地架构模板 |
| PO主清单 | `.sinapse-ai/development/checklists/po-master-checklist.md` | PO验证清单 |

### 代理

| 代理 | 文件 | 文档 |
|------|------|------|
| @architect | `.sinapse-ai/development/agents/architect.md` | Aria - 整体系统架构师 |
| @pm | `.sinapse-ai/development/agents/pm.md` | Morgan - 产品经理 |
| @ux-expert | `.sinapse-ai/development/agents/ux-design-expert.md` | Uma - UX/UI设计师 |
| @po | `.sinapse-ai/development/agents/po.md` | Pax - 产品所有者 |
| @sm | `.sinapse-ai/development/agents/sm.md` | River - 敏捷主管 |
| @analyst | `.sinapse-ai/development/agents/analyst.md` | Atlas - 业务分析师 |
| @dev | `.sinapse-ai/development/agents/dev.md` | Dex - 全栈开发人员 |
| @qa | `.sinapse-ai/development/agents/qa.md` | Quinn - 测试架构师 |
...
*从`.sinapse-ai/development/workflows/brownfield-ui.yaml`自动生成的文档*
