...
本文档为所有 SINAPSE 代理定义了清晰的责任界限，特别关注:
...
- [ ] **创建 Git 前推送钩子**
  - 位置: `.git/hooks/pre-push`
  - 内容: 检查 `$SINAPSE_ACTIVE_AGENT`，如果 != "github-devops" 则阻止
...
- [ ] **更新代理激活脚本**
  - 添加环境变量配置: `SINAPSE_ACTIVE_AGENT={agent_id}`
  - 适当设置 `SINAPSE_GIT_PUSH_ALLOWED`
