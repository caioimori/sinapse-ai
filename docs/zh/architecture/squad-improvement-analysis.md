...
| **职位**       | Squad Creator                              |
| **图标**       | 🏗️                                         |
| **文件**       | `.sinapse-ai/development/agents/squad-creator.md` |
...
| `*publish-squad`   | squad-creator-publish.md     | ⏳ 占位符   | 发布到 sinapse-squads |
| `*sync-squad-sinapse` | squad-creator-sync-sinapse.md | ⏳ 占位符  | 同步到市场       |
...
| SquadPublisher  | squad-publisher.js   | 发布到 sinapse-squads |
