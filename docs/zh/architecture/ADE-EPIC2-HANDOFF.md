...
| 工件                 | 路径                                                      | 类型        | 状态 |
| -------------------- | --------------------------------------------------------- | ----------- | ---- |
| asset-inventory.js   | `.sinapse-ai/infrastructure/scripts/asset-inventory.js`    | JS 脚本     | ✅   |
| path-analyzer.js     | `.sinapse-ai/infrastructure/scripts/path-analyzer.js`      | JS 脚本     | ✅   |
| migrate-agent.js     | `.sinapse-ai/infrastructure/scripts/migrate-agent.js`      | JS 脚本     | ✅   |
...
- **所有代理**同步到 `.claude/commands/SINAPSE/agents/`
