...
> **日期:** 2026-01-28
> **项目:** SINAPSE 自主开发引擎 (ADE)

---

## 执行摘要

ADE 是一个 **提示工程 + 基础设施** 项目，用于在 SINAPSE 中启用自主开发执行。大约 **60% 的工作是创建 tasks .md、workflows .yaml 和模板** - 而不是传统代码。
...
- `docs/stories/sinapse-ai-ade/` (7 个 epic 文件 + README)

### Quality Gates

- `docs/qa/gates/sinapse-ai-ade/` (7 个 gate 文件 + README)

### 参考

- `docs/architecture/AUTO-CLAUDE-ANALYSIS-COMPLETE.md` (Auto-Claude 模式)
- `.sinapse-ai/core-config.yaml` (中央配置)
...
1. **阅读完整 PRD** - `docs/prd/sinapse-autonomous-development-engine.md`
