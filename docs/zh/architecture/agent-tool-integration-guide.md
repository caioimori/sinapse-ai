...
本指南说明如何将工具与 SINAPSE 代理集成。工具通过提供对外部服务、API 和系统资源的访问来扩展代理的能力。
...
| `tasks`        | 任务工作流文件                 | `.sinapse-ai/development/tasks/`    |
| `checklists`   | 验证清单                       | `.sinapse-ai/product/checklists/`   |

### 声明示例

```yaml
# 来自 .sinapse-ai/development/agents/dev.md
dependencies:
  checklists:
...
- [代理定义](../../../.sinapse-ai/development/agents/)
