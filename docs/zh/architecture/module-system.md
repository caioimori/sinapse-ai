...
SINAPSE 将 `.sinapse-ai/` 目录组织为四个主要模块：
...
| `data/` | `sinapse-kb.md`、`workflow-patterns.yaml` | 框架知识库 |
| `docs/` | 内部文档 | 组件指南、故障排除 |
...
| 代理 | ID | 责任 |
| --- | --- | --- |
| SINAPSE 主代理 | `sinapse-master` | 框架编排 |
| 开发者 | `dev` | 代码实现 |
| QA | `qa` | 质量保证 |
| 架构师 | `architect` | 技术架构 |
| 产品经理 | `po` | 产品待办 |
