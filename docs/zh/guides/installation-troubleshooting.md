...
| 命令                             | 描述                    |
| -------------------------------- | ----------------------- |
| `npx sinapse-ai@latest`           | 安装/运行向导            |
| `npx sinapse-ai@latest --version` | 显示版本                 |
| `npx sinapse-ai@latest --help`    | 显示帮助                 |
| `npx sinapse-ai@latest install`   | 在当前目录安装           |
| `npx sinapse-ai@latest init <名称>` | 创建新项目             |
| `npx sinapse-ai@latest doctor`    | 运行诊断                 |
| `npx sinapse-ai@latest info`      | 显示系统信息             |
