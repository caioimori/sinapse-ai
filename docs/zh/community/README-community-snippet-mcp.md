...
| 需要                         | 前往位置                                                                                                    |
| ---------------------------- | -------------------------------------------------------------------------------------------------------------- |
| 🔧 **MCP 问题?**        | 使用 ["MCP 生态" 类别](https://github.com/SynkraAI/sinapse-ai/discussions/categories/mcp-ecosystem) |
...
3. 在 [MCP 生态类别](https://github.com/SynkraAI/sinapse-ai/discussions/categories/mcp-ecosystem) 中讨论
