...
> **Status:** Draft → aguardando validação para iniciar execução.
...
- [ ] Zero `return { success: true }` sem trabalho subjacente (lint anti-teatro verde no CI).
- [ ] Um único caminho de execução (as 3 linhagens viram 1).
- [ ] Os 177 agentes de squad endereçáveis pelo motor.
- [ ] Pelo menos 1 gate capaz de bloquear de verdade num caso de teste.
- [ ] Suite E2E anti-teatro rodando como required check.
