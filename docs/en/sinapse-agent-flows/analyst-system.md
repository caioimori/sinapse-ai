...
> **EN** | [PT](../../sinapse-agent-flows/analyst-system.md) | [ES](../../es/sinapse-agent-flows/analyst-system.md)

---

## Summary

**@analyst** (Atlas) is the **Researcher** of the SINAPSE agent system. This agent is responsible for:
...
**[View Full Documentation (PT)](../../sinapse-agent-flows/analyst-system.md)**

---

*SINAPSE Agent Flows - @analyst System v1.0*
