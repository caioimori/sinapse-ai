...
> **EN** | [PT](../../sinapse-agent-flows/architect-system.md) | [ES](../../es/sinapse-agent-flows/architect-system.md)

---

## Summary

**@architect** (Aria) is the **Visionary** of the SINAPSE agent system. This agent is responsible for:
...
**[View Full Documentation (PT)](../../sinapse-agent-flows/architect-system.md)**

---

*SINAPSE Agent Flows - @architect System v1.0*
