...
> **EN** | [PT](../../sinapse-agent-flows/README.md) | [ES](../../es/sinapse-agent-flows/README.md) | [ZH](../../zh/sinapse-agent-flows/README.md)
...
This folder contains detailed documentation for all SINAPSE agents, including:
...
| SINAPSE Workflows | [docs/sinapse-workflows/](../../sinapse-workflows/) | Detailed workflows |
...
*SINAPSE Agent Flows Documentation v1.0 - Detailed documentation of the agent system*
