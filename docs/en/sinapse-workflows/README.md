...
> **EN** | [PT](../../sinapse-workflows/README.md) | [ES](../../es/sinapse-workflows/README.md) | [ZH](../../zh/sinapse-workflows/README.md)
...
This folder contains detailed documentation of all SINAPSE workflows, including:
...
| Agent Flows | [docs/sinapse-agent-flows/](../../sinapse-agent-flows/) | Agent details |
...
*SINAPSE Workflows Documentation v1.0 - Detailed documentation of development workflows*
