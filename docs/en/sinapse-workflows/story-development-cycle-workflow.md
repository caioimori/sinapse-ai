...
> **EN** | [PT](../../sinapse-workflows/story-development-cycle-workflow.md) | [ES](../../es/sinapse-workflows/story-development-cycle-workflow.md)

---

**Full documentation available in:** [Portuguese Version](../../sinapse-workflows/story-development-cycle-workflow.md)

---

## Summary

The **Story Development Cycle Workflow** is the core development process in SINAPSE. It orchestrates the complete lifecycle of implementing a user story:
...
- For every story implementation in SINAPSE
