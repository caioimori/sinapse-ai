...
**Repository:** caioimori/sinapse-ai
...
- [Framework Core (.sinapse-ai/)](#framework-core-sinapse-ai)
...
SINAPSE uses a **modular architecture** with clear separation of concerns:

1. **Framework Core** (`.sinapse-ai/`) - Portable framework components organized by domain
...
├── .sinapse-ai/                        # Framework core (modular)
...
│
├── bin/                               # CLI executables
│   └── sinapse.js                        # Main CLI entry point
│
...
│   ├── sinapse migration/                # SINAPSE migration stories
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Squads are modular extensions that add specialized capabilities to SINAPSE. Unlike the deprecated Squads, Squads follow a standardized template structure.
...
```
sinapse-ai/
├── .sinapse-ai/                        # Framework assets (modular v2.0)
│   ├── cli/                           # CLI commands and utilities
│   ├── core/                          # Framework essentials
│   │   ├── config/                    # Configuration system
...
```
squads/
├── verified/                          # SINAPSE-curated squads
│   ├── github-devops/
│   ├── db-sage/
│   └── coderabbit-workflow/
│
...
### REPO 4: caioimori/certified-partners (Private)
...
### REPO 5: caioimori/mmos (Private + NDA)
...
The ADE is configured via `.sinapse-ai/core-config.yaml`:
...
Runtime state is persisted in `.sinapse/`:
