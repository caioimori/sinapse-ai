...
|---|---|---|---|
| Constitution | Framework | L1 | Generated by installer, references `.sinapse-ai/constitution.md` |
...
- `<!-- FRAMEWORK-OWNED: Generated by SINAPSE installer, do not customize -->` for L1/L2 sections
...
Use `.sinapse-ai/development/checklists/memory-audit-checklist.md` periodically to:
