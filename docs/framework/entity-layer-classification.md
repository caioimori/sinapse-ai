...
Classification rules for the SINAPSE entity registry boundary layers.
...
|----------|-------|-------------|----------|
| 1 | L1 | `.sinapse-ai/core/**` | ids/index.js, utils/helpers.js |
...
| 9 | L2 | `.sinapse-ai/development/**` | tasks/, templates/, agents/ |
| 10 | L2 | `.sinapse-ai/infrastructure/**` | scripts/, tools/ |
...
|---------------------|----------|-------|
| modules | .sinapse-ai/core | L1 |
| utils | .sinapse-ai/core/utils | L1 |
| tasks | .sinapse-ai/development/tasks | L2 |
| templates | .sinapse-ai/product/templates | L2 |
| scripts | .sinapse-ai/development/scripts | L2 |
| checklists | .sinapse-ai/development/checklists | L2 |
| workflows | .sinapse-ai/development/workflows | L2 |
| tools | .sinapse-ai/development/tools | L2 |
| infra-scripts | .sinapse-ai/infrastructure/scripts | L2 |
| infra-tools | .sinapse-ai/infrastructure/tools | L2 |
| product-checklists | .sinapse-ai/product/checklists | L2 |
| product-data | .sinapse-ai/product/data | L2 |
| agents | .sinapse-ai/development/agents | L2 (MEMORY.md = L3) |
| data | .sinapse-ai/data | L3 |

## Usage

```javascript
const { classifyLayer } = require('./.sinapse-ai/core/ids/layer-classifier');

classifyLayer('.sinapse-ai/core/ids/index.js');  // => 'L1'
classifyLayer('.sinapse-ai/development/tasks/create-next-story.md');  // => 'L2'
classifyLayer('.sinapse-ai/data/entity-registry.yaml');  // => 'L3'
classifyLayer('docs/stories/story-1.md');  // => 'L4'
```

## Implementation

- **Module:** `.sinapse-ai/core/ids/layer-classifier.js`
