...
**Migration Target:** Q2 2026 → `SynkraAI/sinapse-ai` repository

---

## 📋 Overview

This directory contains **official SINAPSE framework documentation** that defines standards, patterns, and structures applicable across all SINAPSE projects (greenfield and brownfield).
...
**⚠️ IMPORTANT**: These documents are now in the `SynkraAI/sinapse-ai` repository. The migration from the old `sinapse/sinapse-ai` org was completed in December 2024 as part of OSR-9 (Rebranding).

### Migration Timeline

- **Phase 1 (Q1 2026 - Story 6.1.2.6):** ✅ Framework docs separated into `docs/framework/`
- **Phase 2 (Q4 2024):** ✅ Repository migrated to `SynkraAI/sinapse-ai` (OSR-9)
...
- **Lifecycle**: Lives in `SynkraAI/sinapse-ai` repository
...
### For Developers
1. **Read framework docs during onboarding** - Understand SINAPSE standards
...
### For SINAPSE Framework Maintainers
...
**Maintainer**: SINAPSE Framework Team
