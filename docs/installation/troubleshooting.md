...
> 🌐 **EN** | [PT](../pt/installation/troubleshooting.md)
...
### Issue 1: "npx sinapse-ai is not recognized"
...
```bash
# Check SINAPSE installation status
npx sinapse-ai status
...
3. Search existing [GitHub Issues](https://github.com/caioimori/sinapse-ai/issues)
