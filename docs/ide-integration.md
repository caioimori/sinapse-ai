...
SINAPSE supports multiple AI-powered development platforms. Choose the one that best fits your workflow.

### Quick Status Matrix (SINAPSE 4.2.11)
...
| Gemini CLI | Works | `/sinapse-menu` then `/sinapse-<agent>` | Works (minor differences in event handling) | -- |
...
Legend:
- `Works`: fully recommended for new users in SINAPSE 4.2.11.
...
_SINAPSE IDE Integration Guide v4.2.11_
