# SINAPSE Troubleshooting Guide

> 🌐 **EN** | [PT](./pt/troubleshooting.md) | [ES](./es/troubleshooting.md)

---

This comprehensive guide helps you diagnose and resolve common issues with SINAPSE.
...
```javascript
// Edit .sinapse/memory-config.json
{
...
2. **Collect information:**
   ...
   - SINAPSE version: `npx sinapse-ai version`
...
- **Stack Overflow**: Tag questions with `sinapse-ai`
...
## Steps to Reproduce
1. Run `npx sinapse-ai init test`
