...
**Versão:** 1.0
**Criado:** 2026-02-04
**Fonte:** `.sinapse-ai/development/workflows/greenfield-service.yaml`
...
**Referencia:** `.sinapse-ai/data/sinapse-kb.md#IDE Development Workflow`
...
|----------|-------------|--------|
| `project-brief-tmpl.yaml` | `.sinapse-ai/development/templates/` | analyst |
| `prd-tmpl.yaml` | `.sinapse-ai/development/templates/` | pm |
| `architecture-tmpl.yaml` | `.sinapse-ai/development/templates/` | architect |
| `story-tmpl.yaml` | `.sinapse-ai/development/templates/` | sm |
| `qa-gate-tmpl.yaml` | `.sinapse-ai/development/templates/` | qa |
...
| Tipo | Localizacao |
|------|-------------|
| Logs do agente | `.sinapse/logs/agent.log` |
| Status do projeto | `.sinapse/project-registry.yaml` |
...
cat .sinapse/project-status.yaml
...
| Arquivo | Descricao |
|---------|-----------|
| `.sinapse-ai/development/workflows/greenfield-service.yaml` | Definicao do workflow |
| `.sinapse-ai/data/sinapse-kb.md` | Knowledge base do SINAPSE |
...
| Arquivo | Task |
|---------|------|
| `.sinapse-ai/development/tasks/create-doc.md` | Criacao de documentos |
| `.sinapse-ai/development/tasks/shard-doc.md` | Fragmentacao de documentos |
| `.sinapse-ai/development/tasks/sm-create-next-story.md` | Criacao de stories |
| `.sinapse-ai/development/tasks/dev-develop-story.md` | Implementacao de stories |
| `.sinapse-ai/development/tasks/qa-review-story.md` | Revisao de implementacao |
| `.sinapse-ai/development/tasks/execute-checklist.md` | Execucao de checklists |

### Templates

| Arquivo | Template |
|---------|----------|
| `.sinapse-ai/development/templates/project-brief-tmpl.yaml` | Project Brief |
| `.sinapse-ai/development/templates/prd-tmpl.yaml` | PRD |
| `.sinapse-ai/development/templates/architecture-tmpl.yaml` | Arquitetura |
| `.sinapse-ai/development/templates/story-tmpl.yaml` | User Story |
| `.sinapse-ai/development/templates/qa-gate-tmpl.yaml` | QA Gate |

### Checklists

| Arquivo | Checklist |
|---------|-----------|
| `.sinapse-ai/development/checklists/po-master-checklist.md` | Validacao PO |
| `.sinapse-ai/development/checklists/story-draft-checklist.md` | Validacao Story Draft |
| `.sinapse-ai/development/checklists/story-dod-checklist.md` | Definition of Done |
