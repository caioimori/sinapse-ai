...
| @project-lead | Morgan | Product Manager | Criação de PRD para brownfield |
| @product-lead | Pax | Product Owner | Validação de artefatos, fragmentação de docs, retrospectiva |
| @sprint-lead | River | Scrum Master | Criação de stories |
| @analyst | Atlas | Business Analyst | Revisão opcional de story drafts |
| @developer | Dex | Full Stack Developer | Implementacao de stories, correção de feedback |
| @quality-gate | Quinn | Test Architect | Revisão de implementação, quality gates |
...
| `execute-checklist` | `po-master-checklist.md` | @product-lead | Validação |
| `shard-doc` | - | @product-lead | Validação |
...
4. **Templates Disponíveis**
   - `.sinapse-ai/development/templates/brownfield-prd-tmpl.yaml`
   - `.sinapse-ai/development/templates/brownfield-architecture-tmpl.yaml`
   - `.sinapse-ai/development/templates/story-tmpl.yaml`

5. **Checklists Disponíveis**
   - `.sinapse-ai/development/checklists/po-master-checklist.md`
   - `.sinapse-ai/development/checklists/story-draft-checklist.md`
   - `.sinapse-ai/development/checklists/story-dod-checklist.md`
...
|---------|-----------|---------|
| Workflow Definition | Definição YAML do workflow | `.sinapse-ai/development/workflows/brownfield-service.yaml` |
| PRD Template | Template para brownfield PRD | `.sinapse-ai/development/templates/brownfield-prd-tmpl.yaml` |
| Architecture Template | Template para arquitetura | `.sinapse-ai/development/templates/brownfield-architecture-tmpl.yaml` |
| Story Template | Template para stories | `.sinapse-ai/development/templates/story-tmpl.yaml` |
| PO Master Checklist | Checklist de validação | `.sinapse-ai/development/checklists/po-master-checklist.md` |
| Story Draft Checklist | Checklist de story | `.sinapse-ai/development/checklists/story-draft-checklist.md` |
| Story DoD Checklist | Definition of Done | `.sinapse-ai/development/checklists/story-dod-checklist.md` |
