...
flowchart TB
    ...
    PF3 -->|Existe| PF4
    PF3 -->|Não existe| ERR3[Erro: SINAPSE incompleto]
...
**Estrutura Criada:**
```
.sinapse/worktrees/{storyId}/     # Diretório de trabalho
...
| Propriedade | Valor |
|-------------|-------|
| **Localização** | `.sinapse-ai/development/tasks/create-worktree.md` |
| **Agente** | @devops (Gage) |
| **Versão** | 1.0 |
| **Story** | 1.3 |
...
3. Aumentar limite (se necessário) em `.sinapse/config.yaml`
