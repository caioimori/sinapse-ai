...
| Arquivo | Localização |
|---------|-------------|
| Definicao do Workflow | `.sinapse-ai/development/workflows/spec-pipeline.yaml` |
| Task: Gather | `.sinapse-ai/development/tasks/spec-gather-requirements.md` |
| Task: Assess | `.sinapse-ai/development/tasks/spec-assess-complexity.md` |
| Task: Research | `.sinapse-ai/development/tasks/spec-research-dependencies.md` |
| Task: Write Spec | `.sinapse-ai/development/tasks/spec-write-spec.md` |
| Task: Critique | `.sinapse-ai/development/tasks/spec-critique.md` |
| Task: Create Plan | `.sinapse-ai/development/tasks/plan-create-implementation.md` |
