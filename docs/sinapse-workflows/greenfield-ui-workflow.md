...
|------|--------|-----------|
| `create-next-story.md` | @sprint-lead | Criar próxima story |
| `execute-checklist.md` | @sprint-lead | Checklist de story draft |
| `dev-develop-story.md` | @developer | Implementar story |
| `apply-qa-fixes.md` | @developer | Aplicar correções QA |
| `review-story.md` | @quality-gate | Revisar implementação |
| `qa-gate.md` | @quality-gate | Decisão de quality gate |
...
| Problema | Causa Provável | Solução |
|----------|----------------|---------|
| Templates nao encontrados | Path incorreto | Verificar `.sinapse-ai/development/templates/` |
...
| Arquivo | Caminho |
|---------|---------|
| Definição do Workflow | `.sinapse-ai/development/workflows/greenfield-ui.yaml` |
...
| Template | Caminho |
|----------|---------|
| Project Brief | `.sinapse-ai/development/templates/project-brief-tmpl.yaml` |
| PRD | `.sinapse-ai/development/templates/prd-tmpl.yaml` |
| Frontend Spec | `.sinapse-ai/development/templates/front-end-spec-tmpl.yaml` |
| Frontend Architecture | `.sinapse-ai/development/templates/front-end-architecture-tmpl.yaml` |
| Story | `.sinapse-ai/development/templates/story-tmpl.yaml` |

### Checklists

| Checklist | Caminho |
|-----------|---------|
| PO Master | `.sinapse-ai/development/checklists/po-master-checklist.md` |
| Story Draft | `.sinapse-ai/development/checklists/story-draft-checklist.md` |
| Story DoD | `.sinapse-ai/development/checklists/story-dod-checklist.md` |
