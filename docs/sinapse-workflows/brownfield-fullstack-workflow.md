...
| Arquivo | Propósito |
|---------|-----------|
| `.sinapse-ai/development/workflows/brownfield-fullstack.yaml` | Definição do workflow |
...
| `.sinapse-ai/product/checklists/po-master-checklist.md` | Checklist de validação PO |
