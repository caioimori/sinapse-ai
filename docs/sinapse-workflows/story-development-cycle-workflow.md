...
O **Story Development Cycle** e o workflow central do SINAPSE para desenvolvimento de stories. Ele automatiza o fluxo completo desde a criacao ate a entrega com quality gate integrado, seguindo a sequencia: **criar -> validar -> implementar -> QA review**.
...
1. **core-config.yaml** - Arquivo de configuracao SINAPSE obrigatorio
...
2. **Story Template** - `story-tmpl.yaml` disponivel em `.sinapse-ai/development/templates/`
...
| Story template | YAML | `.sinapse-ai/development/templates/` | Template padrao |
...
|-------|------|---------|----------|-------------------|-------------------|
| Validação PO | 2 | @product-lead | 10 checks passam | Status: Ready | Retorna para SM |
...
| QA Gate Task | `.sinapse-ai/development/tasks/qa-gate.md` |
| Story Template | `.sinapse-ai/development/templates/story-tmpl.yaml` |
