...
**Localização:** `.sinapse-ai/development/tasks/qa-review-story.md`
...
**Localização:** `.sinapse-ai/development/tasks/dev-apply-qa-fixes.md`
...
No arquivo `.sinapse-ai/core-config.yaml`:
...
| Arquivo | Localização |
|---------|-------------|
| Workflow Definition | `.sinapse-ai/development/workflows/qa-loop.yaml` |
...
|----------|-------------|-----|
| `qa-gate-tmpl.yaml` | `.sinapse-ai/development/templates/` | Gate file structure |
| `story-tmpl.yaml` | `.sinapse-ai/development/templates/` | Story file structure |
