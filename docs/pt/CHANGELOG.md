...
Todas as alteracoes notaveis do SINAPSE serao documentadas neste arquivo.
...
- **Estrutura de Diretorios**: Renomeado `.legacy-core/` para `.sinapse-ai/`
...
- **Configuracao de IDE**: Agentes do Claude Code movidos para `.claude/commands/SINAPSE/agents/`
- **Localizacao de Arquivos**:
  ...
  - `.sinapse-ai/utils/` -> `.sinapse-ai/scripts/`
...
- Processo de instalacao manual (use `npx sinapse-ai install` em vez disso)
...
- Lancamento publico inicial do SINAPSE
...
1. Diretorio renomeado: `.legacy-core/` -> `.sinapse-ai/`
...
- [Repositorio GitHub](https://github.com/caioimori/sinapse-ai)
- [Rastreador de Issues](https://github.com/caioimori/sinapse-ai/issues)
