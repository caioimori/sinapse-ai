...
| -------------------- | -------------------------------------------------------- | ----------- | ------ |
| asset-inventory.js   | `.sinapse-ai/infrastructure/scripts/asset-inventory.js`   | JS Script   | ✅     |
| path-analyzer.js     | `.sinapse-ai/infrastructure/scripts/path-analyzer.js`     | JS Script   | ✅     |
| migrate-agent.js     | `.sinapse-ai/infrastructure/scripts/migrate-agent.js`     | JS Script   | ✅     |
| agent-v3-schema.json | `.sinapse-ai/infrastructure/schemas/agent-v3-schema.json` | JSON Schema | ✅     |
| task-v3-schema.json  | `.sinapse-ai/infrastructure/schemas/task-v3-schema.json`  | JSON Schema | ✅     |
...
- **Todos os agents** sincronizados em `.claude/commands/SINAPSE/agents/`
