...
- `docs/stories/sinapse-ai-ade/` (7 arquivos de epic + README)

### Quality Gates

- `docs/qa/gates/sinapse-ai-ade/` (7 arquivos de gate + README)

### Referência

- `docs/architecture/AUTO-CLAUDE-ANALYSIS-COMPLETE.md` (patterns do Auto-Claude)
- `.sinapse-ai/core-config.yaml` (configuração central)
