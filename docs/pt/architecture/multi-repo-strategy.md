...
> **PT** | [EN](../architecture/multi-repo-strategy.md)
...
- [Repositório Principal (sinapse-ai)](#repositório-principal-sinapse-ai)
...
SINAPSE v4 adota uma **estratégia multi-repositório** para viabilizar desenvolvimento modular, contribuições comunitárias e separação clara entre framework principal, extensões (squads) e componentes proprietários.
...
```
Organização SinapseAI
├── REPOSITÓRIOS PÚBLICOS
│   ├── sinapse-ai          # Framework principal (MIT)
│   ├── sinapse-squads        # Squads comunitárias (MIT)
...
## Repositório Principal (sinapse-ai)

### Propósito

O repositório principal contém o framework SINAPSE fundamental que todos os projetos dependem.

### Conteúdo

| Diretório                    | Descrição                                                |
| ---------------------------- | -------------------------------------------------------- |
| `.sinapse-ai/core/`           | Fundações do framework (config, registry, gates de qualidade) |
| `.sinapse-ai/development/`    | Definições de agentes, tarefas, workflows                |
| `.sinapse-ai/product/`        | Templates, checklists, dados de PM                       |
| `.sinapse-ai/infrastructure/` | Scripts, ferramentas, integrações                        |
...
Squads são extensões modulares que adicionam capacidades especializadas ao SINAPSE.

### Repositório sinapse-squads
...
```bash
# A partir de sinapse-ai
npm publish --access public

# A partir de sinapse-squads/etl
...
2. **Dependências de Pares** - Especifique requisitos exatos de versão sinapse-ai
...
- Guia de Migração v2.0 para v4.0.4
- [Guia de Squads](../guides/squads-guide.md)

---

_Última Atualização: 2026-01-28 | Time do Framework SINAPSE_
