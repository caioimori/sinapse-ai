...
**Definição:** Integração de utilitários é o processo de tornar um script utilitário órfão **descobrível, documentado e utilizável** dentro do framework SINAPSE.
...
- `.sinapse-ai/agents/{agent}.yaml` (adicionar a dependencies.utils)
- `.sinapse-ai/core-config.yaml` (registrar se necessário)
- `.sinapse-ai/utils/README.md` (documentar utilitário)
...
**Arquivos Modificados:**
- `.sinapse-ai/tasks/{task}.md` (adicionar execution.utils)
- `.sinapse-ai/agents/{agent}.yaml` (adicionar task à lista executes)
- `.sinapse-ai/core-config.yaml` (registrar se necessário)
- `.sinapse-ai/utils/README.md` (documentar utilitário)
...
**Arquivos Modificados:**
- `.sinapse-ai/core-config.yaml` (registrar em framework)
- `.sinapse-ai/utils/README.md` (documentar como utilitário de framework)
...
- `.sinapse-ai/tasks/{task}.md` (se criar task)
- `.sinapse-ai/core-config.yaml`
...
**Exemplos:** sinapse-validator, code-quality-improver, coverage-analyzer
...
**Localização:** `.sinapse-ai/utils/{name}.js`
