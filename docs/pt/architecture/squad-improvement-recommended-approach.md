...
```
.sinapse-ai/development/scripts/squad/
...
```
.sinapse-ai/development/agents/squad-creator.md  # Adicionar novos comandos
.sinapse-ai/schemas/squad-schema.json            # (sem alterações necessárias)
```
