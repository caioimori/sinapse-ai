# 🔴 SINAPSE Dashboard - Arquitetura de Observabilidade em Tempo Real

> **PT** | [EN](../architecture/dashboard-realtime.md)
...
Este documento descreve a arquitetura para **observabilidade em tempo real** do SINAPSE Dashboard, permitindo que usuários acompanhem comandos executados no CLI com máximo detalhe visual.
...
│                                                                              │
│  .sinapse/dashboard/events.jsonl (HIGH-LEVEL ONLY)                             │
│  ─────────────────────────────────────────────────────                      │
