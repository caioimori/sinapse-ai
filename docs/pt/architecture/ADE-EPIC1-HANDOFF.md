...
| ------------------------ | ------------------------------------------------------------ | --------- | ------ |
| worktree-manager.js      | `.sinapse-ai/infrastructure/scripts/worktree-manager.js`      | JS Script | ✅     |
| story-worktree-hooks.js  | `.sinapse-ai/infrastructure/scripts/story-worktree-hooks.js`  | JS Script | ✅     |
| project-status-loader.js | `.sinapse-ai/infrastructure/scripts/project-status-loader.js` | JS Script | ✅     |
| auto-worktree.yaml       | `.sinapse-ai/development/workflows/auto-worktree.yaml`        | Workflow  | ✅     |
| worktree-create.md       | `.sinapse-ai/development/tasks/worktree-create.md`            | Task      | ✅     |
| worktree-list.md         | `.sinapse-ai/development/tasks/worktree-list.md`              | Task      | ✅     |
| worktree-merge.md        | `.sinapse-ai/development/tasks/worktree-merge.md`             | Task      | ✅     |
...
- **status.json**: Status do worktree rastreado em `.sinapse/status.json`
- **Dashboard**: API do WorktreeManager consumida pelo SINAPSE Dashboard
