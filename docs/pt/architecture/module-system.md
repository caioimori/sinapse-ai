...
> Guia completo para a arquitetura modular v4.2 do SINAPSE.
...
O SINAPSE organiza o diretório `.sinapse-ai/` em quatro módulos principais:
...
| `data/`          | `sinapse-kb.md`, `workflow-patterns.yaml`           | Base de conhecimento do framework           |
...
**Caminho:** `.sinapse-ai/development/`
...
**Caminho:** `.sinapse-ai/infrastructure/`
