...
**SINAPSE (AI Operating System)** é um framework sofisticado para orquestração de agentes de IA, workers e humanos em fluxos de trabalho complexos de desenvolvimento de software. A versão 2.1 introduz uma arquitetura modular com 4 módulos, estratégia multi-repositório e quality gates de 3 camadas.
...
```
sinapse-ai/
├── .sinapse-ai/                    # Camada do Framework
...
| ------------------ | ---------------------------- | --------------------- | ------------------------------------ |
| **Core**           | `.sinapse-ai/core/`           | Fundação do framework | Config, Registry, QG, MCP, Session   |
| **Development**    | `.sinapse-ai/development/`    | Artefatos de dev      | Agentes, Tarefas, Workflows, Scripts |
| **Product**        | `.sinapse-ai/product/`        | Artefatos PM          | Templates, Checklists, Dados         |
| **Infrastructure** | `.sinapse-ai/infrastructure/` | Config do sistema     | Scripts, Ferramentas, Integrações    |
...
- [SINAPSE-LIVRO-DE-OURO-V2.1-COMPLETE.md](../../../.sinapse-ai/docs/standards/SINAPSE-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Guia completo do framework
