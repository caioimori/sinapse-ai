...
Este guia explica como ferramentas são integradas com agentes SINAPSE. Ferramentas estendem as capacidades dos agentes fornecendo acesso a serviços externos, APIs e recursos do sistema.
...
| `tasks`        | Arquivos de workflow de tarefas     | `.sinapse-ai/development/tasks/`    |
| `checklists`   | Checklists de validação             | `.sinapse-ai/product/checklists/`   |
...
SINAPSE implementa governança rigorosa de operações git:
...
- [Definições de Agentes](../../../.sinapse-ai/development/agents/)
