...
> 🌐 [EN](../agent-reference-guide.md) | **PT**
...
- Diagrama de Workflow - Representação visual do workflow de 9 fases
- Workflow YAML - Configuração de orquestração de workflow
...
**Mantenedor**: Equipe SINAPSE HybridOps
