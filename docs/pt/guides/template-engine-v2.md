...
> Motor de geração de documentos e substituição de variáveis para SINAPSE.
...
O Template Engine fornece uma forma consistente de gerar documentos (PRDs, ADRs, Stories, etc.) com substituição de variáveis, condicionais e loops. Ele alimenta todas as tarefas de geração de documentos no SINAPSE.
...
_SINAPSE Template Engine v2.0_
