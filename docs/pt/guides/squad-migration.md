...
Como migrar squads legados para o formato SINAPSE 2.1.

## Visão Geral

SINAPSE 2.1 introduziu um novo formato de squad com:
...
| Campo SINAPSE type      | Ausente       | `sinapse.type: squad`         |
| Versão mínima        | Ausente       | `sinapse.minVersion: "2.1.0"` |
...
- Adiciona campos `sinapse` ausentes ao manifesto
...
- [ ] `sinapse.type` é `"squad"`
- [ ] `sinapse.minVersion` é `"2.1.0"` ou superior
