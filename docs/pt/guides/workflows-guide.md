...
Os Workflows do SINAPSE sao sequencias orquestradas de atividades de agents que automatizam processos de desenvolvimento complexos. Eles fornecem padroes estruturados e repetitivos para cenarios de desenvolvimento comuns.
...
O state e persistido em `.sinapse/{instance-id}-state.yaml`:
...
O SINAPSE detecta padroes comuns de workflow baseados no historico de comandos:
...
| **Localizacao** | `.sinapse-ai/development/workflows/` | `.sinapse-ai/development/tasks/` |
...
- Diagrama de Workflow HybridOps - Padroes de colaboracao humano-agent
