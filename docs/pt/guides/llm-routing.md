...
**Opção 1: Se você tem o sinapse-ai clonado**
```bash
# Do diretório sinapse-ai
...
- **Definição da Ferramenta:** `.sinapse-ai/infrastructure/tools/cli/llm-routing.yaml`
- **Script de Instalação:** `.sinapse-ai/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Definição de Tarefa:** `.sinapse-ai/development/tasks/setup-llm-routing.md`
...
*Gerado pelo SINAPSE Framework - Story 6.7*
