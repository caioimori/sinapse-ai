...
Guia completo para desenvolvedores que desejam contribuir com o projeto SINAPSE.
...
| -------------------- | --------------------------------------------- |
| **Claude Code**      | Desenvolvimento com IA usando agentes SINAPSE    |
| **VS Code / Cursor** | IDE com integração SINAPSE                       |
...
1. Navegue até [github.com/caioimori/sinapse-ai](https://github.com/caioimori/sinapse-ai)
...
Sincronizar agentes SINAPSE com sua IDE:
...
Entendendo a estrutura de diretórios do `sinapse-ai`:

```
sinapse-ai/
├── .sinapse-ai/                    # Fonte do framework (commitado)
...
| ----------------------------------- | ----------------------------- | ------------------------- |
| `.sinapse-ai/development/agents/`    | Personas e comportamentos de agentes | Adicionar/modificar agentes |
| `.sinapse-ai/development/tasks/`     | Workflows de tasks executáveis | Adicionar/modificar tasks |
| `.sinapse-ai/development/workflows/` | Orquestrações multi-etapas    | Criar workflows           |
...
Crie um novo arquivo em `.sinapse-ai/development/agents/`:

```bash
# Arquivo: .sinapse-ai/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Criar em .sinapse-ai/development/tasks/
  checklists:
    - my-agent-checklist.md  # Criar em .sinapse-ai/development/checklists/
  tools:
    - git
    - context7
````
...
Crie um novo arquivo em `.sinapse-ai/development/tasks/`:
...
# .sinapse-ai/development/tasks/create-doc.md          (compartilhada)
```
...
## Definição da Task (SINAPSE Task Format V1.0)
...
Crie um novo arquivo em `.sinapse-ai/development/workflows/`:

```bash
# Arquivo: .sinapse-ai/development/workflows/my-workflow.yaml
```
...
- Marque `@caioimori/core-team` para issues urgentes
