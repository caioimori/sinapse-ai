...
> Guia completo sobre a estratégia de testes, ferramentas e melhores práticas do SINAPSE.
...
O SINAPSE segue uma estratégia abrangente de testes que garante qualidade de código em todas as camadas do framework. Nossa filosofia de testes é baseada em:
 ...
 *
 * Garante que agentes de versões anteriores do SINAPSE continuem funcionando.
 */
...
O SINAPSE suporta Windows, macOS e Linux. Testes cross-platform garantem comportamento consistente.
...
│   └── .sinapse-ai/       # Cobertura por módulo
...
O Sistema de Quality Gate do SINAPSE (veja [Guia de Quality Gates](./quality-gates.md)) integra testes em múltiplas camadas:
