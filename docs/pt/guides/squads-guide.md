...
Guia completo para criar, validar, publicar e gerenciar Squads no SINAPSE.
...
Squads são equipes modulares de agentes de IA que estendem a funcionalidade do SINAPSE. Cada squad é um pacote autocontido contendo:
...
| -------------------------------------------------------------------------- | ------ | ---------------------------------- |
| [etl-squad](https://github.com/SynkraAI/sinapse-squads/tree/main/etl)         | 2.0.0  | Coleta e transformação de dados    |
| [creator-squad](https://github.com/SynkraAI/sinapse-squads/tree/main/creator) | 1.0.0  | Utilitários de geração de conteúdo |
...
- Node.js 18+
- Projeto SINAPSE inicializado (`.sinapse-ai/` existe)
...
| Modo       | Comportamento                                   |
| ---------- | ----------------------------------------------- |
| `extend`   | Adiciona regras do squad às regras core do SINAPSE |
...
### Nível 2: Repositório sinapse-squads (Público)
...
Isso cria um PR para [SynkraAI/sinapse-squads](https://github.com/SynkraAI/sinapse-squads).
...
3. **Adicionar Campos** - `sinapse.type`, `sinapse.minVersion`
...
# - sinapse.type: deve ser "squad"
# - sinapse.minVersion: deve ser semver válido
```
...
- [Repositório sinapse-squads](https://github.com/SynkraAI/sinapse-squads)
...
_SINAPSE Squads: Equipes de AI agents trabalhando com você_
