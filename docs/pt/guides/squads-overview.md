...
Introdução aos SINAPSE Squads - equipes modulares de agentes de IA que estendem a funcionalidade do framework.
...
Squads são equipes modulares de agentes de IA que estendem a funcionalidade do SINAPSE para domínios ou casos de uso específicos. Cada squad é um pacote autocontido que pode ser instalado, compartilhado e composto com outros squads.

> **SINAPSE Squads:** Equipes de agentes de IA trabalhando com você
...
| Agentes Tradicionais   | SINAPSE Squads                  |
| ---------------------- | ---------------------------- |
...
| ----------------- | ------ | ---------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0  | Coleta e transformação de dados    | [sinapse-squads/etl](https://github.com/SynkraAI/sinapse-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0  | Utilitários de geração de conteúdo | [sinapse-squads/creator](https://github.com/SynkraAI/sinapse-squads/tree/main/creator) |
...
│  Nível 2: SINAPSE-SQUADS  --> github.com/SynkraAI (Público)     │
...
Tasks devem seguir [TASK-FORMAT-SPECIFICATION-V1](../../../.sinapse-ai/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).

### 2. Use Herança de Configuração com Sabedoria

| Modo       | Comportamento                           |
| ---------- | --------------------------------------- |
| `extend`   | Adiciona regras do squad às regras SINAPSE |
| `override` | Substitui regras SINAPSE pelas do squad    |
...
- **Explore Squads Oficiais:** Confira o [repositório sinapse-squads](https://github.com/SynkraAI/sinapse-squads)
...
- [Especificação de Formato de Task](../../../.sinapse-ai/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
### Qual a diferença entre um Squad e formatos legados de squad no SINAPSE?

**Squads** são o padrão no SINAPSE 2.1+ com:
...
Squads requerem SINAPSE 2.1.0+. Defina no manifesto:
...
_SINAPSE Squads: Equipes de agentes de IA trabalhando com você_
