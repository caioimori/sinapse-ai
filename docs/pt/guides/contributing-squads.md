...
Como contribuir squads para o ecossistema SINAPSE.

## Visão Geral

Existem duas formas de compartilhar seu squad com a comunidade:

1. **Repositório sinapse-squads** - Squads gratuitos e open-source no GitHub
2. **SINAPSE Marketplace** - Squads premium via API SINAPSE
...
| **Compatibilidade SINAPSE** | `sinapse.minVersion: "2.1.0"` ou superior |
...
Isso irá:
1. Fazer fork de `SynkraAI/sinapse-squads` (se necessário)
...
## Publicando no SINAPSE Marketplace
...
- **Perguntas**: [GitHub Discussions](https://github.com/SynkraAI/sinapse-ai/discussions)
- **Issues**: [Issue Tracker](https://github.com/SynkraAI/sinapse-ai/issues)
