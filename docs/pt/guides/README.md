...
> 🌐 [EN](../../guides/README.md) | **PT**

---

Índice completo de documentação para os guias do sistema SINAPSE.
...
> **Nota:** A documentação do 1MCP foi descontinuada. O SINAPSE agora usa exclusivamente o Docker MCP Toolkit (Story 5.11). Documentos arquivados disponíveis em `.github/deprecated-docs/guides/`.
...
| **Guia de Migração v2.0→v4.0.4**         | Instruções passo a passo de migração    | 20 min | Todos os usuários atualizando |
