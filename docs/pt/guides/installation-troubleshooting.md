...
# Guia de Instalação e Solução de Problemas do SINAPSE-Core
...
Este comando baixa e executa a versão mais recente do instalador do SINAPSE-Core.
...
npx --ignore-existing sinapse-ai@latest
...
| Comando | Descrição |
|---------|-----------|
| `npx sinapse-ai@latest` | Instalar/executar assistente |
| `npx sinapse-ai@latest --version` | Mostrar versão |
| `npx sinapse-ai@latest --help` | Mostrar ajuda |
| `npx sinapse-ai@latest install` | Instalar no diretório atual |
| `npx sinapse-ai@latest init <name>` | Criar novo projeto |
| `npx sinapse-ai@latest doctor` | Executar diagnósticos |
| `npx sinapse-ai@latest info` | Mostrar informações do sistema |

---

*Última atualização: Dezembro 2025 | SINAPSE-Core v2.2.0*
