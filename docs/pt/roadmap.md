...
> Para rastreamento detalhado, veja nosso [Projeto GitHub](https://github.com/orgs/caioimori/projects/1)

## Visão

O SINAPSE visa ser o framework de agentes IA open-source mais abrangente, permitindo que desenvolvedores construam aplicações sofisticadas com equipes de agentes especializados (Squads) e integração perfeita com IDEs.
...
Reaja com :+1: em [Ideias nas Discussões](https://github.com/caioimori/sinapse-ai/discussions/categories/ideas) existentes para mostrar apoio.

### 2. Proponha Features

Tem uma nova ideia? Abra uma [Discussão de Ideia](https://github.com/caioimori/sinapse-ai/discussions/new?category=ideas) para compartilhar com a comunidade.
...
5. Comunicar mudanças significativas via [Anúncios](https://github.com/caioimori/sinapse-ai/discussions/categories/announcements)
...
|-----------------|---------------------|
| [Projeto GitHub](https://github.com/orgs/caioimori/projects/1) | `docs/stories/backlog.md` |
