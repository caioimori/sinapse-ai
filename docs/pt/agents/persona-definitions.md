...
# Definições de Personas dos Agentes SINAPSE

**Versão:** 1.0
**Criado:** 2025-01-14
**Autor:** @ux-design-expert (Uma)
**Propósito:** Definições abrangentes de personas para todos os 12 agentes SINAPSE para habilitar sistema de agentes nomeados com identidade consistente

---

## Visão Geral

Este documento define personas completas para os 12 agentes SINAPSE, fornecendo:
...
**Nota:** Este agente irá mesclar funcionalidades de `sinapse-developer` e `sinapse-orchestrator` em um único agente mestre.
