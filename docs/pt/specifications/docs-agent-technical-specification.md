...
**@docs (Ajax)** e um agente de IA especializado em criar **documentacao educacional** para o SINAPSE. Diferente da documentacao tecnica (JSDoc/Typedoc), Ajax foca em **tutoriais, guias de onboarding, explicadores visuais e materiais de treinamento para parceiros**.
...
- Aprovacao unanime da mesa redonda (Brad Frost, Marty Cagan, Paul Graham)
...
whenToUse: |
  ...
  - Tutoriais explicando como usar recursos do SINAPSE
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Usa estilo consistente (paleta de cores SINAPSE)"
      blocker: false
...
whenToUse: |
  ...
  - Novo parceiro entra no ecossistema SINAPSE
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Links para documentacao SINAPSE relevante"
      blocker: false
...
[Nome do Agente] e o agente de [funcao] do SINAPSE, especializado em [expertise principal].
...
**Notas do Template:**
- Use paleta de cores SINAPSE (Azul primario, Roxo secundario, Rosa terciario)
...
```bash
#!/bin/bash
# Hook de Auto-Atualizacao @docs do SINAPSE
...
- [ ] Criar `squads/sinapse/agents/docs/agent.yaml`
...
- [ ] **Reconhecimento da Industria:** Docs do SINAPSE citados como "melhor no espaco de agentes de IA"
...
Com a adicao do @docs (Ajax), SINAPSE agora tem **13 agentes nomeados**:
