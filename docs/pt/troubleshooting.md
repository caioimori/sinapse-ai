...
Este guia abrangente ajuda você a diagnosticar e resolver problemas comuns com o SINAPSE.
...
2. **Colete informações:**
   ...
   - Versão do SINAPSE: `npx sinapse-ai version`
...
- **Stack Overflow**: Marque perguntas com `sinapse-ai`
...
1. Executar `npx sinapse-ai init test`
