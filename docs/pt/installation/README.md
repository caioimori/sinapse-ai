...
Este diretório contém documentação abrangente de instalação e configuração para o SINAPSE.
...
3. Abra uma [Issue no GitHub](https://github.com/caioimori/sinapse-ai/issues)
