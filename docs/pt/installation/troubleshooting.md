...
> 🌐 [EN](../../installation/troubleshooting.md) | **PT**
...
### Problema 1: "npx sinapse-ai is not recognized"
...
```bash
# Verifique status da instalação SINAPSE
npx sinapse-ai status
...
```bash
# Verifique estrutura .sinapse-ai
...
3. Pesquise [Issues existentes no GitHub](https://github.com/caioimori/sinapse-ai/issues)
...
- **Issues no GitHub**: [sinapse-ai/issues](https://github.com/caioimori/sinapse-ai/issues)
