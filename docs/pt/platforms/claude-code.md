...
> **CLI Oficial da Anthropic** - Plataforma Recomendada para SINAPSE
...
### Por que usar SINAPSE com Claude Code?

O Claude Code oferece a **melhor integração** com o SINAPSE devido a:
...
# Verificar se os arquivos SINAPSE foram criados
ls -la .claude/
```
...
- Entendimento do framework SINAPSE
...
2. Inicialize o SINAPSE com Claude Code:
   ```bash
...
1. Seus agentes SINAPSE estão armazenados em `.sinapse-ai/development/agents/`
2. Inicialize o SINAPSE para a IDE de destino
