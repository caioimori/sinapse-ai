...
# Melhores Práticas de Segurança do SINAPSE

> 🌐 [EN](../security/security-best-practices.md) | **PT**

---

Este guia fornece recomendações abrangentes de segurança para implantação e manutenção do SINAPSE em ambientes de produção.
...
O SINAPSE implementa uma abordagem de segurança em múltiplas camadas:
...
await auth.createUser({
  username: 'admin',
  password: process.env.ADMIN_PASSWORD, // nunca faca hardcode — 12+ chars, maiusc/minusc, numero, simbolo
...
Para dúvidas ou preocupações de segurança, abra uma issue em: https://github.com/caioimori/sinapse-ai/issues
