...
Guia para configurar servidores MCP (Model Context Protocol) baseados em Docker com SINAPSE.
...
- `~/.sinapse/mcp/servers/` - Configurações de servidores individuais
...
SINAPSE usa Docker MCP Toolkit como a infraestrutura MCP principal:
