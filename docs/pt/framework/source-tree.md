...
O SINAPSE usa uma **arquitetura modular** com clara separação de responsabilidades:

1. **Framework Core** (`.sinapse-ai/`) - Componentes portáveis do framework organizados por domínio
...
│   └── sinapse-kb.md                     # Base de conhecimento SINAPSE
│
...
│   ├── sinapse migration/                # Stories de migração SINAPSE
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Squads são extensões modulares que adicionam capacidades especializadas ao SINAPSE. Diferente dos Squads deprecados, Squads seguem uma estrutura de template padronizada.
...
```
squads/
├── verified/                          # Squads curados pelo SINAPSE
│   ├── github-devops/
│   ├── db-sage/
│   └── coderabbit-workflow/
│
