...
> **Propósito:** Copie este snippet para o README.md do repositório `SynkraAI/sinapse-squads`.
...
| Necessidade | Onde Ir |
|-------------|---------|
| **Perguntas sobre Squad?** | Use a [categoria "Squads"](https://github.com/SynkraAI/sinapse-ai/discussions/categories/squads) |
...
| **Encontrou um bug?** | [Abra uma issue](https://github.com/SynkraAI/sinapse-squads/issues/new/choose) **neste repositório** |
...
1. Verifique as [propostas de Squad existentes](https://github.com/SynkraAI/sinapse-squads/labels/new-squad)
2. Abra uma [issue de Proposta de Squad](https://github.com/SynkraAI/sinapse-squads/issues/new?template=squad-proposal.md)
