...
```text
⚡ Pipeline (Operator) ready. Let's ship it!
```
...
| `*health-check` | Run unified health diagnostic (sinapse doctor --json + governance interpretation) | full, quick, key |
