...
steps:
  ...
  3_handle_edge_cases:
    ...
    known_pitfalls:
      - Email addresses inside strings may match rename patterns (Issue #159: security@synkra/sinapse-ai.dev)
...
- **Pitfall:** `@synkra/sinapse-ai` inside email `security@synkra/sinapse-ai.dev` was corrupted
