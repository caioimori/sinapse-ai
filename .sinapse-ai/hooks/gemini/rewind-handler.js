#!/usr/bin/env node
/**
 * SINAPSE Rewind Handler
 * Story GEMINI-INT.14 - /rewind Integration
 *
 * Syncs Gemini's /rewind command with SINAPSE state.
 */
...
async function handleRewind() {
  ...
  // Sync with SINAPSE memory layer
  try {
    const memoryDir = path.join(projectDir, '.sinapse', 'memory');
