#!/usr/bin/env node
/**
 * SINAPSE Session Start Hook for Gemini CLI
 * Story GEMINI-INT.6 - SINAPSE Hooks System
 *
 * Executes at session start to load SINAPSE context and memory.
...
async function sessionStart() {
  ...
  try {
    const codebaseMapPath = path.join(projectDir, '.sinapse', 'codebase-map.json');
