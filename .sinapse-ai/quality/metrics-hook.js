 ...
 * const { recordPreCommitMetrics } = require('./.sinapse-ai/quality/metrics-hook');
 ...
 *
 * @example
 * const { recordPRReviewMetrics } = require('./.sinapse-ai/quality/metrics-hook');
 ...
 *
 * @example
 * const { recordHumanReviewMetrics } = require('./.sinapse-ai/quality/metrics-hook');
 ...
 *
 * @example
 * const { withPreCommitMetrics } = require('./.sinapse-ai/quality/metrics-hook');
 *
