...
const PIPELINE_MODULES = [
  '.sinapse-ai/development/scripts/unified-activation-pipeline',
  '.sinapse-ai/development/scripts/greeting-builder',
  '.sinapse-ai/development/scripts/agent-config-loader',
  '.sinapse-ai/development/scripts/greeting-preference-manager',
  '.sinapse-ai/development/scripts/workflow-navigator',
  '.sinapse-ai/core/session/context-loader',
  '.sinapse-ai/core/session/context-detector',
  '.sinapse-ai/core/permissions',
  '.sinapse-ai/infrastructure/scripts/project-status-loader',
  '.sinapse-ai/infrastructure/scripts/git-config-detector',
  '.sinapse-ai/core/config/config-resolver',
  '.sinapse-ai/core/config/config-cache',
];
...
async function runBenchmark(options) {
  const pipelinePath = path.resolve(
    PROJECT_ROOT, '.sinapse-ai/development/scripts/unified-activation-pipeline',
  );
