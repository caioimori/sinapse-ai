...
const {
  ...
  NotificationType,
} = require('../../.sinapse-ai/core/orchestration/dashboard-integration');

const { MasterOrchestrator, OrchestratorState } = require('../../.sinapse-ai/core/orchestration');
...
describe('Dashboard Integration (Story 0.8)', () => {
  ...
  describe('Status File Update (AC1)', () => {
    ...
    it('should return status path', () => {
      ...
      expect(normalizedPath).toContain('.sinapse/dashboard/status.json');
    });
  });
