...
// Mock SessionState
jest.mock('../../.sinapse-ai/core/orchestration/session-state', () => ({
...
// Mock SurfaceChecker
jest.mock('../../.sinapse-ai/core/orchestration/surface-checker', () => ({
...
const { SessionState } = require('../../.sinapse-ai/core/orchestration/session-state');
const { SurfaceChecker } = require('../../.sinapse-ai/core/orchestration/surface-checker');
...
describe('WorkflowNavigator Integration (Story ACT-5)', () => {
  ...
  describe('AC5: Bob orchestration patterns in workflow-patterns.yaml', () => {
    ...
    beforeAll(() => {
      const patternsPath = path.join(
        __dirname,
        '../../.sinapse-ai/data/workflow-patterns.yaml',
      );
  ...
  describe('UnifiedActivationPipeline _detectWorkflowState relaxation', () => {
    ...
    beforeEach(() => {
      ...
      jest.mock('../../.sinapse-ai/development/scripts/greeting-builder');
      ...
      const { UnifiedActivationPipeline } = require('../../.sinapse-ai/development/scripts/unified-activation-pipeline');
      const MockWorkflowNavigator = require('../../.sinapse-ai/development/scripts/workflow-navigator');
