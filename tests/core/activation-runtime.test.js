...
jest.mock('../../.sinapse-ai/development/scripts/unified-activation-pipeline', () => ({
...
const { ActivationRuntime, activateAgent } = require('../../.sinapse-ai/development/scripts/activation-runtime');
