 ...
 *
 * @see .sinapse-ai/core/permissions/index.js
 */
...
jest.mock('../../../.sinapse-ai/core/permissions/permission-mode', () => ({
...
jest.mock('../../../.sinapse-ai/core/permissions/operation-guard', () => ({
...
const {
  ...
  cycleMode,
  enforcePermission,
} = require('../../../.sinapse-ai/core/permissions/index');
