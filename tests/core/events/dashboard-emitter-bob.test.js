...
const { DashboardEmitter, getDashboardEmitter } = require('../../../.sinapse-ai/core/events/dashboard-emitter');
const { DashboardEventType } = require('../../../.sinapse-ai/core/events/types');
...
describe('DashboardEmitter Bob-specific methods', () => {
  ...
  beforeEach(async () => {
    ...
    emitter.fallbackPath = path.join(tempDir, '.sinapse', 'dashboard', 'events.jsonl');
  });
