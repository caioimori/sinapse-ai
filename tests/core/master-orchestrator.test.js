...
describe('MasterOrchestrator', () => {
  ...
  beforeEach(async () => {
    ...
    // Create .sinapse/dashboard directory for dashboard integration
    await fs.ensureDir(path.join(tempDir, '.sinapse', 'dashboard'));
  ...
  describe('State Persistence (Story 0.2)', () => {
    describe('saveState (AC1, AC3)', () => {
      it('should save state to correct path', async () => {
        ...
        expect(normalizedPath).toContain('.sinapse/master-orchestrator/TEST-001.json');
