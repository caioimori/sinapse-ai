...
const WorkflowOrchestrator = require('../../../.sinapse-ai/core/orchestration/workflow-orchestrator');
...
describe('WorkflowOrchestrator execution profile propagation', () => {
  ...
  beforeEach(async () => {
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), 'sinapse-workflow-profile-'));
