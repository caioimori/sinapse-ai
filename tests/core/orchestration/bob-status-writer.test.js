...
} = require('../../../.sinapse-ai/core/orchestration/bob-status-writer');
...
describe('BobStatusWriter', () => {
  ...
  describe('constructor', () => {
    ...
    it('should set correct paths', () => {
      ...
      expect(writer.dashboardDir).toBe(path.join(tempDir, '.sinapse', 'dashboard'));
      expect(writer.statusPath).toBe(path.join(tempDir, '.sinapse', 'dashboard', 'bob-status.json'));
    });
  });
