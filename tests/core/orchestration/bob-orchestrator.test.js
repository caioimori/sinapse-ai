...
const {
  BobOrchestrator,
  ProjectState,
} = require('../../../.sinapse-ai/core/orchestration/bob-orchestrator');
...
jest.mock('../../../.sinapse-ai/core/orchestration/message-formatter', () => ({
...
jest.mock('../../../.sinapse-ai/core/orchestration/brownfield-handler', () => ({
...
jest.mock('../../../.sinapse-ai/core/orchestration/executor-assignment', () => ({
...
jest.mock('../../../.sinapse-ai/core/ui/observability-panel', () => ({
...
jest.mock('../../../.sinapse-ai/core/orchestration/bob-status-writer', () => ({
...
jest.mock('../../../.sinapse-ai/core/events/dashboard-emitter', () => ({
...
jest.mock('../../../.sinapse-ai/core/orchestration/data-lifecycle-manager', () => {
...
const { resolveConfig } = require('../../../.sinapse-ai/core/config/config-resolver');
...
describe('BobOrchestrator', () => {
  ...
  beforeEach(async () => {
    ...
    await fs.mkdir(path.join(TEST_PROJECT_ROOT, '.sinapse/locks'), { recursive: true });
  ...
  describe('Educational Mode (Story 12.7)', () => {
    ...
    describe('handleEducationalModeToggle (AC6)', () => {
      ...
      it('should persist to user config for permanent type', async () => {
        // Given
        const { setUserConfigValue } = require('../../../.sinapse-ai/core/config/config-resolver');
