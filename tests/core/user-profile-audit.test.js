...
const { validateUserProfile } = require('../../.sinapse-ai/infrastructure/scripts/validate-user-profile');

// Import modules under test after mocks
const GreetingPreferenceManager = require('../../.sinapse-ai/development/scripts/greeting-preference-manager');
...
describe('validate-user-profile standalone', () => {
  ...
  const actualValidateUserProfile = jest.requireActual(
    '../../.sinapse-ai/infrastructure/scripts/validate-user-profile',
  ).validateUserProfile;
