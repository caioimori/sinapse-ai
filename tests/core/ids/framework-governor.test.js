...
const { FrameworkGovernor, TIMEOUT_MS, RISK_THRESHOLDS } = require('../../../.sinapse-ai/core/ids/framework-governor');
...
describe('FrameworkGovernor', () => {
  ...
  describe('postRegister()', () => {
    ...
    it('should use onAgentTaskComplete (not processChanges) per SF-1', async () => {
      await governor.postRegister('.sinapse-ai/development/tasks/new-task.md', {});
      ...
      it('should include recommendations when matches found', () => {
        const result = {
          ...
          recommendations: [{
            ...
            decision: 'ADAPT',
            relevanceScore: 0.75,
            entityPath: '.sinapse-ai/development/tasks/create-doc.md',
          }],
        };
        const output = FrameworkGovernor.formatPreCheckOutput(result);
