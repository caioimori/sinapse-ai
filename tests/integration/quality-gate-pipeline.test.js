...
const { Layer1PreCommit } = require('../../.sinapse-ai/core/quality-gates/layer1-precommit');
const { Layer2PRAutomation } = require('../../.sinapse-ai/core/quality-gates/layer2-pr-automation');
const { Layer3HumanReview } = require('../../.sinapse-ai/core/quality-gates/layer3-human-review');
const { ChecklistGenerator } = require('../../.sinapse-ai/core/quality-gates/checklist-generator');
    ...
    it('should generate checklist with context', async () => {
      const checklist = await generator.generate({
        ...
        changedFiles: [
          ...
          '.sinapse-ai/core/quality-gates/manager.js',
