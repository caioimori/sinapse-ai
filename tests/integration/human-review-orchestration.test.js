...
const { HumanReviewOrchestrator } = require('../../.sinapse-ai/core/quality-gates/human-review-orchestrator');
const { FocusAreaRecommender } = require('../../.sinapse-ai/core/quality-gates/focus-area-recommender');
const { NotificationManager } = require('../../.sinapse-ai/core/quality-gates/notification-manager');
  ...
  describe('HUMAN-01: Orchestration Flow', () => {
    ...
    beforeEach(() => {
      orchestrator = new HumanReviewOrchestrator({
        statusPath: '.sinapse/qa-status-integration-test.json',
        reviewRequestsPath: '.sinapse/human-review-requests-integration-test',
      });
