...
const PersonalizedOutputFormatter = require('../../.sinapse-ai/infrastructure/scripts/output-formatter');
const OutputPatternValidator = require('../../.sinapse-ai/infrastructure/scripts/validate-output-pattern');
const fs = require('fs');
...
- .sinapse-ai/scripts/output-formatter.js
- .sinapse-ai/scripts/validate-output-pattern.js
