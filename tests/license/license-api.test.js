...
describe('license-api', () => {
  ...
  beforeEach(() => {
    ...
    testDir = fs.mkdtempSync(path.join(os.tmpdir(), 'sinapse-api-test-'));
  ...
  describe('LicenseApiClient constructor', () => {
    it('should use default config', () => {
      ...
      expect(client.baseUrl).toBe(process.env.SINAPSE_LICENSE_API_URL || 'https://api.sinapse.ai');
    ...
    it('should successfully activate license (AC-1)', async () => {
      ...
      await createMockServer((req, res) => {
        ...
        req.on('end', () => {
          ...
          expect(data.sinapseCoreVersion).toBe('3.0.0');
