...
describeIntegration('Google Workspace Tool Validators', () => {
  ...
  beforeAll(async () => {
    // Set search path to sinapse-ai/tools
    const toolsPath = path.join(__dirname, '../../sinapse-ai/tools');
  ...
  describeIntegration('Tool Resolution', () => {
    test('should resolve google-workspace tool from sinapse-ai/tools/mcp', async () => {
