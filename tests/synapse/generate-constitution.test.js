...
const {
  ...
  main,
  ROMAN_TO_ARABIC,
} = require('../../.sinapse-ai/core/synapse/scripts/generate-constitution');
const { parseManifest, loadDomainFile } = require('../../.sinapse-ai/core/synapse/domain/domain-loader');
 ...
 */
const FULL_CONSTITUTION = `# SINAPSE Constitution
...
describe('generateConstitution', () => {
  ...
  test('should include header comments', () => {
    ...
    expect(output).toContain('# Auto-generated from .sinapse-ai/constitution.md');
