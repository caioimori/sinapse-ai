...
jest.mock('../../.sinapse-ai/core/synapse/memory/synapse-memory-provider', () => ({
...
const { MemoryBridge, BRACKET_LAYER_MAP, BRIDGE_TIMEOUT_MS } = require('../../.sinapse-ai/core/synapse/memory/memory-bridge');
