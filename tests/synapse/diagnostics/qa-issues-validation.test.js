...
const { collectQualityMetrics, BRACKET_ACTIVE_LAYERS, MAX_STALENESS_MS } = require(
  '../../../.sinapse-ai/core/synapse/diagnostics/collectors/quality-collector',
);
const { collectConsistencyMetrics, MAX_TIMESTAMP_GAP_MS } = require(
  '../../../.sinapse-ai/core/synapse/diagnostics/collectors/consistency-collector',
);
const { collectOutputAnalysis, UAP_OUTPUT_EXPECTATIONS } = require(
  '../../../.sinapse-ai/core/synapse/diagnostics/collectors/output-analyzer',
);
const { collectRelevanceMatrix, IMPORTANCE } = require(
  '../../../.sinapse-ai/core/synapse/diagnostics/collectors/relevance-matrix',
);
const { getActiveLayers } = require(
  '../../../.sinapse-ai/core/synapse/context/context-tracker',
);
