...
const { formatReport } = jest.requireActual(
  '../../../.sinapse-ai/core/synapse/diagnostics/report-formatter',
);
...
jest.mock('../../../.sinapse-ai/core/synapse/diagnostics/collectors/hook-collector');
jest.mock('../../../.sinapse-ai/core/synapse/diagnostics/collectors/session-collector');
jest.mock('../../../.sinapse-ai/core/synapse/diagnostics/collectors/manifest-collector');
jest.mock('../../../.sinapse-ai/core/synapse/diagnostics/collectors/pipeline-collector');
jest.mock('../../../.sinapse-ai/core/synapse/diagnostics/collectors/uap-collector');
jest.mock('../../../.sinapse-ai/core/synapse/diagnostics/report-formatter');
jest.mock('../../../.sinapse-ai/core/synapse/domain/domain-loader');

const { collectHookStatus } = require('../../../.sinapse-ai/core/synapse/diagnostics/collectors/hook-collector');
const { collectSessionStatus } = require('../../../.sinapse-ai/core/synapse/diagnostics/collectors/session-collector');
const { collectManifestIntegrity } = require('../../../.sinapse-ai/core/synapse/diagnostics/collectors/manifest-collector');
const { collectPipelineSimulation } = require('../../../.sinapse-ai/core/synapse/diagnostics/collectors/pipeline-collector');
const { collectUapBridgeStatus } = require('../../../.sinapse-ai/core/synapse/diagnostics/collectors/uap-collector');
const { formatReport: mockFormatReport } = require('../../../.sinapse-ai/core/synapse/diagnostics/report-formatter');
const { parseManifest } = require('../../../.sinapse-ai/core/synapse/domain/domain-loader');

const { runDiagnostics, runDiagnosticsRaw } = require('../../../.sinapse-ai/core/synapse/diagnostics/synapse-diagnostics');
