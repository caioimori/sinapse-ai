...
const { onPreCompact, getHookConfig } = require('../../../../.sinapse-ai/hooks/unified/runners/precompact-runner');
...
describe('PreCompact Hook Runner', () => {
  ...
  describe('onPreCompact', () => {
    ...
    it('should gracefully no-op when sinapse-pro not available', async () => {
      proDetector.isProAvailable.mockReturnValue(false);
      ...
      expect(console.log).toHaveBeenCalledWith(
        '[PreCompact] sinapse-pro not available, skipping session digest',
      );
    });
