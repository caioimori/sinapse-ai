...
const {
  ...
  CheckRegistry,
  DEFAULT_CONFIG,
} = require('../../.sinapse-ai/core/health-check');
...
describe('Health Check System', () => {
  ...
  describe('HealthCheck Instance', () => {
    ...
    it('should have 35 total checks', () => {
      const counts = healthCheck.getCheckCounts();
      const total = Object.values(counts).reduce((a, b) => a + b, 0);
      assert.strictEqual(total, 35, 'Should have 35 total checks (gemini-cli check #26 added in Frente 5.1)');
    });
    ...
    it('should have correct check distribution', () => {
      ...
      assert.strictEqual(counts.services, 5, 'Services should have 5 checks (gemini-cli added)');
    });
  });
