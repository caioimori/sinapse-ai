...
const {
  ...
  DEFAULT_COLOR,
  LIFECYCLE_STYLES,
} = require('../../.sinapse-ai/core/graph-dashboard/formatters/html-formatter');
...
describe('html-formatter', () => {
  ...
  describe('CLI integration (FORMAT_MAP)', () => {
    it('should have html in FORMAT_MAP', () => {
      const { FORMAT_MAP } = require('../../.sinapse-ai/core/graph-dashboard/cli');
      expect(FORMAT_MAP.html).toBe(formatAsHtml);
    });

    it('should have html in VALID_FORMATS', () => {
      const { VALID_FORMATS } = require('../../.sinapse-ai/core/graph-dashboard/cli');
      expect(VALID_FORMATS).toContain('html');
    });

    it('should have html in WATCH_FORMAT_MAP', () => {
      const { WATCH_FORMAT_MAP } = require('../../.sinapse-ai/core/graph-dashboard/cli');
    ...
    it('should parse --format=html correctly', () => {
      const { parseArgs } = require('../../.sinapse-ai/core/graph-dashboard/cli');
