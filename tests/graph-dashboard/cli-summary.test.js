...
jest.mock('../../.sinapse-ai/core/graph-dashboard/data-sources/code-intel-source', () => ({
...
jest.mock('../../.sinapse-ai/core/graph-dashboard/data-sources/registry-source', () => ({
...
jest.mock('../../.sinapse-ai/core/graph-dashboard/data-sources/metrics-source', () => ({
...
const { handleSummary, handleDeps, FORMAT_MAP, VALID_FORMATS } = require('../../.sinapse-ai/core/graph-dashboard/cli');
...
describe('cli-summary', () => {
  ...
  describe('handleSummary', () => {
    it('should render all three sections', async () => {
      ...
      expect(output).toContain('SINAPSE Graph Dashboard');
