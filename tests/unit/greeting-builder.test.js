...
const { resolveConfig: mockResolveConfig } = require('../../.sinapse-ai/core/config/config-resolver');
...
const { loadProjectStatus, formatStatusDisplay } = require('../../.sinapse-ai/infrastructure/scripts/project-status-loader');
