...
const {
  ...
  TemplateFiles,
  OutputFiles,
} = require('../../../.sinapse-ai/infrastructure/scripts/documentation-integrity/doc-generator');

describe('Documentation Generator', () => {
  let tempDir;

  beforeEach(() => {
    tempDir = fs.mkdtempSync(path.join(os.tmpdir(), 'sinapse-docgen-test-'));
  });
  ...
  describe('renderTemplate', () => {
    ...
    it('should handle multiple variables', () => {
      ...
      const context = { greeting: 'Hello', name: 'User', place: 'SINAPSE' };

      const result = renderTemplate(template, context);

      expect(result).toBe('Hello User, welcome to SINAPSE!');
    });
