...
const {
  ...
  getCurrentContext,
} = require('../../.sinapse-ai/development/scripts/decision-recorder');

// Mock decision-log-generator
jest.mock('../../.sinapse-ai/development/scripts/decision-log-generator', () => ({
...
describe('decision-recorder', () => {
  ...
  describe('completeDecisionLogging', () => {
    it('should complete logging and generate log file', async () => {
      const { generateDecisionLog } = require('../../.sinapse-ai/development/scripts/decision-log-generator');
