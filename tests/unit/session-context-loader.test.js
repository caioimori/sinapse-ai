...
const SessionContextLoader = require('../../.sinapse-ai/scripts/session-context-loader');

describe('SessionContextLoader', () => {
  let loader;
  const testSessionPath = path.join(process.cwd(), '.sinapse', 'session-state-test.json');
