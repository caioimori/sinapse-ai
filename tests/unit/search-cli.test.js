...
// Test modules
const { searchKeyword, fuzzyMatchScore, levenshteinDistance } = require('../../.sinapse-ai/cli/commands/workers/search-keyword');
const { applyFilters, filterByCategory, filterByTags } = require('../../.sinapse-ai/cli/commands/workers/search-filters');
const { formatOutput, formatTable, formatJSON, formatYAML } = require('../../.sinapse-ai/cli/utils/output-formatter-cli');
const { calculateScores, sortByScore, calculateSearchAccuracy } = require('../../.sinapse-ai/cli/utils/score-calculator');
const { isSemanticAvailable, cosineSimilarity, buildSearchText } = require('../../.sinapse-ai/cli/commands/workers/search-semantic');
...
const mockWorkers = [
  {
    ...
    path: '.sinapse-ai/development/tasks/data/json-csv-transformer.md',
  },
  {
    ...
    subcategory: 'transformation',
    tags: ['etl', 'data', 'json', 'csv'],
    path: '.sinapse-ai/development/tasks/data/csv-json-transformer.md',
  },
  {
    id: 'json-validator',
    ...
    path: '.sinapse-ai/development/tasks/validation/json-validator.md',
  },
  {
    id: 'api-generator',
    ...
    path: '.sinapse-ai/development/tasks/code/api-generator.md',
  },
  {
    id: 'test-runner',
    name: 'Test Runner',
    ...
    path: '.sinapse-ai/development/tasks/testing/test-runner.md',
  },
];
  ...
  const testResults = [
    {
      ...
      tags: ['etl', 'json', 'csv'],
      score: 95,
      path: '.sinapse-ai/tasks/json-csv-transformer.md',
    },
  ];
