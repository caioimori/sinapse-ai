...
describe('HumanReviewOrchestrator', () => {
  ...
  beforeEach(() => {
    orchestrator = new HumanReviewOrchestrator({
      statusPath: '.sinapse/qa-status-test.json',
      reviewRequestsPath: '.sinapse/human-review-requests-test',
    });
  });
  ...
  describe('constructor', () => {
    ...
    it('should create orchestrator with custom config', () => {
      expect(orchestrator.statusPath).toBe('.sinapse/qa-status-test.json');
      expect(orchestrator.reviewRequestsPath).toBe('.sinapse/human-review-requests-test');
    });
  });
