...
- **Brownfield support**: Detects existing SINAPSE installations and offers migration
...
If you have an existing SINAPSE installation, the installer will:
...
- Documentation: https://github.com/caioimori/sinapse-ai
