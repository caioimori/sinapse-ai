...
async function validateFiles(fileContext = {}) {
  ...
  try {
    ...
    const coreConfigPath = fileContext.coreConfig || '.sinapse-ai/core-config.yaml';
    ...
    // Validate directory structure - only .sinapse-ai is required
    const requiredDirs = ['.sinapse-ai'];
