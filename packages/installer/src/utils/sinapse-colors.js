/**
 * SINAPSE Color Palette v5.0.0
 *
 * Brand color system for CLI tools and terminal output.
 * Colors derived from SINAPSE brand identity: Lime + Cream on Dark surfaces.
 *
 * @see docs/standards/SINAPSE-COLOR-PALETTE-V2.1.md
 * @module sinapse-colors
 */

const chalk = require('chalk');

/**
 * SINAPSE Brand Color Palette
...
const colors = {
  ...
  /**
   * Primary branding - Bold lime for SINAPSE brand moments
   */
...
const examples = {
  welcome: () => {
    console.log(headings.h1('🎉 Welcome to SINAPSE v4 Installer!'));
  ...
  complete: () => {
    ...
    console.log(colors.info('Your SINAPSE project is ready to use.'));
