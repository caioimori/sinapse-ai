 ...
 *
 * Generates YAML configuration file for SINAPSE framework
 *
 ...
 * @param {string} options.projectType - Project type from Story 1.3 (GREENFIELD|BROWNFIELD|EXISTING_SINAPSE)
 ...
 * @param {string} [options.sinapseVersion] - SINAPSE version (default: 2.1.0)
...
function generateCoreConfig(options = {}) {
  ...
  const config = {
    ...
    scriptsLocation: '.sinapse-ai/scripts',
    dataLocation: '.sinapse-ai/data',
    elicitationLocation: '.sinapse-ai/elicitation',
    ...
    boundary: {
      ...
      // L3 paths — mutable exceptions (allowed even within .sinapse-ai/)
      exceptions: [
        '.sinapse-ai/data/**',
