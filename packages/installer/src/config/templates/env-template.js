...
/**
 * Get the current SINAPSE version from package.json
 * @returns {string} The version string
 */
function getSinapseVersion() {
  try {
...
const SINAPSE_VERSION = getSinapseVersion();
...
# ============================================
# Generated by SINAPSE Installer
...
# --------------------------------------------
# SINAPSE Core Configuration
# --------------------------------------------
NODE_ENV=development
SINAPSE_VERSION=${SINAPSE_VERSION}
