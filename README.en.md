...
- **[Learn how to use SINAPSE](docs/guides/user-guide.md)** → Complete user guide and walkthrough
...
- ✅ Configuration of all SINAPSE agents and workflows
...
- 📝 SINAPSE-specific code patterns
...
- 🚀 **[Squads Guide](docs/guides/squads-guide.md)** - Extend SINAPSE to any domain beyond software development
...
- ⚙️ **[Performance Tuning Guide](docs/performance-tuning-guide.md)** - Optimize your SINAPSE workflow
